    ...
    let BulkEdit = class BulkEdit {
        ...
        perform() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let progress = { report: _ => this._progress && this._progress.worked(1) };
                // do it.
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const edit of edits) {
                    ...
                    if (edit.newUri && edit.oldUri) {
                        // rename
                        if (options.overwrite === undefined && options.ignoreIfExists && (yield this._fileService.existsFile(edit.newUri))) {
                        ...
                        // delete file
                        if (!options.ignoreIfNotExists || (yield this._fileService.existsFile(edit.oldUri))) {
                            yield this._textFileService.delete(edit.oldUri, { useTrash: this._configurationService.getValue('files.enableTrash'), recursive: options.recursive });
                        }
                    }
                    else if (edit.newUri && !edit.oldUri) {
                        // create file
