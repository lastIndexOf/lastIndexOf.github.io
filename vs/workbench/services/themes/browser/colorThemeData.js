...
define(["require", "exports", "vs/base/common/path", "vs/base/common/json", "vs/base/common/color", "vs/workbench/services/themes/common/workbenchThemeService", "vs/workbench/services/themes/browser/themeCompatibility", "vs/nls", "vs/base/common/types", "vs/base/common/objects", "vs/base/common/resources", "vs/platform/theme/common/colorRegistry", "vs/platform/registry/common/platform", "vs/base/common/jsonErrorMessages", "vs/workbench/services/themes/common/plistParser", "vs/base/common/strings"], function (require, exports, path_1, Json, color_1, workbenchThemeService_1, themeCompatibility_1, nls, types, objects, resources, colorRegistry_1, platform_1, jsonErrorMessages_1, plistParser_1, strings_1) {
    ...
    class ColorThemeData {
        ...
        sanitizeTokenColors() {
            ...
            let updatedTokenColors = [updateDefaultRuleSettings({ settings: {} }, this)];
    ...
    function updateDefaultRuleSettings(defaultRule, theme) {
        const foreground = theme.getColor(colorRegistry_1.editorForeground) || theme.getDefault(colorRegistry_1.editorForeground);
        const background = theme.getColor(colorRegistry_1.editorBackground) || theme.getDefault(colorRegistry_1.editorBackground);
