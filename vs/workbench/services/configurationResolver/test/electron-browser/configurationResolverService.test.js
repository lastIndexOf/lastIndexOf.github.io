...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/workbench/services/configurationResolver/browser/configurationResolverService", "vs/workbench/test/workbenchTestServices", "vs/platform/configuration/test/common/testConfigurationService", "vs/base/common/lifecycle", "vs/base/common/types"], function (require, exports, assert, uri_1, platform, configuration_1, configurationResolverService_1, workbenchTestServices_1, testConfigurationService_1, lifecycle_1, Types) {
    ...
    suite('Configuration Resolver Service', () => {
        ...
        setup(() => {
            ...
            configurationResolverService = new configurationResolverService_1.ConfigurationResolverService(windowService, editorService, workbenchTestServices_1.TestEnvironmentService, new MockInputsConfigurationService(), mockCommandService, new workbenchTestServices_1.TestContextService(), quickInputService);
        });
        teardown(() => {
        ...
        test('substitute one configuration variable', () => {
            ...
            let service = new configurationResolverService_1.ConfigurationResolverService(windowService, new workbenchTestServices_1.TestEditorService(), workbenchTestServices_1.TestEnvironmentService, configurationService, mockCommandService, new workbenchTestServices_1.TestContextService(), quickInputService);
    ...
    class MockWindowService extends workbenchTestServices_1.TestWindowService {
        constructor(env) {
            super();
            this.env = env;
        }
        getConfiguration() {
            return { userEnv: this.env };
        }
    }
});
