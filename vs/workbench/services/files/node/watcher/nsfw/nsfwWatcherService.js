 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/glob", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/platform", "vs/workbench/services/files/node/watcher/common", "vscode-nsfw", "vs/base/common/async", "vs/base/common/normalization", "vs/base/common/event", "vs/base/node/extfs"], function (require, exports, glob, extpath, path, platform, watcher, nsfw, async_1, normalization_1, event_1, extfs_1) {
    "use strict";
