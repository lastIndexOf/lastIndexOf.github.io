...
define(["require", "exports", "vs/base/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/dom", "vs/platform/contextview/browser/contextView", "vs/platform/telemetry/common/telemetry", "vs/platform/keybinding/common/keybinding", "electron", "vs/base/common/labels", "vs/base/common/event", "vs/platform/notification/common/notification", "vs/base/browser/contextmenu", "vs/base/common/functional", "vs/base/common/lifecycle", "vs/base/parts/contextmenu/electron-browser/contextmenu", "vs/platform/windows/common/windows", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/contextview/browser/contextMenuService", "vs/platform/theme/common/themeService", "vs/platform/instantiation/common/extensions", "vs/platform/layout/browser/layoutService"], function (require, exports, actions_1, actionbar_1, dom, contextView_1, telemetry_1, keybinding_1, electron_1, labels_1, event_1, notification_1, contextmenu_1, functional_1, lifecycle_1, contextmenu_2, windows_1, platform_1, configuration_1, environment_1, contextMenuService_1, themeService_1, extensions_1, layoutService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ContextMenuService = class ContextMenuService extends lifecycle_1.Disposable {
        constructor(notificationService, telemetryService, keybindingService, configurationService, environmentService, contextViewService, themeService, layoutService) {
            super();
            ...
            if (!platform_1.isMacintosh && windows_1.getTitleBarStyle(configurationService, environmentService) === 'custom') {
                this.impl = new contextMenuService_1.ContextMenuService(layoutService, telemetryService, notificationService, contextViewService, keybindingService, themeService);
            }
