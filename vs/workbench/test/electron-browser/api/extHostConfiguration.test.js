...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/api/node/extHostWorkspace", "vs/workbench/api/node/extHostConfiguration", "vs/platform/configuration/common/configurationModels", "./testRPCProtocol", "vs/workbench/test/electron-browser/api/mock", "vs/platform/workspace/common/workspace", "vs/platform/log/common/log", "vs/base/common/objects", "vs/base/common/numbers"], function (require, exports, assert, uri_1, extHostWorkspace_1, extHostConfiguration_1, configurationModels_1, testRPCProtocol_1, mock_1, workspace_1, log_1, objects_1, numbers_1) {
    ...
    suite('ExtHostConfiguration', function () {
        ...
        function createExtHostConfiguration(contents = Object.create(null), shape) {
            ...
            return new extHostConfiguration_1.ExtHostConfigProvider(shape, new extHostWorkspace_1.ExtHostWorkspace(new testRPCProtocol_1.TestRPCProtocol(), new log_1.NullLogService(), new numbers_1.Counter()), createConfigurationData(contents));
        }
        ...
        test('inspect in no workspace context', function () {
            ...
            }, new extHostWorkspace_1.ExtHostWorkspace(new testRPCProtocol_1.TestRPCProtocol(), new log_1.NullLogService(), new numbers_1.Counter()), {
        ...
        test('inspect in single root context', function () {
            ...
            const extHostWorkspace = new extHostWorkspace_1.ExtHostWorkspace(new testRPCProtocol_1.TestRPCProtocol(), new log_1.NullLogService(), new numbers_1.Counter());
