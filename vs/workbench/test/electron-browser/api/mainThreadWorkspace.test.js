...
define(["require", "exports", "vs/workbench/test/workbenchTestServices", "vs/workbench/services/search/common/search", "vs/workbench/api/electron-browser/mainThreadWorkspace", "assert", "vs/workbench/test/electron-browser/api/testRPCProtocol", "vs/base/common/cancellation", "vs/platform/configuration/common/configuration"], function (require, exports, workbenchTestServices_1, search_1, mainThreadWorkspace_1, assert, testRPCProtocol_1, cancellation_1, configuration_1) {
    ...
    suite('MainThreadWorkspace', () => {
        ...
        test('simple', () => {
            ...
            return mtw.$startFileSearch('foo', undefined, undefined, 10, new cancellation_1.CancellationTokenSource().token);
        });
        test('exclude defaults', () => {
            ...
            const mtw = instantiationService.createInstance(mainThreadWorkspace_1.MainThreadWorkspace, testRPCProtocol_1.SingleProxyRPCProtocol({ $initializeWorkspace: () => { } }));
            return mtw.$startFileSearch('', undefined, undefined, 10, new cancellation_1.CancellationTokenSource().token);
        });
        test('disregard excludes', () => {
            ...
            const mtw = instantiationService.createInstance(mainThreadWorkspace_1.MainThreadWorkspace, testRPCProtocol_1.SingleProxyRPCProtocol({ $initializeWorkspace: () => { } }));
            return mtw.$startFileSearch('', undefined, false, 10, new cancellation_1.CancellationTokenSource().token);
        });
        test('exclude string', () => {
            instantiationService.stub(search_1.ISearchService, {
                fileSearch(query) {
            ...
            const mtw = instantiationService.createInstance(mainThreadWorkspace_1.MainThreadWorkspace, testRPCProtocol_1.SingleProxyRPCProtocol({ $initializeWorkspace: () => { } }));
            return mtw.$startFileSearch('', undefined, 'exclude/**', 10, new cancellation_1.CancellationTokenSource().token);
        });
    });
});
