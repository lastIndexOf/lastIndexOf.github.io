...
define(["require", "exports", "assert", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/base/common/errors", "vs/base/common/uri", "vs/workbench/api/node/extHostTypes", "vs/editor/common/model/textModel", "vs/editor/common/core/position", "vs/editor/common/core/range", "./testRPCProtocol", "vs/platform/markers/common/markers", "vs/platform/markers/common/markerService", "vs/workbench/api/node/extHostLanguageFeatures", "vs/workbench/api/electron-browser/mainThreadLanguageFeatures", "vs/workbench/api/node/extHostCommands", "vs/workbench/api/electron-browser/mainThreadCommands", "vs/workbench/api/electron-browser/mainThreadHeapService", "vs/workbench/api/node/extHostDocuments", "vs/workbench/api/node/extHostDocumentsAndEditors", "vs/editor/contrib/quickOpen/quickOpen", "vs/editor/common/modes", "vs/editor/contrib/codelens/codelens", "vs/editor/contrib/goToDefinition/goToDefinition", "vs/editor/contrib/hover/getHover", "vs/editor/contrib/wordHighlighter/wordHighlighter", "vs/editor/contrib/referenceSearch/referenceSearch", "vs/editor/contrib/codeAction/codeAction", "vs/workbench/contrib/search/common/search", "vs/editor/contrib/rename/rename", "vs/editor/contrib/parameterHints/provideSignatureHelp", "vs/editor/contrib/suggest/suggest", "vs/editor/contrib/format/format", "vs/editor/contrib/links/getLinks", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/node/extHostDiagnostics", "vs/workbench/api/node/extHostHeapService", "vs/platform/log/common/log", "vs/editor/contrib/colorPicker/color", "vs/base/common/cancellation", "vs/workbench/services/extensions/common/extensions", "vs/editor/contrib/smartSelect/smartSelect", "vs/platform/telemetry/common/telemetryUtils", "vs/workbench/test/electron-browser/api/mock", "vs/base/common/lifecycle"], function (require, exports, assert, instantiationServiceMock_1, errors_1, uri_1, types, textModel_1, position_1, range_1, testRPCProtocol_1, markers_1, markerService_1, extHostLanguageFeatures_1, mainThreadLanguageFeatures_1, extHostCommands_1, mainThreadCommands_1, mainThreadHeapService_1, extHostDocuments_1, extHostDocumentsAndEditors_1, quickOpen_1, modes, codelens_1, goToDefinition_1, getHover_1, wordHighlighter_1, referenceSearch_1, codeAction_1, search_1, rename_1, provideSignatureHelp_1, suggest_1, format_1, getLinks_1, extHost_protocol_1, extHostDiagnostics_1, extHostHeapService_1, log_1, color_1, cancellation_1, extensions_1, smartSelect_1, telemetryUtils_1, mock_1, lifecycle_1) {
    "use strict";
    ...
    suite('ExtHostLanguageFeatures', function () {
        suiteSetup(() => {
            ...
            const heapService = new extHostHeapService_1.ExtHostHeapService();
            const commands = new extHostCommands_1.ExtHostCommands(rpcProtocol, heapService, new log_1.NullLogService());
            ...
            extHost = new extHostLanguageFeatures_1.ExtHostLanguageFeatures(rpcProtocol, null, extHostDocuments, commands, heapService, diagnostics, new log_1.NullLogService());
        ...
        test('Format Doc, data conversion', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            let value = (yield format_1.getDocumentFormattingEdits(telemetryUtils_1.NullTelemetryService, NullWorkerService, model, { insertSpaces: true, tabSize: 4 }, 1 /* Auto */, cancellation_1.CancellationToken.None));
            assert.equal(value.length, 2);
            let [first, second] = value;
        ...
        test('Format Doc, evil provider', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            return format_1.getDocumentFormattingEdits(telemetryUtils_1.NullTelemetryService, NullWorkerService, model, { insertSpaces: true, tabSize: 4 }, 1 /* Auto */, cancellation_1.CancellationToken.None);
        }));
        ...
        test('Format Range, data conversion', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            const value = (yield format_1.getDocumentRangeFormattingEdits(telemetryUtils_1.NullTelemetryService, NullWorkerService, model, new range_1.Range(1, 1, 1, 1), { insertSpaces: true, tabSize: 4 }, 1 /* Auto */, cancellation_1.CancellationToken.None));
            assert.equal(value.length, 1);
            const [first] = value;
            assert.equal(first.text, 'testing');
            assert.deepEqual(first.range, { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 });
        ...
        test('Format Range, evil provider', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            return format_1.getDocumentRangeFormattingEdits(telemetryUtils_1.NullTelemetryService, NullWorkerService, model, new range_1.Range(1, 1, 1, 1), { insertSpaces: true, tabSize: 4 }, 1 /* Auto */, cancellation_1.CancellationToken.None);
        }));
        test('Format on Type, data conversion', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            const value = (yield format_1.getOnTypeFormattingEdits(telemetryUtils_1.NullTelemetryService, NullWorkerService, model, new position_1.Position(1, 1), ';', { insertSpaces: true, tabSize: 2 }));
            assert.equal(value.length, 1);
            const [first] = value;
        ...
        test('Links, data conversion', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield rpcProtocol.sync();
            let value = yield getLinks_1.getLinks(model, cancellation_1.CancellationToken.None);
            assert.equal(value.length, 1);
            let [first] = value;
