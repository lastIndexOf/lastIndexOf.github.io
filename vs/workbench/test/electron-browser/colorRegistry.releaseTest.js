...
define(["require", "exports", "vs/platform/registry/common/platform", "vs/platform/theme/common/colorRegistry", "vs/editor/contrib/gotoError/gotoErrorWidget", "vs/workbench/contrib/scm/browser/dirtydiffDecorator", "vs/workbench/contrib/debug/browser/statusbarColorProvider", "vs/workbench/contrib/debug/browser/exceptionWidget", "vs/workbench/contrib/debug/browser/debugToolbar", "vs/workbench/contrib/welcome/page/browser/welcomePage", "vs/workbench/contrib/welcome/walkThrough/browser/walkThroughPart", "vs/base/node/request", "vs/base/node/pfs", "vs/base/common/path", "assert", "vs/base/common/amd", "vs/base/common/cancellation"], function (require, exports, platform_1, colorRegistry_1, gotoErrorWidget_1, dirtydiffDecorator_1, statusbarColorProvider_1, exceptionWidget_1, debugToolbar_1, welcomePage_1, walkThroughPart_1, request_1, pfs, path, assert, amd_1, cancellation_1) {
    "use strict";
    ...
    suite('Color Registry', function () {
        test('all colors documented', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const reqContext = yield request_1.request({ url: 'https://raw.githubusercontent.com/Microsoft/vscode-docs/vnext/docs/getstarted/theme-color-reference.md' }, cancellation_1.CancellationToken.None);
