...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/common/lifecycle", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/editor/contrib/referenceSearch/referencesWidget", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/api/node/extHostTypes", "vs/workbench/contrib/comments/electron-browser/commentThreadWidget", "vs/workbench/contrib/comments/electron-browser/commentService", "vs/editor/common/model/textModel", "vs/platform/notification/common/notification", "vs/base/common/async", "vs/workbench/contrib/comments/electron-browser/commentGlyphWidget", "vs/platform/contextview/browser/contextView", "vs/workbench/common/theme", "vs/platform/commands/common/commands", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/comments/electron-browser/simpleCommentEditor", "vs/base/common/errors", "vs/css!./media/review"], function (require, exports, nls, dom_1, arrays_1, lifecycle_1, editorBrowser_1, editorExtensions_1, codeEditorService_1, range_1, modes, referencesWidget_1, contextkey_1, instantiation_1, keybindingsRegistry_1, colorRegistry_1, themeService_1, extHostTypes_1, commentThreadWidget_1, commentService_1, textModel_1, notification_1, async_1, commentGlyphWidget_1, contextView_1, theme_1, commands_1, editorService_1, simpleCommentEditor_1, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ctxCommentThreadVisible = new contextkey_1.RawContextKey('commentThreadVisible', false);
    ...
    class CommentingRangeDecoration {
        constructor(_editor, _ownerId, _extensionId, _range, _reply, commentingOptions, commentingRangesInfo) {
            ...
            for (const info of commentInfos) {
                if (Array.isArray(info.commentingRanges)) {
                    ...
                    (info.commentingRanges ? info.commentingRanges.ranges : []).forEach(range => {
                        commentingRangeDecorations.push(new CommentingRangeDecoration(editor, info.owner, info.extensionId, range, info.commentingRanges.newCommentThreadCommand, this.decorationOptions, info.commentingRanges));
                    });
                }
            }
    ...
    let ReviewController = class ReviewController {
        constructor(editor, contextKeyService, commentService, _commandService, notificationService, instantiationService, codeEditorService, contextMenuService) {
            ...
            this._commentThreadVisible = exports.ctxCommentThreadVisible.bindTo(contextKeyService);
        ...
        revealCommentThread(threadId, commentId, fetchOnceIfNotExist) {
        ...
        onModelChanged(e) {
            ...
            this.localToDispose.push(this.editor.onDidChangeModelContent(() => __awaiter(this, void 0, void 0, function* () {
        ...
        displayCommentThread(owner, thread, pendingComment, draftMode) {
            const zoneWidget = this.instantiationService.createInstance(commentThreadWidget_1.ReviewZoneWidget, this.editor, owner, thread, pendingComment, draftMode);
            zoneWidget.display(thread.range.startLineNumber);
            this._commentWidgets.push(zoneWidget);
        }
        addComment(lineNumber, replyCommand, ownerId, extensionId, draftMode, pendingComment) {
            if (this._newCommentWidget) {
            ...
            this._newCommentWidget = this.instantiationService.createInstance(commentThreadWidget_1.ReviewZoneWidget, this.editor, ownerId, {
                ...
                reply: replyCommand,
                collapsibleState: extHostTypes_1.CommentThreadCollapsibleState.Expanded,
        ...
        addOrToggleCommentAtLine(lineNumber) {
        ...
        setComments(commentInfos) {
            ...
            let lineDecorationsWidth = this.editor.getConfiguration().layoutInfo.decorationsWidth;
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        when: exports.ctxCommentThreadVisible,
        handler: closeReviewPanel
    });
    function getActiveEditor(accessor) {
        let activeTextEditorWidget = accessor.get(editorService_1.IEditorService).activeTextEditorWidget;
    ...
    function closeReviewPanel(accessor, args) {
    ...
    themeService_1.registerThemingParticipant((theme, collector) => {
        const peekViewBackground = theme.getColor(referencesWidget_1.peekViewResultsBackground);
        ...
        const monacoEditorBackground = theme.getColor(referencesWidget_1.peekViewTitleBackground);
        ...
        const selectionBackground = theme.getColor(referencesWidget_1.peekViewResultsSelectionBackground);
