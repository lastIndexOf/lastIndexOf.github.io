...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/strings", "vs/platform/commands/common/commands", "vs/base/common/arrays", "vs/workbench/contrib/welcome/walkThrough/common/walkThroughInput", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/editor/common/editorService", "vs/base/common/errors", "vs/platform/windows/common/windows", "vs/platform/workspace/common/workspace", "vs/platform/configuration/common/configuration", "vs/nls", "vs/base/common/actions", "vs/platform/telemetry/common/telemetry", "vs/base/common/network", "vs/workbench/services/backup/common/backup", "vs/workbench/contrib/extensions/common/extensionsUtils", "vs/platform/extensionManagement/common/extensionManagement", "vs/workbench/contrib/welcome/page/browser/vs_code_welcome_page", "vs/platform/lifecycle/common/lifecycle", "vs/base/common/lifecycle", "vs/base/common/labels", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/contrib/welcome/walkThrough/common/walkThroughUtils", "vs/workbench/contrib/extensions/common/extensions", "vs/platform/notification/common/notification", "vs/base/common/async", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/label/common/label", "vs/platform/files/common/files", "vs/base/common/resources", "vs/platform/history/common/history", "vs/css!./welcomePage"], function (require, exports, uri_1, strings, commands_1, arrays, walkThroughInput_1, instantiation_1, editorService_1, errors_1, windows_1, workspace_1, configuration_1, nls_1, actions_1, telemetry_1, network_1, backup_1, extensionsUtils_1, extensionManagement_1, vs_code_welcome_page_1, lifecycle_1, lifecycle_2, labels_1, themeService_1, colorRegistry_1, walkThroughUtils_1, extensions_1, notification_1, async_1, extensionManagementUtil_1, label_1, files_1, resources_1, history_1) {
    "use strict";
    ...
    let WelcomePageContribution = class WelcomePageContribution {
        constructor(instantiationService, configurationService, editorService, backupFileService, fileService, contextService, lifecycleService, commandService) {
    ...
    */
    ...
    let WelcomePage = class WelcomePage {
        constructor(editorService, instantiationService, windowService, contextService, configurationService, labelService, notificationService, extensionEnablementService, extensionGalleryService, extensionManagementService, tipsService, extensionsWorkbenchService, lifecycleService, telemetryService) {
        ...
        onReady(container, recentlyOpened, installedExtensions) {
            ...
            recentlyOpened.then(({ workspaces }) => {
                ...
                workspaces = workspaces.filter(recent => !this.contextService.isCurrentWorkspace(history_1.isRecentWorkspace(recent) ? recent.workspace : recent.folderUri));
            ...
            this.disposables.push(this.instantiationService.invokeFunction(extensionsUtils_1.onExtensionChanged)(ids => {
                for (const id of ids) {
            ...
            this.instantiationService.invokeFunction(extensionsUtils_1.getInstalledExtensions).then(extensions => {
                ...
                const foundAndInstalled = installedExtension ? Promise.resolve(installedExtension.local) : this.extensionGalleryService.query({ names: [extensionSuggestion.id], source: telemetryFrom })
                    ...
                    return this.extensionManagementService.installFromGallery(extension)
                        ...
                        return this.extensionEnablementService.setEnablement([local], 0 /* Disabled */).then(() => local);
                    });
                });
                this.notificationService.prompt(notification_1.Severity.Info, strings.reloadAfterInstall.replace('{0}', extensionSuggestion.name), [{
                        ...
                        run: () => {
                            ...
                            extensionsToDisable.length ? this.extensionEnablementService.setEnablement(extensionsToDisable, 0 /* Disabled */) : Promise.resolve()
                                .then(() => {
                                return foundAndInstalled.then(foundExtension => {
                                    messageDelay.cancel();
                                    if (foundExtension) {
                                        return this.extensionEnablementService.setEnablement([foundExtension], 2 /* Enabled */)
                                            .then(() => {
                                            /* __GDPR__FRAGMENT__
                                                "WelcomePageInstalled-2" : {
                                                    "from" : { "classification": "SystemMetaData", "purpose": "FeatureInsight" },
    ...
    WelcomePage = __decorate([
        ...
        __param(7, extensionManagement_1.IExtensionEnablementService),
