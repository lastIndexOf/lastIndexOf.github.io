...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/nls", "vs/workbench/contrib/terminal/common/terminal", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/browser/ui/splitview/splitview", "vs/workbench/services/layout/browser/layoutService"], function (require, exports, aria, nls, terminal_1, event_1, lifecycle_1, splitview_1, layoutService_1) {
    ...
    let TerminalTab = class TerminalTab extends lifecycle_1.Disposable {
        constructor(terminalFocusContextKey, configHelper, _container, shellLaunchConfig, _terminalService, _layoutService) {
            super();
            this._container = _container;
            ...
            const instance = this._terminalService.createInstance(terminalFocusContextKey, configHelper, undefined, shellLaunchConfig, true);
        ...
        attachToElement(element) {
            ...
            if (!this._splitPaneContainer) {
                ...
                const orientation = this._panelPosition === 2 /* BOTTOM */ ? 1 /* HORIZONTAL */ : 0 /* VERTICAL */;
        ...
        split(terminalFocusContextKey, configHelper, shellLaunchConfig) {
            const newTerminalSize = ((this._panelPosition === 2 /* BOTTOM */ ? this._container.clientWidth : this._container.clientHeight) / (this._terminalInstances.length + 1));
        ...
        layout(width, height) {
            if (this._splitPaneContainer) {
                ...
                if (panelPositionChanged) {
                    const newOrientation = newPanelPosition === 2 /* BOTTOM */ ? 1 /* HORIZONTAL */ : 0 /* VERTICAL */;
