...
define(["require", "exports", "vs/editor/contrib/find/simpleFindWidget", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/terminal/common/terminal", "vs/platform/contextkey/common/contextkey"], function (require, exports, simpleFindWidget_1, contextView_1, terminal_1, contextkey_1) {
    "use strict";
    ...
    let TerminalFindWidget = class TerminalFindWidget extends simpleFindWidget_1.SimpleFindWidget {
        constructor(findState, _contextViewService, _contextKeyService, _terminalService) {
            ...
            this._findInputFocused = terminal_1.KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_INPUT_FOCUSED.bindTo(this._contextKeyService);
            this._findWidgetFocused = terminal_1.KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_FOCUSED.bindTo(this._contextKeyService);
        }
        find(previous) {
