...
define(["require", "exports", "vs/nls", "vs/base/common/actions", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/terminal/common/terminal", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/browser/panel", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/panel/common/panelService", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/quickOpen/common/quickOpen", "vs/platform/quickinput/common/quickInput", "vs/workbench/browser/actions", "vs/workbench/contrib/terminal/browser/terminalQuickOpen", "vs/platform/instantiation/common/instantiation", "vs/platform/contextview/browser/contextView", "vs/platform/commands/common/commands", "vs/platform/workspace/common/workspace", "vs/workbench/browser/actions/workspaceCommands", "vs/platform/notification/common/notification", "vs/editor/browser/editorExtensions", "vs/base/common/async", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/workbench/services/history/common/history", "vs/base/common/network", "vs/base/common/platform"], function (require, exports, nls, actions_1, codeEditorService_1, terminal_1, actionbar_1, panel_1, layoutService_1, panelService_1, styler_1, themeService_1, quickOpen_1, quickInput_1, actions_2, terminalQuickOpen_1, instantiation_1, contextView_1, commands_1, workspace_1, workspaceCommands_1, notification_1, editorExtensions_1, async_1, configurationResolver_1, history_1, network_1, platform_1) {
    ...
    let SwitchTerminalActionItem = class SwitchTerminalActionItem extends actionbar_1.SelectActionItem {
        ...
        _updateItems() {
            this.setOptions(this.terminalService.getTabLabels().map(label => ({ text: label })), this.terminalService.activeTabIndex);
        }
    };
    ...
    let AllowWorkspaceShellTerminalCommand = class AllowWorkspaceShellTerminalCommand extends actions_1.Action {
        constructor(id, label, terminalService) {
            super(id, label);
            this.terminalService = terminalService;
        }
    ...
    AllowWorkspaceShellTerminalCommand.ID = "workbench.action.terminal.allowWorkspaceShell" /* WORKSPACE_SHELL_ALLOW */;
    ...
    let DisallowWorkspaceShellTerminalCommand = class DisallowWorkspaceShellTerminalCommand extends actions_1.Action {
        constructor(id, label, terminalService) {
            super(id, label);
            this.terminalService = terminalService;
        }
    ...
    DisallowWorkspaceShellTerminalCommand.ID = "workbench.action.terminal.disallowWorkspaceShell" /* WORKSPACE_SHELL_DISALLOW */;
