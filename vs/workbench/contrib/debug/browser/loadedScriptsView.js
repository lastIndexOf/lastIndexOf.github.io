...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/path", "vs/workbench/browser/parts/views/panelViewlet", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/debug/browser/baseDebugView", "vs/workbench/contrib/debug/common/debug", "vs/platform/workspace/common/workspace", "vs/platform/contextkey/common/contextkey", "vs/platform/environment/common/environment", "vs/base/common/labels", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/strings", "vs/base/common/async", "vs/workbench/browser/labels", "vs/platform/files/common/files", "vs/workbench/services/editor/common/editorService", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/workbench/contrib/debug/browser/debugContentProvider", "vs/base/common/lifecycle", "vs/base/common/filters"], function (require, exports, nls, dom, path_1, panelViewlet_1, contextView_1, keybinding_1, instantiation_1, configuration_1, baseDebugView_1, debug_1, workspace_1, contextkey_1, environment_1, labels_1, platform_1, uri_1, strings_1, async_1, labels_2, files_1, editorService_1, listService_1, themeService_1, debugContentProvider_1, lifecycle_1, filters_1) {
    "use strict";
    ...
    class RootTreeItem extends BaseTreeItem {
        constructor(_debugModel, _environmentService, _contextService) {
    ...
    class SessionTreeItem extends BaseTreeItem {
        constructor(parent, session, _environmentService, rootProvider) {
    ...
    let LoadedScriptsView = class LoadedScriptsView extends panelViewlet_1.ViewletPanel {
        constructor(options, contextMenuService, keybindingService, instantiationService, configurationService, editorService, contextKeyService, contextService, environmentService, debugService, listService, themeService) {
            super(Object.assign({}, options, { ariaHeaderLabel: nls.localize('loadedScriptsSection', "Loaded Scripts Section") }), keybindingService, contextMenuService, configurationService);
        ...
        renderBody(container) {
            ...
            this.tree = new listService_1.WorkbenchAsyncDataTree(this.treeContainer, new LoadedScriptsDelegate(), [new LoadedScriptsRenderer(this.treeLabels)], new LoadedScriptsDataSource(), {
                identityProvider: {
