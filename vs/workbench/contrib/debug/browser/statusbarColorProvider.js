...
define(["require", "exports", "vs/platform/theme/common/themeService", "vs/nls", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/debug/common/debug", "vs/platform/workspace/common/workspace", "vs/workbench/common/theme", "vs/base/browser/dom"], function (require, exports, themeService_1, nls_1, colorRegistry_1, layoutService_1, debug_1, workspace_1, theme_1, dom_1) {
    ...
    let StatusBarColorProvider = class StatusBarColorProvider extends theme_1.Themable {
        ...
        updateStyles() {
            super.updateStyles();
            const container = this.layoutService.getContainer("workbench.parts.statusbar" /* STATUSBAR_PART */);
            if (!container) {
                return;
            }
    ...
    function isStatusbarInDebugMode(debugService) {
        if (debugService.state === 0 /* Inactive */ || debugService.state === 1 /* Initializing */) {
            return false;
        }
    ...
    themeService_1.registerThemingParticipant((theme, collector) => {
        const statusBarItemDebuggingForeground = theme.getColor(exports.STATUS_BAR_DEBUGGING_FOREGROUND);
