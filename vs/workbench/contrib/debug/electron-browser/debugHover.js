...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/editor/common/core/range", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugModel", "vs/workbench/contrib/debug/browser/baseDebugView", "vs/workbench/contrib/debug/electron-browser/variablesView", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/editor/common/model/textModel", "vs/workbench/contrib/debug/common/debugUtils", "vs/platform/list/browser/listService", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/base/common/arrays", "vs/platform/keybinding/common/keybinding"], function (require, exports, nls, lifecycle, dom, range_1, instantiation_1, debug_1, debugModel_1, baseDebugView_1, variablesView_1, scrollableElement_1, styler_1, themeService_1, colorRegistry_1, textModel_1, debugUtils_1, listService_1, configuration_1, contextkey_1, arrays_1, keybinding_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const $ = dom.$;
    const MAX_TREE_HEIGHT = 324;
    let DebugHoverWidget = class DebugHoverWidget {
        constructor(editor, debugService, instantiationService, themeService, contextKeyService, listService, configurationService, keybindingService) {
            this.editor = editor;
        ...
        create() {
            ...
            this.tree = new listService_1.WorkbenchAsyncDataTree(this.treeContainer, new DebugHoverDelegate(), [this.instantiationService.createInstance(variablesView_1.VariablesRenderer)], this.dataSource, {
    ...
    DebugHoverWidget = __decorate([
        ...
        __param(5, listService_1.IListService),
