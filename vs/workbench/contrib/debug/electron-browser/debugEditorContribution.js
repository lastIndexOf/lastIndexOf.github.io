...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/json", "vs/base/common/severity", "vs/base/common/actions", "vs/editor/common/model/wordHelper", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/configuration/common/configuration", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/debug/electron-browser/debugHover", "vs/workbench/contrib/debug/browser/debugActions", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/electron-browser/breakpointWidget", "vs/workbench/contrib/debug/browser/exceptionWidget", "vs/workbench/browser/parts/editor/editorWidgets", "vs/editor/common/core/position", "vs/editor/browser/controller/coreCommands", "vs/base/common/arrays", "vs/platform/keybinding/common/keybinding", "vs/base/browser/contextmenu", "vs/base/common/decorators", "vs/platform/dialogs/common/dialogs", "vs/editor/contrib/hover/getHover", "vs/base/common/cancellation"], function (require, exports, nls, async_1, lifecycle, env, json_1, severity_1, actions_1, wordHelper_1, editorExtensions_1, codeEditorService_1, range_1, instantiation_1, telemetry_1, configuration_1, commands_1, contextkey_1, contextView_1, debugHover_1, debugActions_1, debug_1, breakpointWidget_1, exceptionWidget_1, editorWidgets_1, position_1, coreCommands_1, arrays_1, keybinding_1, contextmenu_1, decorators_1, dialogs_1, getHover_1, cancellation_1) {
    ...
    let DebugEditorContribution = class DebugEditorContribution {
        ...
        get showHoverScheduler() {
            const scheduler = new async_1.RunOnceScheduler(() => this.showHover(this.hoverRange, false), HOVER_DELAY);
            this.toDispose.push(scheduler);
            return scheduler;
        }
        get hideHoverScheduler() {
            const scheduler = new async_1.RunOnceScheduler(() => this.hoverWidget.hide(), 2 * HOVER_DELAY);
            this.toDispose.push(scheduler);
            return scheduler;
        }
