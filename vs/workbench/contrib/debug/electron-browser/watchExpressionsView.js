...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/browser/dom", "vs/workbench/browser/viewlet", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugModel", "vs/workbench/contrib/debug/browser/debugActions", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/workbench/contrib/debug/electron-browser/electronDebugActions", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/contrib/debug/browser/baseDebugView", "vs/platform/configuration/common/configuration", "vs/workbench/browser/parts/views/panelViewlet", "vs/workbench/contrib/debug/electron-browser/variablesView", "vs/platform/contextkey/common/contextkey", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/base/common/errors", "vs/base/browser/ui/list/listView"], function (require, exports, nls, async_1, dom, viewlet_1, debug_1, debugModel_1, debugActions_1, contextView_1, instantiation_1, keybinding_1, electronDebugActions_1, actionbar_1, baseDebugView_1, configuration_1, panelViewlet_1, variablesView_1, contextkey_1, listService_1, themeService_1, errors_1, listView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const MAX_VALUE_RENDER_LENGTH_IN_VIEWLET = 1024;
    let WatchExpressionsView = class WatchExpressionsView extends panelViewlet_1.ViewletPanel {
        constructor(options, contextMenuService, debugService, keybindingService, instantiationService, configurationService, contextKeyService, listService, themeService) {
            super(Object.assign({}, options, { ariaHeaderLabel: nls.localize('watchExpressionsSection', "Watch Expressions Section") }), keybindingService, contextMenuService, configurationService);
        ...
        renderBody(container) {
            ...
            this.tree = new listService_1.WorkbenchAsyncDataTree(treeContainer, new WatchExpressionsDelegate(), [expressionsRenderer, this.instantiationService.createInstance(variablesView_1.VariablesRenderer)], new WatchExpressionsDataSource(), {
            ...
            this.disposables.push(variablesView_1.variableSetEmitter.event(() => this.tree.updateChildren()));
        ...
        onContextMenu(e) {
            ...
            if (element instanceof debugModel_1.Expression) {
                ...
                if (!expression.hasChildren) {
                    actions.push(new electronDebugActions_1.CopyValueAction(electronDebugActions_1.CopyValueAction.ID, electronDebugActions_1.CopyValueAction.LABEL, expression.value, 'watch', this.debugService));
                }
                ...
                if (element instanceof debugModel_1.Variable) {
                    ...
                    if (!variable.hasChildren) {
                        actions.push(new electronDebugActions_1.CopyValueAction(electronDebugActions_1.CopyValueAction.ID, electronDebugActions_1.CopyValueAction.LABEL, variable, 'watch', this.debugService));
                    }
                    actions.push(new actionbar_1.Separator());
                }
                actions.push(new debugActions_1.RemoveAllWatchExpressionsAction(debugActions_1.RemoveAllWatchExpressionsAction.ID, debugActions_1.RemoveAllWatchExpressionsAction.LABEL, this.debugService, this.keybindingService));
