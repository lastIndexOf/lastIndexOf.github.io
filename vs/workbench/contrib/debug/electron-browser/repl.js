...
define(["require", "exports", "vs/nls", "vs/base/common/uri", "vs/base/common/errors", "vs/base/common/actions", "vs/base/browser/dom", "vs/base/browser/ui/aria/aria", "vs/base/common/severity", "vs/editor/contrib/suggest/suggestController", "vs/editor/browser/editorExtensions", "vs/editor/common/services/modelService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/contextkey/common/contextkey", "vs/platform/telemetry/common/telemetry", "vs/platform/instantiation/common/instantiation", "vs/platform/storage/common/storage", "vs/workbench/browser/panel", "vs/platform/theme/common/themeService", "electron", "vs/base/common/decorators", "vs/base/common/lifecycle", "vs/editor/common/editorContextKeys", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/contrib/debug/common/debug", "vs/base/common/history", "vs/platform/browser/contextScopedHistoryWidget", "vs/workbench/contrib/codeEditor/browser/simpleEditorOptions", "vs/platform/theme/common/colorRegistry", "vs/editor/browser/services/codeEditorService", "vs/workbench/contrib/debug/browser/debugActionItems", "vs/editor/common/modes", "vs/base/common/arrays", "vs/workbench/services/panel/common/panelService", "vs/workbench/contrib/debug/common/debugModel", "vs/workbench/contrib/debug/electron-browser/variablesView", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/debug/browser/baseDebugView", "vs/workbench/contrib/debug/browser/debugANSIHandling", "vs/platform/label/common/label", "vs/workbench/contrib/debug/browser/linkDetector", "vs/workbench/contrib/debug/electron-browser/electronDebugActions", "vs/workbench/contrib/debug/browser/debugActions", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/contextview/browser/contextView", "vs/base/common/strings", "vs/platform/list/browser/listService", "vs/platform/configuration/common/configuration", "vs/editor/common/services/resourceConfiguration", "vs/base/common/async", "vs/platform/keybinding/common/keybinding", "vs/base/common/filters", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/css!vs/workbench/contrib/debug/browser/media/repl"], function (require, exports, nls, uri_1, errors, actions_1, dom, aria, severity_1, suggestController_1, editorExtensions_1, modelService_1, serviceCollection_1, contextkey_1, telemetry_1, instantiation_1, storage_1, panel_1, themeService_1, electron_1, decorators_1, lifecycle_1, editorContextKeys_1, codeEditorWidget_1, debug_1, history_1, contextScopedHistoryWidget_1, simpleEditorOptions_1, colorRegistry_1, codeEditorService_1, debugActionItems_1, modes_1, arrays_1, panelService_1, debugModel_1, variablesView_1, editorService_1, baseDebugView_1, debugANSIHandling_1, label_1, linkDetector_1, electronDebugActions_1, debugActions_1, actionbar_1, contextView_1, strings_1, listService_1, configuration_1, resourceConfiguration_1, async_1, keybinding_1, filters_1, highlightedLabel_1) {
    "use strict";
    ...
    let Repl = class Repl extends panel_1.Panel {
        constructor(debugService, telemetryService, instantiationService, storageService, themeService, modelService, contextKeyService, codeEditorService, contextMenuService, listService, configurationService, textResourcePropertiesService, keybindingService) {
        ...
        create(parent) {
            ...
            this.tree = new listService_1.WorkbenchAsyncDataTree(treeContainer, this.replDelegate, [
        ...
        onContextMenu(e) {
            ...
            actions.push(new actions_1.Action('workbench.debug.action.copyAll', nls.localize('copyAll', "Copy All"), undefined, true, () => {
                electron_1.clipboard.writeText(this.getVisibleContent());
                return Promise.resolve(undefined);
            }));
            actions.push(new debugActions_1.ReplCollapseAllAction(this.tree, this.replInput));
    ...
    Repl = __decorate([
        ...
        __param(11, resourceConfiguration_1.ITextResourcePropertiesService),
    ...
    let ReplSimpleElementsRenderer = class ReplSimpleElementsRenderer {
        constructor(editorService, labelService, instantiationService) {
        ...
        renderElement({ element }, index, templateData) {
            ...
            const result = debugANSIHandling_1.handleANSIOutput(element.value, this.linkDetector);
    ...
    class ReplDelegate {
        ...
        getHeight(element) {
            ...
            const fontSize = this.configurationService.getValue('debug').console.fontSize;
    ...
    class SelectReplActionItem extends debugActionItems_1.FocusSessionActionItem {
        getSessions() {
