...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/browser/dom", "vs/workbench/contrib/debug/common/debug", "vs/workbench/contrib/debug/common/debugModel", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/actions/common/actions", "vs/platform/keybinding/common/keybinding", "vs/workbench/contrib/debug/browser/baseDebugView", "vs/workbench/contrib/debug/browser/debugActions", "vs/workbench/contrib/debug/electron-browser/electronDebugActions", "vs/workbench/services/editor/common/editorService", "vs/platform/configuration/common/configuration", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/contextkey/common/contextkey", "vs/workbench/browser/parts/views/panelViewlet", "vs/platform/label/common/label", "vs/workbench/contrib/debug/electron-browser/debugSession", "vs/platform/actions/browser/menuItemActionItem", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/base/common/errors", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/base/common/filters"], function (require, exports, nls, async_1, dom, debug_1, debugModel_1, contextView_1, instantiation_1, actions_1, keybinding_1, baseDebugView_1, debugActions_1, electronDebugActions_1, editorService_1, configuration_1, actionbar_1, contextkey_1, panelViewlet_1, label_1, debugSession_1, menuItemActionItem_1, listService_1, themeService_1, errors_1, highlightedLabel_1, filters_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const $ = dom.$;
    let CallStackView = class CallStackView extends panelViewlet_1.ViewletPanel {
        constructor(options, contextMenuService, debugService, keybindingService, instantiationService, editorService, configurationService, menuService, contextKeyService, themeService, listService) {
            super(Object.assign({}, options, { ariaHeaderLabel: nls.localize('callstackSection', "Call Stack Section") }), keybindingService, contextMenuService, configurationService);
        ...
        renderBody(container) {
            ...
            this.tree = new listService_1.WorkbenchAsyncDataTree(treeContainer, new CallStackDelegate(), [
                ...
                keyboardNavigationLabelProvider: {
                    getKeyboardNavigationLabel: e => {
                        if (e instanceof debugSession_1.DebugSession) {
                            return e.getLabel();
                        }
            ...
            this.disposables.push(callstackNavigator.onDidOpenResource(e => {
                ...
                if (element instanceof debugSession_1.DebugSession) {
        ...
        updateTreeSelection() {
            ...
            if (!thread) {
                ...
                const expansionsPromise = async_1.ignoreErrors(this.tree.expand(thread.session))
                    .then(() => async_1.ignoreErrors(this.tree.expand(thread)));
                if (stackFrame) {
        ...
        onContextMenu(e) {
            ...
            if (element instanceof debugSession_1.DebugSession) {
                ...
                actions.push(new debugActions_1.TerminateThreadAction(debugActions_1.TerminateThreadAction.ID, debugActions_1.TerminateThreadAction.LABEL, this.debugService, this.keybindingService));
            }
            ...
            this.contextMenuService.showContextMenu({
                getAnchor: () => e.anchor,
                getActions: () => {
                    menuItemActionItem_1.fillInContextMenuActions(this.contributedContextMenu, { arg: this.getContextForContributedActions(element) }, actions, this.contextMenuService);
                    return actions;
                },
    ...
    class CallStackDataSource {
        hasChildren(element) {
            return isDebugModel(element) || element instanceof debugSession_1.DebugSession || (element instanceof debugModel_1.Thread && element.stopped);
        }
        getChildren(element) {
            ...
            else if (element instanceof debugSession_1.DebugSession) {
