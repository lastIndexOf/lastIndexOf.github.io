 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/severity", "vs/workbench/contrib/debug/common/debugModel", "sinon", "vs/workbench/contrib/debug/test/common/mockDebug", "vs/workbench/contrib/debug/common/debugSource", "vs/workbench/contrib/debug/electron-browser/debugSession", "vs/workbench/contrib/debug/common/replModel"], function (require, exports, assert, uri_1, severity_1, debugModel_1, sinon, mockDebug_1, debugSource_1, debugSession_1, replModel_1) {
    "use strict";
    ...
    suite('Debug - Model', () => {
        ...
        let rawSession;
        setup(() => {
            model = new debugModel_1.DebugModel([], true, [], [], [], { isDirty: (e) => false });
        ...
        test('threads simple', () => {
            ...
            const session = new debugSession_1.DebugSession({ resolved: { name: 'mockSession', type: 'node', request: 'launch' }, unresolved: undefined }, undefined, model, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
        ...
        test('repl output', () => {
            ...
            repl.appendToRepl('third line', severity_1.default.Warning);
            ...
            const element = repl.getReplElements()[5];
