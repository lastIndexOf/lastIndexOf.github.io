 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/dom", "vs/base/common/uuid", "vs/workbench/contrib/debug/browser/debugANSIHandling", "vs/workbench/test/workbenchTestServices", "vs/workbench/contrib/debug/browser/linkDetector"], function (require, exports, assert, dom, uuid_1, debugANSIHandling_1, workbenchTestServices_1, linkDetector_1) {
    "use strict";
    ...
    suite('Debug - ANSI Handling', () => {
        ...
        test('appendStylizedStringToContainer', () => {
            ...
            debugANSIHandling_1.appendStylizedStringToContainer(root, 'content1', ['class1', 'class2'], linkDetector);
            debugANSIHandling_1.appendStylizedStringToContainer(root, 'content2', ['class2', 'class3'], linkDetector);
        ...
        function getSequenceOutput(sequence) {
            const root = debugANSIHandling_1.handleANSIOutput(sequence, linkDetector);
         ...
         */
        function assertMultipleSequenceElements(sequence, assertions) {
            const root = debugANSIHandling_1.handleANSIOutput(sequence, linkDetector);
