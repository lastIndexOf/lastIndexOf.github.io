...
define(["require", "exports", "vs/base/common/json", "vs/base/common/collections", "vs/nls", "vs/base/common/path", "vs/editor/contrib/snippet/snippetParser", "vs/editor/contrib/snippet/snippetVariables", "vs/base/common/strings"], function (require, exports, json_1, collections_1, nls_1, path_1, snippetParser_1, snippetVariables_1, strings_1) {
    ...
    class Snippet {
        ...
        static _rewriteBogousVariables(template) {
            const textmateSnippet = new snippetParser_1.SnippetParser().parse(template, false);
    ...
    class SnippetFile {
        constructor(source, location, defaultScopes, _extension, _fileService) {
            this.source = source;
        ...
        load() {
            if (!this._loadPromise) {
                this._loadPromise = Promise.resolve(this._fileService.resolveContent(this.location, { encoding: 'utf8' })).then(content => {
                    const data = json_1.parse(content.value.toString());
