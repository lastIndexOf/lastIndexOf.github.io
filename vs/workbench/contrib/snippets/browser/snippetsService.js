...
define(["require", "exports", "vs/base/common/path", "vs/base/common/lifecycle", "vs/base/common/map", "vs/base/common/resources", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/common/services/modeService", "vs/editor/contrib/suggest/suggest", "vs/nls", "vs/platform/environment/common/environment", "vs/platform/files/common/files", "vs/platform/instantiation/common/extensions", "vs/platform/lifecycle/common/lifecycle", "vs/platform/log/common/log", "vs/platform/workspace/common/workspace", "vs/workbench/contrib/snippets/browser/snippets.contribution", "vs/workbench/contrib/snippets/browser/snippetsFile", "vs/workbench/services/extensions/common/extensionsRegistry", "vs/workbench/services/mode/common/workbenchModeService", "./snippetCompletionProvider"], function (require, exports, path_1, lifecycle_1, map_1, resources, strings_1, uri_1, modeService_1, suggest_1, nls_1, environment_1, files_1, extensions_1, lifecycle_2, log_1, workspace_1, snippets_contribution_1, snippetsFile_1, extensionsRegistry_1, workbenchModeService_1, snippetCompletionProvider_1) {
    "use strict";
    ...
    let SnippetsService = class SnippetsService {
        constructor(_environmentService, _contextService, _modeService, _logService, _fileService, lifecycleService) {
        ...
        getSnippetFiles() {
            return this._joinSnippets().then(() => map_1.values(this._files));
        }
                ...
                for (const extension of extensions) {
                    for (const contribution of extension.value) {
                        ...
                        if (file) {
                            ...
                            const file = new snippetsFile_1.SnippetFile(3 /* Extension */, validContribution.location, validContribution.language ? [validContribution.language] : undefined, extension.description, this._fileService);
        ...
        _initUserSnippets() {
            const userSnippetsFolder = uri_1.URI.file(path_1.join(this._environmentService.appSettingsHome, 'snippets'));
