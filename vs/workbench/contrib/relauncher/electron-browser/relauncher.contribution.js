...
define(["require", "exports", "vs/base/common/lifecycle", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/platform/windows/common/windows", "vs/platform/configuration/common/configuration", "vs/nls", "vs/platform/environment/common/environment", "vs/platform/workspace/common/workspace", "vs/workbench/services/extensions/common/extensions", "vs/base/common/async", "vs/base/common/resources", "vs/base/common/platform", "vs/platform/dialogs/common/dialogs", "vs/base/common/objects"], function (require, exports, lifecycle_1, contributions_1, platform_1, windows_1, configuration_1, nls_1, environment_1, workspace_1, extensions_1, async_1, resources_1, platform_2, dialogs_1, objects_1) {
    ...
    let SettingsChangeRelauncher = class SettingsChangeRelauncher extends lifecycle_1.Disposable {
        ...
        onConfigurationChange(config, notify) {
            ...
            if (!this.experimentalFileWatcher && this.contextService.getWorkbenchState() === 2 /* FOLDER */) {
            ...
            if (platform_2.isMacintosh && config.keyboard && config.keyboard.touchbar && typeof config.keyboard.touchbar.enabled === 'boolean' && config.keyboard.touchbar.enabled !== this.touchbarEnabled) {
