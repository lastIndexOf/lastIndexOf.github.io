...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/aria/aria", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/iterator", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/editor/browser/editorBrowser", "vs/nls", "vs/platform/actions/browser/menuItemActionItem", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/dialogs/common/dialogs", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/list/browser/listService", "vs/platform/notification/common/notification", "vs/platform/progress/common/progress", "vs/workbench/services/search/common/search", "vs/workbench/contrib/search/common/searchHistoryService", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/browser/actions/workspaceActions", "vs/workbench/browser/labels", "vs/workbench/contrib/search/browser/patternInputWidget", "vs/workbench/contrib/search/browser/searchActions", "vs/workbench/contrib/search/browser/searchResultsView", "vs/workbench/contrib/search/browser/searchWidget", "vs/workbench/contrib/search/common/constants", "vs/workbench/contrib/search/common/queryBuilder", "vs/workbench/contrib/search/common/replace", "vs/workbench/contrib/search/common/search", "vs/workbench/contrib/search/common/searchModel", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/untitled/common/untitledEditorService", "vs/base/common/resources", "vs/platform/accessibility/common/accessibility", "vs/workbench/browser/parts/views/panelViewlet", "vs/platform/keybinding/common/keybinding", "vs/workbench/common/memento", "vs/platform/storage/common/storage", "vs/css!./media/searchview"], function (require, exports, dom, keyboardEvent_1, aria, async_1, errors, event_1, iterator_1, lifecycle_1, env, strings, editorBrowser_1, nls, menuItemActionItem_1, actions_1, configuration_1, contextkey_1, contextView_1, dialogs_1, files_1, instantiation_1, listService_1, notification_1, progress_1, search_1, searchHistoryService_1, colorRegistry_1, themeService_1, workspace_1, workspaceActions_1, labels_1, patternInputWidget_1, searchActions_1, searchResultsView_1, searchWidget_1, Constants, queryBuilder_1, replace_1, search_2, searchModel_1, editorService_1, editorGroupsService_1, preferences_1, untitledEditorService_1, resources_1, accessibility_1, panelViewlet_1, keybinding_1, memento_1, storage_1) {
    "use strict";
    ...
    let SearchView = class SearchView extends panelViewlet_1.ViewletPanel {
        constructor(options, fileService, editorService, progressService, notificationService, dialogService, contextViewService, instantiationService, configurationService, contextService, searchWorkbenchService, contextKeyService, replaceService, untitledEditorService, preferencesService, themeService, searchHistoryService, editorGroupsService, contextMenuService, menuService, accessibilityService, keybindingService, storageService) {
            super(Object.assign({}, options, { id: search_1.VIEW_ID, ariaHeaderLabel: nls.localize('searchView', "Search") }), keybindingService, contextMenuService, configurationService);
            ...
            this.globalMemento = this.memento.getMemento(0 /* GLOBAL */);
            ...
            this.selectCurrentMatchEmitter = this._register(new event_1.Emitter());
            this._register(event_1.Event.debounce(this.selectCurrentMatchEmitter.event, (l, e) => e, 100, /*leading=*/ true)(() => this.selectCurrentMatch()));
        ...
        refreshTree(event) {
            ...
            if (!event || event.added || event.removed) {
                ...
                event.elements.forEach(element => {
                    ...
                    const root = element instanceof searchModel_1.SearchResult ? null : element;
        ...
        createSearchResultsView(container) {
            ...
            const resourceNavigator = this._register(new listService_1.TreeResourceNavigator2(this.tree, { openOnFocus: true }));
        ...
        onContextMenu(e) {
            ...
            this.contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    const actions = [];
                    menuItemActionItem_1.fillInContextMenuActions(this.contextMenu, { shouldForwardArgs: true }, actions, this.contextMenuService);
                    return actions;
                },
        ...
        selectCurrentMatch() {
            ...
            const fakeKeyboardEvent = listService_1.getSelectionKeyboardEvent(undefined, false);
        ...
        doSearch(query, options, excludePatternText, includePatternText) {
            ...
            const onError = (e) => {
                if (errors.isPromiseCanceledError(e)) {
                    ...
                    this.viewModel.searchResult.clear();
                    if (e.code === search_1.SearchErrorCode.regexParseError && !this.configurationService.getValue('search.usePCRE2')) {
                        this.showPcre2Hint();
                    }
        ...
        showSearchWithoutFolderMessage() {
            ...
            const textEl = dom.append(this.searchWithoutFolderMessageElement, $('p', undefined, nls.localize('searchWithoutFolder', "You have not yet opened a folder. Only open files are currently searched - ")));
    ...
    SearchView = __decorate([
        ...
        __param(19, actions_1.IMenuService),
