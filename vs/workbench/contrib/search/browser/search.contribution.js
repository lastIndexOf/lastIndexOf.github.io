...
define(["require", "exports", "vs/base/common/actions", "vs/base/common/arrays", "vs/base/common/errors", "vs/base/common/network", "vs/base/common/objects", "vs/base/common/platform", "vs/base/common/resources", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/contrib/find/findController", "vs/editor/contrib/find/findModel", "vs/nls", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationRegistry", "vs/platform/contextkey/common/contextkey", "vs/platform/files/common/files", "vs/platform/instantiation/common/extensions", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/list/browser/listService", "vs/platform/quickOpen/common/quickOpen", "vs/platform/registry/common/platform", "vs/workbench/services/search/common/search", "vs/workbench/browser/parts/quickopen/quickopen", "vs/workbench/browser/quickopen", "vs/workbench/common/actions", "vs/workbench/common/contributions", "vs/workbench/common/resources", "vs/workbench/contrib/files/browser/files", "vs/workbench/contrib/files/common/files", "vs/workbench/contrib/search/browser/openAnythingHandler", "vs/workbench/contrib/search/browser/openSymbolHandler", "vs/workbench/contrib/search/browser/replaceContributions", "vs/workbench/contrib/search/browser/searchActions", "vs/workbench/contrib/search/browser/searchWidget", "vs/workbench/contrib/search/common/constants", "vs/workbench/contrib/search/common/search", "vs/workbench/contrib/search/common/searchModel", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/browser/panel", "vs/workbench/browser/viewlet", "vs/workbench/contrib/search/common/searchHistoryService", "vs/workbench/contrib/search/browser/searchViewlet", "vs/workbench/contrib/search/browser/searchPanel", "vs/workbench/common/views", "vs/workbench/contrib/search/browser/searchView", "vs/css!./media/search.contribution"], function (require, exports, actions_1, arrays_1, errors_1, network_1, objects, platform, resources_1, editorExtensions_1, codeEditorService_1, findController_1, findModel_1, nls, actions_2, commands_1, configuration_1, configurationRegistry_1, contextkey_1, files_1, extensions_1, instantiation_1, keybindingsRegistry_1, listService_1, quickOpen_1, platform_1, search_1, quickopen_1, quickopen_2, actions_3, contributions_1, resources_2, files_2, files_3, openAnythingHandler_1, openSymbolHandler_1, replaceContributions_1, searchActions_1, searchWidget_1, Constants, search_2, searchModel_1, editorService_1, panelService_1, viewlet_1, panel_1, viewlet_2, searchHistoryService_1, searchViewlet_1, searchPanel_1, views_1, searchView_1) {
    "use strict";
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        handler: accessor => {
            const searchView = searchActions_1.getSearchView(accessor.get(viewlet_1.IViewletService), accessor.get(panelService_1.IPanelService));
            if (searchView) {
    ...
    const searchInFolderCommand = (accessor, resource) => {
        ...
        return searchActions_1.openSearchView(viewletService, panelService, true).then(searchView => {
    ...
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        weight: 200 /* WorkbenchContrib */,
        when: contextkey_1.ContextKeyExpr.and(files_3.FilesExplorerFocusCondition, files_3.ExplorerFolderContext, resources_2.ResourceContextKey.Scheme.isEqualTo(network_1.Schemas.file)),
    ...
    commands_1.CommandsRegistry.registerCommand({
        ...
        handler: (accessor) => {
            return searchActions_1.openSearchView(accessor.get(viewlet_1.IViewletService), accessor.get(panelService_1.IPanelService), true).then(searchView => {
    ...
    actions_2.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, {
        ...
        when: contextkey_1.ContextKeyExpr.and(files_3.ExplorerFolderContext, resources_2.ResourceContextKey.Scheme.isEqualTo(network_1.Schemas.file)) // todo@remote
    });
    actions_2.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, {
        group: '4_search',
        order: 10,
    ...
    platform_1.Registry.as(viewlet_2.Extensions.Viewlets).registerViewlet(new viewlet_2.ViewletDescriptor(searchViewlet_1.SearchViewlet, search_1.VIEWLET_ID, nls.localize('name', "Search"), 'search', 1));
        ...
        constructor(viewletService, panelService, configurationService) {
            ...
            const updateSearchViewLocation = (open) => {
                ...
                if (config.search.location === 'panel') {
                    viewsRegistry.deregisterViews(viewsRegistry.getViews(search_1.VIEW_CONTAINER), search_1.VIEW_CONTAINER);
                    platform_1.Registry.as(panel_1.Extensions.Panels).registerPanel(new panel_1.PanelDescriptor(searchPanel_1.SearchPanel, search_1.PANEL_ID, nls.localize('name', "Search"), 'search', 10));
                    if (open) {
                        panelService.openPanel(search_1.PANEL_ID);
                    }
                }
                else {
                    platform_1.Registry.as(panel_1.Extensions.Panels).deregisterPanel(search_1.PANEL_ID);
                    viewsRegistry.registerViews([{ id: search_1.VIEW_ID, name: nls.localize('search', "Search"), ctorDescriptor: { ctor: searchView_1.SearchView }, canToggleVisibility: false }], search_1.VIEW_CONTAINER);
                    if (open) {
                        viewletService.openViewlet(search_1.VIEWLET_ID);
                    }
                }
            };
    ...
    registry.registerWorkbenchAction(new actions_2.SyncActionDescriptor(searchActions_1.OpenSearchViewletAction, search_1.VIEWLET_ID, searchActions_1.OpenSearchViewletAction.LABEL, { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 36 /* KEY_F */ }, Constants.SearchViewVisibleKey.toNegated()), 'View: Show Search', nls.localize('view', "View"));
    ...
    editorExtensions_1.registerLanguageCommand('_executeWorkspaceSymbolProvider', function (accessor, args) {
        ...
        return search_2.getWorkspaceSymbols(query);
    });
    // View menu
