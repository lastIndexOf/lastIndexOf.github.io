...
define(["require", "exports", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/map", "vs/base/common/platform", "vs/base/common/strings", "vs/base/common/arrays", "vs/base/common/lifecycle", "vs/base/common/decorators", "vs/base/common/event"], function (require, exports, extpath_1, path_1, resources, map_1, platform_1, strings_1, arrays_1, lifecycle_1, decorators_1, event_1) {
    "use strict";
    ...
    class ExplorerItem {
        constructor(resource, _parent, _isDirectory, _isSymbolicLink, _isReadonly, _name = resources.basenameOrAuthority(resource), _mtime, _etag) {
