...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/inputbox/inputBox", "vs/base/browser/ui/widget", "vs/base/common/actions", "vs/base/common/event", "vs/base/common/htmlContent", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/nls", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/common/theme"], function (require, exports, DOM, keyboardEvent_1, actionbar_1, inputBox_1, widget_1, actions_1, event_1, htmlContent_1, lifecycle_1, uri_1, nls_1, contextView_1, instantiation_1, colorRegistry_1, styler_1, themeService_1, workspace_1, theme_1) {
    ...
    let FolderSettingsActionItem = class FolderSettingsActionItem extends actionbar_1.BaseActionItem {
    ...
    let SettingsTargetsWidget = class SettingsTargetsWidget extends widget_1.Widget {
        constructor(parent, contextService, instantiationService) {
            super();
            this.contextService = contextService;
            this.instantiationService = instantiationService;
            this._onDidTargetChange = new event_1.Emitter();
        ...
        create(parent) {
            ...
            this.settingsSwitcherBar = this._register(new actionbar_1.ActionBar(settingsTabsWidget, {
                ...
                animated: false,
                actionItemProvider: (action) => action.id === 'folderSettings' ? this.folderSettings : null
            }));
            this.userSettings = new actions_1.Action('userSettings', nls_1.localize('userSettings', "User Settings"), '.settings-tab', true, () => this.updateTarget(1 /* USER */));
            this.userSettings.tooltip = this.userSettings.label;
            this.workspaceSettings = new actions_1.Action('workspaceSettings', nls_1.localize('workspaceSettings', "Workspace Settings"), '.settings-tab', false, () => this.updateTarget(2 /* WORKSPACE */));
            this.workspaceSettings.tooltip = this.workspaceSettings.label;
            const folderSettingsAction = new actions_1.Action('folderSettings', nls_1.localize('folderSettings', "Folder Settings"), '.settings-tab', false, (folder) => this.updateTarget(folder ? folder.uri : 1 /* USER */));
        ...
        setResultCount(settingsTarget, count) {
            if (settingsTarget === 2 /* WORKSPACE */) {
                let label = nls_1.localize('workspaceSettings', "Workspace Settings");
                if (count) {
                    label += ` (${count})`;
                }
                ...
                let label = nls_1.localize('userSettings', "User Settings");
                if (count) {
                    label += ` (${count})`;
                }
        ...
        updateTarget(settingsTarget) {
            const isSameTarget = this.settingsTarget === settingsTarget || settingsTarget instanceof uri_1.URI && this.settingsTarget instanceof uri_1.URI && this.settingsTarget.toString() === settingsTarget.toString();
            if (!isSameTarget) {
        ...
        create(parent) {
            ...
            if (this.options.showResultCount) {
                ...
                this._register(styler_1.attachStylerCallback(this.themeService, { badgeBackground: colorRegistry_1.badgeBackground, contrastBorder: colorRegistry_1.contrastBorder }, colors => {
                    ...
                    const color = this.themeService.getTheme().getColor(colorRegistry_1.badgeForeground);
