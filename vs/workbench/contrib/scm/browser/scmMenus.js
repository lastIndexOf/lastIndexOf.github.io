...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuItemActionItem", "./scmUtil", "vs/platform/contextview/browser/contextView", "vs/base/common/arrays", "vs/css!./media/scmViewlet"], function (require, exports, event_1, lifecycle_1, contextkey_1, actions_1, menuItemActionItem_1, scmUtil_1, contextView_1, arrays_1) {
    "use strict";
    ...
    let SCMMenus = class SCMMenus {
        constructor(provider, contextKeyService, menuService, contextMenuService) {
            ...
            this.titleMenu = this.menuService.createMenu(33 /* SCMTitle */, this.contextKeyService);
        ...
        updateTitleActions() {
            const primary = [];
            const secondary = [];
            menuItemActionItem_1.fillInActionBarActions(this.titleMenu, { shouldForwardArgs: true }, { primary, secondary });
        ...
        getResourceGroupContextActions(group) {
            return this.getActions(31 /* SCMResourceGroupContext */, group).secondary;
        }
        getResourceContextActions(resource) {
            return this.getActions(30 /* SCMResourceContext */, resource).secondary;
        }
        ...
        onDidSpliceGroups({ start, deleteCount, toInsert }) {
            const menuEntriesToInsert = toInsert.map(group => {
                ...
                const resourceGroupMenu = this.menuService.createMenu(31 /* SCMResourceGroupContext */, contextKeyService);
                const resourceMenu = this.menuService.createMenu(30 /* SCMResourceContext */, contextKeyService);
...
//# sourceMappingURL=scmMenus.js.map