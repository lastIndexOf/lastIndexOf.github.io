...
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/uri", "vs/base/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/platform/storage/common/storage", "vs/platform/registry/common/platform", "vs/workbench/common/editor", "vs/workbench/contrib/output/common/output", "vs/workbench/services/panel/common/panelService", "vs/platform/workspace/common/workspace", "vs/workbench/contrib/output/common/outputLinkProvider", "vs/editor/common/services/resolverService", "vs/workbench/common/editor/resourceEditorInput", "vs/platform/environment/common/environment", "vs/platform/windows/common/windows", "vs/platform/log/common/log", "vs/platform/lifecycle/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/base/common/cancellation", "vs/workbench/services/output/common/outputChannelModel"], function (require, exports, nls, event_1, uri_1, lifecycle_1, instantiation_1, storage_1, platform_1, editor_1, output_1, panelService_1, workspace_1, outputLinkProvider_1, resolverService_1, resourceEditorInput_1, environment_1, windows_1, log_1, lifecycle_2, contextkey_1, cancellation_1, outputChannelModel_1) {
    ...
    let OutputService = class OutputService extends lifecycle_1.Disposable {
        constructor(storageService, instantiationService, panelService, contextService, textModelResolverService, environmentService, windowService, logService, lifecycleService, contextKeyService) {
            super();
