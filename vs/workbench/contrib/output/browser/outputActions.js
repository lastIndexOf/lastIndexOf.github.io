...
define(["require", "exports", "vs/nls", "vs/base/browser/ui/aria/aria", "vs/base/common/actions", "vs/workbench/contrib/output/common/output", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/panel/common/panelService", "vs/workbench/browser/panel", "vs/base/common/lifecycle", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/contextview/browser/contextView", "vs/platform/registry/common/platform", "vs/base/common/arrays", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/editor/common/editorService", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/output/browser/logViewer"], function (require, exports, nls, aria, actions_1, output_1, actionbar_1, layoutService_1, panelService_1, panel_1, lifecycle_1, styler_1, themeService_1, contextView_1, platform_1, arrays_1, quickInput_1, editorService_1, instantiation_1, logViewer_1) {
    ...
    let SwitchOutputActionItem = class SwitchOutputActionItem extends actionbar_1.SelectActionItem {
        ...
        updateOtions() {
            ...
            const options = [...this.outputChannels.map(c => c.label), ...(showSeparator ? [SwitchOutputActionItem.SEPARATOR] : []), ...this.logChannels.map(c => nls.localize('logChannel', "Log ({0})", c.label))];
            let selected = 0;
            const activeChannel = this.outputService.getActiveChannel();
            if (activeChannel) {
