...
define(["require", "exports", "vs/base/common/errorMessage", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/uri", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/workbench/api/node/extHost.protocol", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledEditorService"], function (require, exports, errorMessage_1, lifecycle_1, network_1, uri_1, modeService_1, modelService_1, resolverService_1, files_1, extHost_protocol_1, textfiles_1, untitledEditorService_1) {
    "use strict";
    ...
    let MainThreadDocuments = class MainThreadDocuments {
        constructor(documentsAndEditors, extHostContext, modelService, modeService, textFileService, fileService, textModelResolverService, untitledEditorService) {
        ...
        _handleUntitledScheme(uri) {
            const asFileUri = uri.with({ scheme: network_1.Schemas.file });
        ...
        _doCreateUntitled(resource, modeId, initialValue) {
