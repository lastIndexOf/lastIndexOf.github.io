...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/objects", "vs/base/common/lifecycle", "vs/workbench/contrib/scm/common/scm", "../node/extHost.protocol", "vs/workbench/api/electron-browser/extHostCustomers", "vs/base/common/sequence", "vs/base/common/cancellation"], function (require, exports, uri_1, event_1, objects_1, lifecycle_1, scm_1, extHost_protocol_1, extHostCustomers_1, sequence_1, cancellation_1) {
    "use strict";
    ...
    let MainThreadSCMProvider = class MainThreadSCMProvider {
        ...
        get onDidChangeResources() { return this._onDidChangeResources.event; }
        ...
        get onDidChangeCommitTemplate() { return this._onDidChangeCommitTemplate.event; }
        ...
        getOriginalResource(uri) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield this.proxy.$provideOriginalResource(this.handle, uri, cancellation_1.CancellationToken.None);
    ...
    let MainThreadSCM = class MainThreadSCM {
        ...
        $registerSourceControl(handle, id, label, rootUri) {
            const provider = new MainThreadSCMProvider(this._proxy, handle, id, label, rootUri && uri_1.URI.revive(rootUri), this.scmService);
        ...
        $setValidationProviderIsEnabled(sourceControlHandle, enabled) {
            ...
            if (enabled) {
                repository.input.validateInput = (value, pos) => __awaiter(this, void 0, void 0, function* () {
                    const result = yield this._proxy.$validateInput(sourceControlHandle, value, pos);
                    return result && { message: result[0], type: result[1] };
                });
            }
            else {
                repository.input.validateInput = () => __awaiter(this, void 0, void 0, function* () { return undefined; });
            }
        }
