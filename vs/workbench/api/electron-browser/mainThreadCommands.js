...
define(["require", "exports", "vs/platform/commands/common/commands", "../node/extHost.protocol", "vs/workbench/api/electron-browser/extHostCustomers", "vs/base/common/marshalling"], function (require, exports, commands_1, extHost_protocol_1, extHostCustomers_1, marshalling_1) {
    "use strict";
    ...
    let MainThreadCommands = class MainThreadCommands {
        ...
        $registerCommand(id) {
            this._disposables.set(id, commands_1.CommandsRegistry.registerCommand(id, (accessor, ...args) => {
