...
define(["require", "exports", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/platform/instantiation/common/instantiation", "vs/workbench/api/common/jsonValidationExtensionPoint", "vs/workbench/services/themes/common/colorExtensionPoint", "vs/workbench/contrib/codeEditor/browser/languageConfigurationExtensionPoint", "vs/workbench/api/node/apiCommands", "./mainThreadClipboard", "./mainThreadCommands", "./mainThreadConfiguration", "./mainThreadConsole", "./mainThreadDebugService", "./mainThreadDecorations", "./mainThreadDiagnostics", "./mainThreadDialogs", "./mainThreadDocumentContentProviders", "./mainThreadDocuments", "./mainThreadDocumentsAndEditors", "./mainThreadEditor", "./mainThreadEditors", "./mainThreadErrors", "./mainThreadExtensionService", "./mainThreadFileSystem", "./mainThreadFileSystemEventService", "./mainThreadHeapService", "./mainThreadLanguageFeatures", "./mainThreadLanguages", "./mainThreadMessageService", "./mainThreadOutputService", "./mainThreadProgress", "./mainThreadQuickOpen", "./mainThreadSCM", "./mainThreadSearch", "./mainThreadSaveParticipant", "./mainThreadStatusBar", "./mainThreadStorage", "./mainThreadTask", "./mainThreadTelemetry", "./mainThreadTerminalService", "./mainThreadTreeViews", "./mainThreadLogService", "./mainThreadWebview", "./mainThreadComments", "./mainThreadUrls", "./mainThreadWindow", "./mainThreadWorkspace"], function (require, exports, contributions_1, platform_1, instantiation_1, jsonValidationExtensionPoint_1, colorExtensionPoint_1, languageConfigurationExtensionPoint_1) {
    "use strict";
