 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/uri", "vs/workbench/api/node/extHostTypeConverters", "vs/workbench/api/node/extHostTypes", "./apiCommands", "vs/base/common/arrays"], function (require, exports, uri_1, typeConverters, types, apiCommands_1, arrays_1) {
    "use strict";
    ...
    class ExtHostApiCommands {
        ...
        registerCommands() {
            ...
            this._register('vscode.executeCodeLensProvider', this._executeCodeLensProvider, {
                ...
                args: [
                    { name: 'uri', description: 'Uri of a text document', constraint: uri_1.URI },
                    { name: 'itemResolveCount', description: '(optional) Number of lenses that should be resolved and returned. Will only retrun resolved lenses, will impact performance)', constraint: (value) => value === undefined || typeof value === 'number' }
                ],
        ...
        _executeCodeActionProvider(resource, range, kind) {
            const args = {
                resource,
