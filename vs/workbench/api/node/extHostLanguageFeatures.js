...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/objects", "vs/workbench/api/node/extHostTypeConverters", "vs/workbench/api/node/extHostTypes", "vs/base/common/async", "./extHost.protocol", "vs/base/common/strings", "vs/editor/common/core/range", "vs/base/common/arrays", "vs/base/common/types", "vs/editor/common/core/selection", "vs/workbench/api/node/extHostWebview", "vs/base/common/uuid"], function (require, exports, uri_1, objects_1, typeConvert, extHostTypes_1, async_1, extHost_protocol_1, strings_1, range_1, arrays_1, types_1, selection_1, extHostWebview_1, uuid_1) {
    "use strict";
    ...
    class SuggestAdapter {
        ...
        _convertCompletionItem(item, position, defaultRange, _id, _parentId) {
            ...
            const result = {
                ...
                insertTextRules: item.keepWhitespace ? 1 /* KeepWhitespace */ : 0,
    ...
    class ExtHostLanguageFeatures {
        ...
        _transformDocumentSelector(selector) {
            if (Array.isArray(selector)) {
                return arrays_1.coalesce(selector.map(sel => this._doTransformDocumentSelector(sel)));
            }
            return arrays_1.coalesce([this._doTransformDocumentSelector(selector)]);
        }
        ...
        _withAdapter(handle, ctor, callback) {
        ...
        $provideDocumentSymbols(handle, resource, token) {
            return this._withAdapter(handle, DocumentSymbolAdapter, adapter => adapter.provideDocumentSymbols(uri_1.URI.revive(resource), token));
        }
        // --- code lens
        ...
        $resolveCodeLens(handle, resource, symbol, token) {
            return this._withAdapter(handle, CodeLensAdapter, adapter => adapter.resolveCodeLens(uri_1.URI.revive(resource), symbol, token));
        }
        // --- code insets
        ...
        $provideCodeInsets(handle, resource, token) {
            return this._withAdapter(handle, CodeInsetAdapter, adapter => adapter.provideCodeInsets(uri_1.URI.revive(resource), token));
        }
        $resolveCodeInset(handle, _resource, symbol, token) {
            ...
            return this._withAdapter(handle, CodeInsetAdapter, (adapter, extension) => __awaiter(this, void 0, void 0, function* () {
                yield this._webviewProxy.$createWebviewCodeInset(webviewHandle, symbol.id, { enableCommandUris: true, enableScripts: true }, extension ? extension.extensionLocation : undefined);
        ...
        $provideHover(handle, resource, position, token) {
            return this._withAdapter(handle, HoverAdapter, adapter => adapter.provideHover(uri_1.URI.revive(resource), position, token));
        }
        // --- occurrences
        ...
        $provideDocumentHighlights(handle, resource, position, token) {
            return this._withAdapter(handle, DocumentHighlightAdapter, adapter => adapter.provideDocumentHighlights(uri_1.URI.revive(resource), position, token));
        }
        // --- references
        ...
        $provideReferences(handle, resource, position, context, token) {
            return this._withAdapter(handle, ReferenceAdapter, adapter => adapter.provideReferences(uri_1.URI.revive(resource), position, context, token));
        }
        // --- quick fix
        ...
        $provideCodeActions(handle, resource, rangeOrSelection, context, token) {
            return this._withAdapter(handle, CodeActionAdapter, adapter => adapter.provideCodeActions(uri_1.URI.revive(resource), rangeOrSelection, context, token));
        }
        // --- formatting
        ...
        $provideDocumentFormattingEdits(handle, resource, options, token) {
            return this._withAdapter(handle, DocumentFormattingAdapter, adapter => adapter.provideDocumentFormattingEdits(uri_1.URI.revive(resource), options, token));
        }
        ...
        $provideDocumentRangeFormattingEdits(handle, resource, range, options, token) {
            return this._withAdapter(handle, RangeFormattingAdapter, adapter => adapter.provideDocumentRangeFormattingEdits(uri_1.URI.revive(resource), range, options, token));
        }
        ...
        $provideOnTypeFormattingEdits(handle, resource, position, ch, options, token) {
            return this._withAdapter(handle, OnTypeFormattingAdapter, adapter => adapter.provideOnTypeFormattingEdits(uri_1.URI.revive(resource), position, ch, options, token));
        }
        // --- navigate types
        ...
        $provideRenameEdits(handle, resource, position, newName, token) {
            return this._withAdapter(handle, RenameAdapter, adapter => adapter.provideRenameEdits(uri_1.URI.revive(resource), position, newName, token));
        }
        $resolveRenameLocation(handle, resource, position, token) {
            return this._withAdapter(handle, RenameAdapter, adapter => adapter.resolveRenameLocation(uri_1.URI.revive(resource), position, token));
        }
        // --- suggestion
        ...
        $provideCompletionItems(handle, resource, position, context, token) {
            return this._withAdapter(handle, SuggestAdapter, adapter => adapter.provideCompletionItems(uri_1.URI.revive(resource), position, context, token));
        }
        $resolveCompletionItem(handle, resource, position, suggestion, token) {
            return this._withAdapter(handle, SuggestAdapter, adapter => adapter.resolveCompletionItem(uri_1.URI.revive(resource), position, suggestion, token));
        }
        ...
        $provideSignatureHelp(handle, resource, position, context, token) {
            return this._withAdapter(handle, SignatureHelpAdapter, adapter => adapter.provideSignatureHelp(uri_1.URI.revive(resource), position, context, token));
        }
        // --- links
        ...
        $provideDocumentLinks(handle, resource, token) {
            return this._withAdapter(handle, LinkProviderAdapter, adapter => adapter.provideLinks(uri_1.URI.revive(resource), token));
        }
        ...
        $provideColorPresentations(handle, resource, colorInfo, token) {
            return this._withAdapter(handle, ColorProviderAdapter, adapter => adapter.provideColorPresentations(uri_1.URI.revive(resource), colorInfo, token));
        }
        ...
        $provideFoldingRanges(handle, resource, context, token) {
            return this._withAdapter(handle, FoldingProviderAdapter, adapter => adapter.provideFoldingRanges(uri_1.URI.revive(resource), context, token));
        }
        // --- smart select
