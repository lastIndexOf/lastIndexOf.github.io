...
define(["require", "exports", "crypto", "vs/base/common/arrays", "vs/base/common/errors", "vs/base/common/htmlContent", "vs/base/common/map", "vs/base/common/strings", "vs/base/common/uri", "vs/base/common/uuid"], function (require, exports, crypto, arrays_1, errors_1, htmlContent_1, map_1, strings_1, uri_1, uuid_1) {
    "use strict";
    ...
    */
    ...
    let FileSystemError = FileSystemError_1 = class FileSystemError extends Error {
        ...
        static FileExists(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'EntryExists', FileSystemError_1.FileExists);
        }
        static FileNotFound(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'EntryNotFound', FileSystemError_1.FileNotFound);
        }
        static FileNotADirectory(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'EntryNotADirectory', FileSystemError_1.FileNotADirectory);
        }
        static FileIsADirectory(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'EntryIsADirectory', FileSystemError_1.FileIsADirectory);
        }
        static NoPermissions(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'NoPermissions', FileSystemError_1.NoPermissions);
        }
        static Unavailable(messageOrUri) {
            return new FileSystemError_1(messageOrUri, 'Unavailable', FileSystemError_1.Unavailable);
        }
    };
