...
define(["require", "exports", "vs/nls", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/platform/actions/common/actions", "vs/workbench/common/actions", "vs/platform/configuration/common/configuration", "vs/workbench/services/layout/browser/layoutService", "vs/platform/commands/common/commands", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/workbench/common/contextkeys", "vs/platform/keybinding/common/keybindingsRegistry", "vs/workbench/common/editor", "vs/platform/contextkey/common/contextkey", "vs/css!./media/actions"], function (require, exports, nls, platform_1, actions_1, actions_2, actions_3, configuration_1, layoutService_1, commands_1, editorGroupsService_1, keyCodes_1, lifecycle_1, platform_2, contextkeys_1, keybindingsRegistry_1, editor_1, contextkey_1) {
    "use strict";
    ...
    let ToggleEditorVisibilityAction = class ToggleEditorVisibilityAction extends actions_1.Action {
        ...
        run() {
            const hideEditor = this.layoutService.isVisible("workbench.parts.editor" /* EDITOR_PART */);
