 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/workbench/common/component", "vs/base/browser/dom", "vs/base/common/event", "vs/css!./media/part"], function (require, exports, component_1, dom_1, event_1) {
    "use strict";
    ...
    class PartLayout {
        ...
        layout(width, height) {
            ...
            const contentSize = new dom_1.Dimension(width, height - titleSize.height);
