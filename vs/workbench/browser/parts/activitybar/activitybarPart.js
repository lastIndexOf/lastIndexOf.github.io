...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/common/activity", "vs/platform/registry/common/platform", "vs/workbench/browser/part", "vs/workbench/browser/parts/activitybar/activitybarActions", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/services/layout/browser/layoutService", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/workbench/browser/actions/layoutActions", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/platform/theme/common/colorRegistry", "vs/workbench/browser/parts/compositeBar", "vs/base/browser/dom", "vs/platform/storage/common/storage", "vs/workbench/services/extensions/common/extensions", "vs/base/common/uri", "vs/workbench/browser/parts/compositeBarActions", "vs/workbench/common/views", "vs/platform/contextkey/common/contextkey", "vs/base/common/types", "vs/workbench/services/activityBar/browser/activityBarService", "vs/platform/instantiation/common/extensions", "vs/base/common/network", "vs/css!./media/activitybarpart"], function (require, exports, nls, errors_1, actionbar_1, activity_1, platform_1, part_1, activitybarActions_1, viewlet_1, layoutService_1, instantiation_1, lifecycle_1, layoutActions_1, themeService_1, theme_1, colorRegistry_1, compositeBar_1, dom_1, storage_1, extensions_1, uri_1, compositeBarActions_1, views_1, contextkey_1, types_1, activityBarService_1, extensions_2, network_1) {
    ...
    let ActivitybarPart = class ActivitybarPart extends part_1.Part {
        constructor(viewletService, instantiationService, layoutService, themeService, storageService, extensionService, viewsService, contextKeyService) {
            ...
            this.compositeBar = this._register(this.instantiationService.createInstance(compositeBar_1.CompositeBar, this.cachedViewlets.map(v => ({ id: v.id, name: undefined, visible: v.visible, order: v.order, pinned: v.pinned })), {
                icon: true,
        ...
        registerListeners() {
            ...
            this._register(lifecycle_1.toDisposable(() => lifecycle_1.dispose(disposables)));
        }
        ...
        showGlobalActivity(globalActivityId, badge, clazz) {
            if (!badge) {
            ...
            return lifecycle_1.toDisposable(() => action.setBadge(undefined));
        }
        ...
        createGlobalActivityActionBar(container) {
            const activityRegistry = platform_1.Registry.as(activity_1.GlobalActivityExtensions);
            ...
            const actions = descriptors
                ...
                .map(a => new activitybarActions_1.GlobalActivityAction(a));
            this.globalActionBar = this._register(new actionbar_1.ActionBar(container, {
                actionItemProvider: a => this.instantiationService.createInstance(activitybarActions_1.GlobalActivityActionItem, a, (theme) => this.getActivitybarItemColors(theme)),
                orientation: 2 /* VERTICAL */,
        ...
        removeComposite(compositeId, hide) {
            if (hide) {
        ...
        saveCachedViewlets() {
            ...
            for (const compositeItem of compositeItems) {
                ...
                if (viewlet) {
                    ...
                    state.push({ id: compositeItem.id, iconUrl: viewlet.iconUrl && viewlet.iconUrl.scheme === network_1.Schemas.file ? viewlet.iconUrl : undefined, views, pinned: compositeItem && compositeItem.pinned, order: compositeItem ? compositeItem.order : undefined, visible: compositeItem && compositeItem.visible });
                }
            }
        ...
        getCachedViewlets() {
            ...
            const cachedViewlets = storedStates.map(c => {
                const serialized = typeof c === 'string' /* migration from pinned states to composites states */ ? { id: c, pinned: true, order: undefined, visible: true, iconUrl: undefined, views: undefined } : c;
