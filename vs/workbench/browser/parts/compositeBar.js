    ...
    let CompositeBar = class CompositeBar extends widget_1.Widget {
        ...
        create(parent) {
            ...
            this.compositeSwitcherBar = this._register(new actionbar_1.ActionBar(actionBarDiv, {
                actionItemProvider: (action) => {
                    ...
                    return item && this.instantiationService.createInstance(compositeBarActions_1.CompositeActionItem, action, item.pinnedAction, () => this.getContextMenuActions(), this.options.colors, this.options.icon, this);
                },
        ...
        updateCompositeSwitcher() {
            ...
            if ((visibleCompositesChange && overflows) || this.compositeSwitcherBar.length() === 0) {
                ...
                this.compositeOverflowActionItem = this.instantiationService.createInstance(compositeBarActions_1.CompositeOverflowActivityActionItem, this.compositeOverflowAction, () => this.getOverflowingComposites(), () => this.model.activeItem ? this.model.activeItem.id : undefined, (compositeId) => {
                    const item = this.model.findItem(compositeId);
