...
define(["require", "exports", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/workbench/common/notifications", "vs/platform/actions/common/actions", "vs/nls", "vs/platform/list/browser/listService"], function (require, exports, commands_1, contextkey_1, keybindingsRegistry_1, notifications_1, actions_1, nls_1, listService_1) {
    ...
    function registerNotificationCommands(center, toasts) {
        ...
        const category = nls_1.localize('notifications', "Notifications");
        actions_1.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: exports.SHOW_NOTIFICATIONS_CENTER, title: { value: nls_1.localize('showNotifications', "Show Notifications"), original: 'Notifications: Show Notifications' }, category }, when: exports.NotificationsCenterVisibleContext.toNegated() });
        actions_1.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: exports.HIDE_NOTIFICATIONS_CENTER, title: { value: nls_1.localize('hideNotifications', "Hide Notifications"), original: 'Notifications: Hide Notifications' }, category }, when: exports.NotificationsCenterVisibleContext });
        actions_1.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: exports.CLEAR_ALL_NOTIFICATIONS, title: { value: nls_1.localize('clearAllNotifications', "Clear All Notifications"), original: 'Notifications: Clear All Notifications' }, category } });
    }
