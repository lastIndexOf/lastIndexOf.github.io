...
define(["require", "exports", "vs/base/browser/dom", "vs/platform/opener/common/opener", "vs/base/common/uri", "vs/nls", "vs/base/browser/ui/button/button", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/platform/contextview/browser/contextView", "vs/base/browser/ui/dropdown/dropdown", "vs/workbench/common/notifications", "vs/workbench/browser/parts/notifications/notificationsActions", "vs/platform/keybinding/common/keybinding", "vs/base/browser/ui/progressbar/progressbar", "vs/platform/notification/common/notification", "vs/base/common/arrays"], function (require, exports, dom_1, opener_1, uri_1, nls_1, button_1, styler_1, themeService_1, actionbar_1, instantiation_1, lifecycle_1, contextView_1, dropdown_1, notifications_1, notificationsActions_1, keybinding_1, progressbar_1, notification_1, arrays_1) {
        ...
        static render(message, actionHandler) {
            ...
            // Message has links
                ...
                for (const link of message.links) {
                    ...
                    if (actionHandler) {
                        actionHandler.disposeables.push(dom_1.addDisposableListener(anchor, 'click', () => actionHandler.callback(link.href)));
                    }
            ...
            data.toolbar = new actionbar_1.ActionBar(toolbarContainer, {
                ...
                actionItemProvider: action => {
                    if (action && action instanceof notificationsActions_1.ConfigureNotificationAction) {
                        const item = new dropdown_1.DropdownMenuActionItem(action, action.configurationActions, this.contextMenuService, undefined, this.actionRunner, undefined, action.class);
    ...
    let NotificationTemplateRenderer = class NotificationTemplateRenderer {
        ...
        render(notification) {
            ...
            this.inputDisposeables.push(dom_1.addDisposableListener(this.template.container, dom_1.EventType.MOUSE_UP, e => {
        ...
        renderSeverity(notification) {
            NotificationTemplateRenderer.SEVERITIES.forEach(severity => {
                const domAction = notification.severity === this.toSeverity(severity) ? dom_1.addClass : dom_1.removeClass;
        ...
        renderSecondaryActions(notification, messageOverflows) {
            ...
            // Secondary Actions
            if (arrays_1.isNonEmptyArray(notification.actions.secondary)) {
                const configureNotificationAction = this.instantiationService.createInstance(notificationsActions_1.ConfigureNotificationAction, notificationsActions_1.ConfigureNotificationAction.ID, notificationsActions_1.ConfigureNotificationAction.LABEL, notification.actions.secondary);
        ...
        renderButtons(notification) {
            ...
            if (notification.expanded && notification.actions.primary) {
                const buttonGroup = new button_1.ButtonGroup(this.template.buttonsContainer, notification.actions.primary.length, { title: true /* assign titles to buttons in case they overflow */ });
                buttonGroup.buttons.forEach((button, index) => {
                    ...
                    this.inputDisposeables.push(styler_1.attachButtonStyler(button, this.themeService));
                });
