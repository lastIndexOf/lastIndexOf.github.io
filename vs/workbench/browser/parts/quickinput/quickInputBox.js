 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/inputbox/inputBox", "vs/platform/theme/common/colorRegistry", "vs/base/common/lifecycle", "vs/base/browser/keyboardEvent", "vs/base/common/severity", "vs/base/browser/mouseEvent", "vs/css!./quickInput"], function (require, exports, dom, inputBox_1, colorRegistry_1, lifecycle_1, keyboardEvent_1, severity_1, mouseEvent_1) {
    "use strict";
    ...
    class QuickInputBox {
        constructor(parent) {
            ...
            this.inputBox = new inputBox_1.InputBox(this.container, undefined);
