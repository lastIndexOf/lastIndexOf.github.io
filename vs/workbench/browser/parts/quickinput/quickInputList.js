    ...
    let QuickInputList = class QuickInputList {
        ...
        filter(query) {
            ...
            // Filter by value (since we support octicons, use octicon aware fuzzy matching)
                ...
                this.elements.forEach(element => {
                    const labelHighlights = this.matchOnLabel ? octicon_1.matchesFuzzyOcticonAware(query, octicon_1.parseOcticons(element.saneLabel)) || undefined : undefined;
                    const descriptionHighlights = this.matchOnDescription ? octicon_1.matchesFuzzyOcticonAware(query, octicon_1.parseOcticons(element.saneDescription || '')) || undefined : undefined;
                    const detailHighlights = this.matchOnDetail ? octicon_1.matchesFuzzyOcticonAware(query, octicon_1.parseOcticons(element.saneDetail || '')) || undefined : undefined;
