...
define(["require", "exports", "vs/platform/registry/common/platform", "vs/nls", "vs/base/common/uri", "vs/workbench/browser/quickopen", "vs/workbench/browser/parts/statusbar/statusbar", "vs/workbench/browser/editor", "vs/workbench/common/editor", "vs/workbench/browser/parts/editor/textResourceEditor", "vs/workbench/browser/parts/editor/sideBySideEditor", "vs/workbench/common/editor/diffEditorInput", "vs/workbench/common/editor/untitledEditorInput", "vs/workbench/common/editor/resourceEditorInput", "vs/platform/instantiation/common/instantiation", "vs/workbench/browser/parts/editor/textDiffEditor", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/browser/parts/editor/binaryDiffEditor", "vs/workbench/browser/parts/editor/editorStatus", "vs/workbench/common/actions", "vs/workbench/browser/actions", "vs/platform/actions/common/actions", "vs/platform/instantiation/common/descriptors", "vs/base/common/keyCodes", "vs/workbench/browser/parts/editor/editorActions", "vs/workbench/browser/parts/editor/editorCommands", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/quickopen/quickopen", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/contextkey/common/contextkey", "vs/base/common/platform", "vs/workbench/browser/parts/editor/editorPicker", "vs/base/common/network", "vs/editor/browser/editorExtensions", "vs/workbench/browser/parts/editor/editorWidgets", "vs/workbench/browser/parts/editor/resourceViewer"], function (require, exports, platform_1, nls, uri_1, quickopen_1, statusbar_1, editor_1, editor_2, textResourceEditor_1, sideBySideEditor_1, diffEditorInput_1, untitledEditorInput_1, resourceEditorInput_1, instantiation_1, textDiffEditor_1, textfiles_1, binaryDiffEditor_1, editorStatus_1, actions_1, actions_2, actions_3, descriptors_1, keyCodes_1, editorActions_1, editorCommands, editorService_1, quickopen_2, keybindingsRegistry_1, contextkey_1, platform_2, editorPicker_1, network_1, editorExtensions_1, editorWidgets_1, resourceViewer_1) {
    ...
    let UntitledEditorInputFactory = class UntitledEditorInputFactory {
        ...
        deserialize(instantiationService, serializedEditorInput) {
            return instantiationService.invokeFunction(accessor => {
                ...
                const filePath = resource.scheme === network_1.Schemas.file ? resource.fsPath : undefined;
                const language = deserialized.modeId;
                const encoding = deserialized.encoding;
                return accessor.get(editorService_1.IEditorService).createInput({ resource, filePath, language, encoding });
            });
        }
    };
    ...
    statusBar.registerStatusbarItem(new statusbar_1.StatusbarItemDescriptor(resourceViewer_1.ZoomStatusbarItem, 1 /* RIGHT */, 101 /* to the left of editor status (100) */));
    ...
    if (platform_2.isMacintosh) {
        actions_3.MenuRegistry.appendMenuItem(35 /* TouchBarContext */, {
    ...
    actions_3.MenuRegistry.appendMenuItem(9 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, title: nls.localize('closeOthers', "Close Others") }, group: '1_close', order: 20 });
    actions_3.MenuRegistry.appendMenuItem(9 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, title: nls.localize('closeRight', "Close to the Right") }, group: '1_close', order: 30, when: contextkey_1.ContextKeyExpr.has('config.workbench.editor.showTabs') });
    ...
    actions_3.MenuRegistry.appendMenuItem(9 /* EditorTitleContext */, { command: { id: editorCommands.KEEP_EDITOR_COMMAND_ID, title: nls.localize('keepOpen', "Keep Open") }, group: '3_preview', order: 10, when: contextkey_1.ContextKeyExpr.has('config.workbench.editor.enablePreview') });
    ...
    // Editor Title Menu
    actions_3.MenuRegistry.appendMenuItem(8 /* EditorTitle */, { command: { id: editorCommands.TOGGLE_DIFF_SIDE_BY_SIDE, title: nls.localize('toggleSideBySideView', "Toggle Side By Side View") }, group: '1_diff', order: 10, when: contextkey_1.ContextKeyExpr.has('isInDiffEditor') });
    ...
    actions_3.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.KEEP_EDITOR_COMMAND_ID, title: { value: nls.localize('keepEditor', "Keep Editor"), original: 'View: Keep Editor' }, category }, when: contextkey_1.ContextKeyExpr.has('config.workbench.editor.enablePreview') });
    actions_3.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_EDITORS_IN_GROUP_COMMAND_ID, title: { value: nls.localize('closeEditorsInGroup', "Close All Editors in Group"), original: 'View: Close All Editors in Group' }, category } });
    actions_3.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_SAVED_EDITORS_COMMAND_ID, title: { value: nls.localize('closeSavedEditors', "Close Saved Editors in Group"), original: 'View: Close Saved Editors in Group' }, category } });
    actions_3.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, title: { value: nls.localize('closeOtherEditors', "Close Other Editors in Group"), original: 'View: Close Other Editors in Group' }, category } });
    actions_3.MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, title: { value: nls.localize('closeRightEditors', "Close Editors to the Right in Group"), original: 'View: Close Editors to the Right in Group' }, category } });
    // File menu
