 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/browser", "vs/editor/browser/editorDom", "vs/editor/browser/view/viewPart", "vs/editor/browser/viewParts/lines/viewLine", "vs/editor/common/core/position", "vs/editor/common/core/range"], function (require, exports, browser, editorDom_1, viewPart_1, viewLine_1, position_1, range_1) {
    "use strict";
    ...
    class HitTestContext {
        constructor(context, viewHelper, lastViewCursorsRenderData) {
    ...
    class MouseTargetFactory {
        ...
        createMouseTarget(lastViewCursorsRenderData, editorPos, pos, target) {
        ...
        static _hitTestViewLines(ctx, request, domHitTestExecuted) {
            ...
            if (ctx.isAfterLines(request.mouseVerticalOffset)) {
                ...
                return request.fulfill(7 /* CONTENT_EMPTY */, new position_1.Position(lineCount, maxLineColumn), undefined, EMPTY_CONTENT_AFTER_LINES);
            }
            if (domHitTestExecuted) {
                ...
                if (ElementPath.isStrictChildOfViewLines(request.targetPath)) {
                    ...
                    if (ctx.model.getLineLength(lineNumber) === 0) {
                        ...
                        return request.fulfill(7 /* CONTENT_EMPTY */, new position_1.Position(lineNumber, 1), undefined, detail);
                    }
                }
        ...
        static createMouseTargetFromHitTestPosition(ctx, request, lineNumber, column) {
            const pos = new position_1.Position(lineNumber, column);
            const lineWidth = ctx.getLineWidth(lineNumber);
            if (request.mouseContentHorizontalOffset > lineWidth) {
                if (browser.isEdge && pos.column === 1) {
                    // See https://github.com/Microsoft/vscode/issues/10875
                    const detail = createEmptyContentDataInLines(request.mouseContentHorizontalOffset - lineWidth);
                    return request.fulfill(7 /* CONTENT_EMPTY */, new position_1.Position(lineNumber, ctx.model.getLineMaxColumn(lineNumber)), undefined, detail);
                }
                const detail = createEmptyContentDataInLines(request.mouseContentHorizontalOffset - lineWidth);
