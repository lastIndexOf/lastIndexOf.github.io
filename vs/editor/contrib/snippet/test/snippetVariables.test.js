define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/snippetVariables", "vs/editor/contrib/snippet/snippetParser", "vs/editor/common/model/textModel", "vs/platform/workspace/common/workspace"], function (require, exports, assert, platform_1, uri_1, selection_1, snippetVariables_1, snippetParser_1, textModel_1, workspace_1) {
    ...
    suite('Snippet Variables Resolver', function () {
        ...
        test('editor variables, file/dir', function () {
            ...
            resolver = new snippetVariables_1.ModelBasedVariableResolver(textModel_1.TextModel.createFromString('', undefined, undefined, uri_1.URI.parse('http://www.pb.o/abc/def/ghi')));
            ...
            resolver = new snippetVariables_1.ModelBasedVariableResolver(textModel_1.TextModel.createFromString('', undefined, undefined, uri_1.URI.parse('mem:fff.ts')));
        ...
        test('More useful environment variables for snippets, #32737', function () {
            ...
            resolver = new snippetVariables_1.ModelBasedVariableResolver(textModel_1.TextModel.createFromString('', undefined, undefined, uri_1.URI.parse('mem:.git')));
            assertVariableResolve(resolver, 'TM_FILENAME_BASE', '.git');
            resolver = new snippetVariables_1.ModelBasedVariableResolver(textModel_1.TextModel.createFromString('', undefined, undefined, uri_1.URI.parse('mem:foo.')));
        ...
        test('Add variable to insert value from clipboard to a snippet #40153', function () {
            let readTextResult;
            const clipboardService = new class {
                constructor() {
                    this._throw = () => { throw new Error(); };
                    this.writeText = this._throw;
                    this.readFindText = this._throw;
                    this.writeFindText = this._throw;
                    this.writeResources = this._throw;
                    this.readResources = this._throw;
                    this.hasResources = this._throw;
                }
                readText() { return readTextResult; }
            };
            let resolver = new snippetVariables_1.ClipboardBasedVariableResolver(clipboardService, 1, 0);
        ...
        test('Add workspace name variable for snippets #68261', function () {
            ...
            workspace = new workspace_1.Workspace('', workspace_1.toWorkspaceFolders([{ path: '/folderName' }]));
            assertVariableResolve(resolver, 'WORKSPACE_NAME', 'folderName');
            // workspace with config
            workspace = new workspace_1.Workspace('', workspace_1.toWorkspaceFolders([{ path: 'folderName' }]), uri_1.URI.file('testWorkspace.code-workspace'));
