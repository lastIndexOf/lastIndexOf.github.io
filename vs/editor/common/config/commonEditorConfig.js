 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/base/common/platform", "vs/editor/common/config/editorOptions", "vs/editor/common/config/editorZoom", "vs/editor/common/config/fontInfo", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform"], function (require, exports, nls, event_1, lifecycle_1, objects, platform, editorOptions, editorZoom_1, fontInfo_1, configurationRegistry_1, platform_1) {
    "use strict";
    ...
    class CommonEditorConfiguration extends lifecycle_1.Disposable {
        ...
        _computeInternalOptions() {
            ...
            const bareFontInfo = fontInfo_1.BareFontInfo.createFromRawSettings(this._rawOptions, partialEnv.zoomLevel);
            const env = {
