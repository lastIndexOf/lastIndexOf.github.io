 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/lineTokens", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/test/common/core/viewLineToken"], function (require, exports, assert, lineTokens_1, range_1, textModel_1, modes_1, viewLineToken_1) {
    "use strict";
    ...
    function assertLineTokens(__actual, _expected) {
        ...
        let expected = viewLineToken_1.ViewLineTokenFactory.inflateArr(tmp);
    ...
    suite('ModelLine - getIndentLevel', () => {
        function assertIndentLevel(text, expected, tabSize = 4) {
            let actual = textModel_1.TextModel.computeIndentLevel(text, tabSize);
    ...
    suite('ModelLinesTokens', () => {
        function testApplyEdits(initial, edits, expected) {
            ...
            const model = new textModel_1.TextModel(initialText, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, new modes_1.LanguageIdentifier('test', 0));
        ...
        test('insertion on empty line', () => {
            const model = new textModel_1.TextModel('some text', textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, new modes_1.LanguageIdentifier('test', 0));
