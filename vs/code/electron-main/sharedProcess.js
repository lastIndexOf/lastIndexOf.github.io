        ...
        get _whenReady() {
            ...
            return new Promise(c => {
                electron_1.ipcMain.once('handshake:hello', ({ sender }) => {
                    ...
                    disposables.push(lifecycle_1.toDisposable(() => sender.send('handshake:goodbye')));
