...
define(["require", "exports", "electron", "vs/base/common/platform", "vs/code/electron-main/windows", "vs/platform/windows/common/windows", "vs/platform/windows/node/windowsIpc", "vs/platform/windows/electron-main/windowsService", "vs/platform/lifecycle/electron-main/lifecycleMain", "vs/code/node/shellEnv", "vs/platform/update/common/update", "vs/platform/update/node/updateIpc", "vs/base/parts/ipc/electron-main/ipc.electron-main", "vs/base/parts/ipc/node/ipc.net", "vs/code/electron-main/sharedProcess", "vs/platform/launch/electron-main/launchService", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/serviceCollection", "vs/platform/instantiation/common/descriptors", "vs/platform/log/common/log", "vs/platform/state/common/state", "vs/platform/environment/common/environment", "vs/platform/configuration/common/configuration", "vs/platform/url/common/url", "vs/platform/url/node/urlIpc", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/telemetry/node/telemetryIpc", "vs/platform/telemetry/common/telemetryService", "vs/platform/telemetry/node/commonProperties", "vs/base/parts/ipc/node/ipc", "vs/platform/product/node/product", "vs/platform/product/node/package", "vs/code/electron-main/auth", "vs/base/common/lifecycle", "vs/platform/windows/electron-main/windows", "vs/platform/history/common/history", "vs/base/common/types", "vs/code/electron-main/keyboard", "vs/base/common/uri", "vs/platform/workspaces/node/workspacesIpc", "vs/platform/workspaces/common/workspaces", "vs/base/node/id", "vs/platform/update/electron-main/updateService.win32", "vs/platform/update/electron-main/updateService.linux", "vs/platform/update/electron-main/updateService.darwin", "vs/platform/issue/common/issue", "vs/platform/issue/node/issueIpc", "vs/platform/issue/electron-main/issueService", "vs/platform/log/node/logIpc", "vs/base/common/errors", "vs/platform/url/electron-main/electronUrlListener", "vs/platform/driver/electron-main/driver", "vs/platform/remote/node/remoteAgentConnection", "vs/platform/menubar/common/menubar", "vs/platform/menubar/electron-main/menubarService", "vs/platform/menubar/node/menubarIpc", "vs/platform/environment/node/argv", "vs/base/common/async", "vs/base/parts/contextmenu/electron-main/contextmenu", "vs/code/electron-main/theme", "os", "vs/base/common/path", "vs/nls", "vs/platform/remote/common/remoteHosts", "vs/platform/remote/node/remoteAgentFileSystemChannel", "vs/platform/update/electron-main/updateService.snap", "vs/platform/storage/node/storageMainService", "vs/platform/storage/node/storageIpc", "vs/base/common/strings", "vs/platform/backup/electron-main/backupMainService", "vs/platform/backup/common/backup", "vs/platform/history/electron-main/historyMainService", "vs/platform/url/common/urlService", "vs/platform/workspaces/electron-main/workspacesMainService"], function (require, exports, electron_1, platform_1, windows_1, windows_2, windowsIpc_1, windowsService_1, lifecycleMain_1, shellEnv_1, update_1, updateIpc_1, ipc_electron_main_1, ipc_net_1, sharedProcess_1, launchService_1, instantiation_1, serviceCollection_1, descriptors_1, log_1, state_1, environment_1, configuration_1, url_1, urlIpc_1, telemetry_1, telemetryUtils_1, telemetryIpc_1, telemetryService_1, commonProperties_1, ipc_1, product_1, package_1, auth_1, lifecycle_1, windows_3, history_1, types_1, keyboard_1, uri_1, workspacesIpc_1, workspaces_1, id_1, updateService_win32_1, updateService_linux_1, updateService_darwin_1, issue_1, issueIpc_1, issueService_1, logIpc_1, errors, electronUrlListener_1, driver_1, remoteAgentConnection_1, menubar_1, menubarService_1, menubarIpc_1, argv_1, async_1, contextmenu_1, theme_1, os_1, path_1, nls_1, remoteHosts_1, remoteAgentFileSystemChannel_1, updateService_snap_1, storageMainService_1, storageIpc_1, strings_1, backupMainService_1, backup_1, historyMainService_1, urlService_1, workspacesMainService_1) {
    "use strict";
    ...
    let CodeApplication = class CodeApplication extends lifecycle_1.Disposable {
        ...
        registerListeners() {
            ...
            process.on('unhandledRejection', (reason, promise) => errors.onUnexpectedError(reason));
            ...
            electron_1.app.on('open-file', (event, path) => {
                ...
                macOpenFileURIs.push({ uri: uri_1.URI.file(path) });
            ...
            electron_1.ipcMain.on('vscode:fetchShellEnv', (event) => {
                const webContents = event.sender;
                shellEnv_1.getShellEnvironment().then(shellEnv => {
            ...
            electron_1.ipcMain.on('vscode:broadcast', (event, windowId, broadcast) => {
                if (this.windowsMainService && broadcast.channel && !types_1.isUndefinedOrNull(broadcast.payload)) {
        ...
        onBroadcast(event, payload) {
            ...
            if (event === 'vscode:changeColorTheme' && typeof payload === 'string') {
                theme_1.storeBackgroundColor(this.stateService, JSON.parse(payload));
            }
        }
        startup() {
            ...
            const startupWithMachineId = (machineId) => {
                this.logService.trace(`Resolved machine identifier: ${machineId}`);
                // Spawn shared process
                this.sharedProcess = this.instantiationService.createInstance(sharedProcess_1.SharedProcess, machineId, this.userEnv);
                this.sharedProcessClient = this.sharedProcess.whenReady().then(() => ipc_net_1.connect(this.environmentService.sharedIPCHandle, 'main'));
                // Services
                return this.initServices(machineId).then(appInstantiationService => {
                    // Create driver
                    if (this.environmentService.driverHandle) {
                        driver_1.serve(this.electronIpcServer, this.environmentService.driverHandle, this.environmentService, appInstantiationService).then(server => {
        ...
        resolveMachineId() {
            const machineId = this.stateService.getItem(CodeApplication.MACHINE_ID_KEY);
            if (machineId) {
                return machineId;
            }
            return id_1.getMachineId().then(machineId => {
        ...
        initServices(machineId) {
            ...
            if (!this.environmentService.isExtensionDevelopment && !this.environmentService.args['disable-telemetry'] && !!product_1.default.enableTelemetry) {
                const channel = ipc_1.getDelayedChannel(this.sharedProcessClient.then(c => c.getChannel('telemetryAppender')));
                ...
                const commonProperties = commonProperties_1.resolveCommonProperties(product_1.default.commit, package_1.default.version, machineId, this.environmentService.installSourcePath);
        ...
        initBackupService(accessor) {
            const backupMainService = accessor.get(backup_1.IBackupMainService);
            return backupMainService.initialize();
        }
        openFirstWindow(accessor) {
            const appInstantiationService = accessor.get(instantiation_1.IInstantiationService);
            ...
            const workspacesChannel = appInstantiationService.createInstance(workspacesIpc_1.WorkspacesChannel, workspacesService);
            ...
            const windowsMainService = this.windowsMainService = accessor.get(windows_3.IWindowsMainService); // TODO@Joao: unfold this
                ...
                urlService.registerHandler({
                    handleURL(uri) {
                        if (windowsMainService.getWindowCount() === 0) {
                            const cli = Object.assign({}, environmentService.args, { goto: true });
                            const [window] = windowsMainService.open({ context: 5 /* API */, cli, forceEmpty: true });
            ...
            const urlListener = new electronUrlListener_1.ElectronURLListener(urls || [], urlService, this.windowsMainService);
            ...
            if (macOpenFiles && macOpenFiles.length && !hasCliArgs && !hasFolderURIs && !hasFileURIs) {
                return this.windowsMainService.open({ context: 1 /* DOCK */, cli: args, urisToOpen: macOpenFiles.map(file => ({ uri: uri_1.URI.file(file) })), initialStartup: true }); // mac: open-file event received on startup
            }
        ...
        afterWindowOpen(accessor) {
            const windowsMainService = accessor.get(windows_3.IWindowsMainService);
            const historyMainService = accessor.get(history_1.IHistoryMainService);
            if (platform_1.isWindows) {
                // Setup Windows mutex
                try {
                    const Mutex = require.__$__nodeRequire('windows-mutex').Mutex;
                    const windowsMutex = new Mutex(product_1.default.win32MutexName);
                    this._register(lifecycle_1.toDisposable(() => windowsMutex.release()));
                }
                catch (e) {
            ...
            keyboard_1.KeyboardLayoutMonitor.INSTANCE.onDidChangeKeyboardLayout(() => {
            ...
            const sharedProcessSpawn = this._register(new async_1.RunOnceScheduler(() => shellEnv_1.getShellEnvironment().then(userEnv => this.sharedProcess.spawn(userEnv)), 3000));
        ...
        handleRemoteAuthorities() {
            ...
            class ActiveConnection {
                constructor(authority, host, port) {
                    this._authority = authority;
                    this._client = remoteAgentConnection_1.connectRemoteAgentManagement(authority, host, port, `main`, isBuilt);
                    this._disposeRunner = new async_1.RunOnceScheduler(() => this.dispose(), 5000);
                }
                dispose() {
            ...
            electron_1.ipcMain.on('vscode:remoteAuthorityResolved', (event, data) => {
            ...
            const resolveAuthority = (authority) => {
                ...
                if (authority.indexOf('+') >= 0) {
                    if (resolvedAuthorities.has(authority)) {
                        return types_1.withUndefinedAsNull(resolvedAuthorities.get(authority));
                    }
            ...
            electron_1.protocol.registerBufferProtocol(remoteHosts_1.REMOTE_HOST_SCHEME, (request, callback) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const rawClient = yield activeConnection.getClient();
                    if (connectionPool.has(uri.authority)) { // not disposed in the meantime
                        const channel = rawClient.getChannel(remoteAgentFileSystemChannel_1.REMOTE_FILE_SYSTEM_CHANNEL_NAME);
                        // TODO@alex don't use call directly, wrap it around a `RemoteExtensionsFileSystemProvider`
                        const fileContents = yield channel.call('readFile', [uri]);
