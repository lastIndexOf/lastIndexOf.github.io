...
define(["require", "exports", "assert", "vs/base/browser/dom", "vs/base/browser/ui/grid/gridview", "./util"], function (require, exports, assert, dom_1, gridview_1, util_1) {
    ...
    suite('Gridview', function () {
        ...
        test('empty gridview is empty', function () {
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), []);
            gridview.dispose();
        });
        test('gridview addView', function () {
            ...
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), views);
            gridview.dispose();
        });
        ...
        test('gridview addView deep nested', function () {
            ...
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1]);
            const view2 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view2, 200, [1]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, view2]);
            const view3 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view3, 200, [1, 0]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [view3, view2]]);
            const view4 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view4, 200, [1, 0, 0]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [[view4, view3], view2]]);
            const view5 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view5, 200, [1, 0]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [view5, [view4, view3], view2]]);
            const view6 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view6, 200, [2]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [view5, [view4, view3], view2], view6]);
            const view7 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view7, 200, [1, 1]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [view5, view7, [view4, view3], view2], view6]);
            const view8 = new util_1.TestView(20, 20, 20, 20);
            gridview.addView(view8, 200, [1, 1, 0]);
            assert.deepEqual(util_1.nodesToArrays(gridview.getViews()), [view1, [view5, [view8, view7], [view4, view3], view2], view6]);
            gridview.dispose();
        });
