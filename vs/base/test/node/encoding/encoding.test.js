...
define(["require", "exports", "assert", "fs", "vs/base/node/encoding", "vs/base/node/stream", "stream", "vs/base/common/amd"], function (require, exports, assert, fs, encoding, stream_1, stream_2, amd_1) {
    "use strict";
    ...
    suite('Encoding', () => {
        test('detectBOM UTF-8', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const detectedEncoding = yield encoding.detectEncodingByBOM(file);
        ...
        test('detectEncodingFromBuffer (JSON saved as PNG)', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const buffer = yield stream_1.readExactlyByFile(file, 512);
        ...
        test('autoGuessEncoding (ShiftJIS)', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const buffer = yield stream_1.readExactlyByFile(file, 512 * 8);
        ...
        function readAndDecodeFromDisk(path, _encoding) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        test('toDecodeStream - some stream', function () {
            return __awaiter(this, void 0, void 0, function* () {
                let source = new stream_2.Readable({
                    read(size) {
                ...
                let { detected, stream } = yield encoding.toDecodeStream(source, { minBytesRequiredForDetection: 4 });
                assert.ok(detected);
                assert.ok(stream);
        ...
        test('toDecodeStream - some stream, expect too much data', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let { detected, stream } = yield encoding.toDecodeStream(source, { minBytesRequiredForDetection: 64 });
                assert.ok(detected);
                assert.ok(stream);
                const content = yield readAllAsString(stream);
                assert.equal(content, 'ABCABCABC');
        ...
        test('toDecodeStream - some stream, no data', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let { detected, stream } = yield encoding.toDecodeStream(source, { minBytesRequiredForDetection: 512 });
                assert.ok(detected);
                assert.ok(stream);
                const content = yield readAllAsString(stream);
        ...
        test('toDecodeStream - empty file', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let source = fs.createReadStream(path);
                let { detected, stream } = yield encoding.toDecodeStream(source, {});
                let expected = yield readAndDecodeFromDisk(path, detected.encoding);
                let actual = yield readAllAsString(stream);
                assert.equal(actual, expected);
            });
