...
define(["require", "exports", "vs/base/node/storage", "vs/base/common/uuid", "vs/base/common/path", "os", "assert", "vs/base/node/pfs", "vs/base/common/async", "vs/base/common/event", "vs/base/common/platform"], function (require, exports, storage_1, uuid_1, path_1, os_1, assert_1, pfs_1, async_1, event_1, platform_1) {
    "use strict";
    ...
    suite('Storage Library', () => {
        ...
        test('basics', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const storage = new storage_1.Storage(new storage_1.SQLiteStorageDatabase(path_1.join(storageDir, 'storage.db')));
            yield storage.init();
            // Empty fallbacks
            ...
            yield storage.close();
            yield pfs_1.del(storageDir, os_1.tmpdir());
        }));
        ...
        test('close flushes data', () => __awaiter(this, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
            let storage = new storage_1.Storage(new storage_1.SQLiteStorageDatabase(path_1.join(storageDir, 'storage.db')));
            yield storage.init();
            ...
            yield storage.close();
            assert_1.equal(setPromiseResolved, true);
            storage = new storage_1.Storage(new storage_1.SQLiteStorageDatabase(path_1.join(storageDir, 'storage.db')));
            yield storage.init();
            assert_1.equal(storage.get('foo'), 'bar');
            assert_1.equal(storage.get('bar'), 'foo');
            yield storage.close();
        ...
        test('corrupt DB recovers', () => __awaiter(this, void 0, void 0, function* () {
            ...
            let storage = new storage_1.Storage(new storage_1.SQLiteStorageDatabase(storageFile));
            yield storage.init();
            ...
            assert_1.equal(storage.get('foo'), 'bar');
            yield storage.close();
            storage = new storage_1.Storage(new storage_1.SQLiteStorageDatabase(storageFile));
            yield storage.init();
            assert_1.equal(storage.get('bar'), 'foo');
            assert_1.equal(storage.get('foo'), 'bar');
            yield storage.close();
