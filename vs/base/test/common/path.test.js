 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/platform"], function (require, exports, assert, path, platform_1) {
    "use strict";
    ...
    suite('Paths (Node Implementation)', () => {
        ...
        test('dirname', () => {
            assert.strictEqual(path.dirname(path.normalize(__filename)).substr(-11), platform_1.isWindows ? 'test\\common' : 'test/common');
