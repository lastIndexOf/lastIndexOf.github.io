...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/keyCodes", "vs/base/browser/keyboardEvent", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/browser/ui/list/listWidget", "vs/base/browser/event", "vs/base/common/platform", "vs/base/browser/htmlContentRenderer", "vs/css!./selectBoxCustom"], function (require, exports, lifecycle_1, event_1, keyCodes_1, keyboardEvent_1, dom, arrays, listWidget_1, event_2, platform_1, htmlContentRenderer_1) {
    ...
    class SelectBoxList {
        ...
        registerListeners() {
            ...
            this.toDispose.push(dom.addDisposableListener(this.selectElement, dom.EventType.KEY_DOWN, (e) => {
        ...
        createSelectList(parent) {
            ...
            onSelectDropDownKeyDown.filter(e => e.keyCode === 3 /* Enter */).on(e => this.onEnter(e), this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 9 /* Escape */).on(e => this.onEscape(e), this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 16 /* UpArrow */).on(this.onUpArrow, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 18 /* DownArrow */).on(this.onDownArrow, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 12 /* PageDown */).on(this.onPageDown, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 11 /* PageUp */).on(this.onPageUp, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 14 /* Home */).on(this.onHome, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => e.keyCode === 13 /* End */).on(this.onEnd, this, this.toDispose);
            onSelectDropDownKeyDown.filter(e => (e.keyCode >= 21 /* KEY_0 */ && e.keyCode <= 56 /* KEY_Z */) || (e.keyCode >= 80 /* US_SEMICOLON */ && e.keyCode <= 108 /* NUMPAD_DIVIDE */)).on(this.onCharacter, this, this.toDispose);
            ...
            this.toDispose.push(this.selectList.onDidBlur(_ => this.onListBlur()), this.selectList.onMouseOver(e => typeof e.index !== 'undefined' && this.selectList.setFocus([e.index])), this.selectList.onFocusChange(e => this.onListFocus(e)));
        ...
        renderDescriptionMarkdown(text) {
            ...
            const renderedMarkdown = htmlContentRenderer_1.renderMarkdown({ value: text });
