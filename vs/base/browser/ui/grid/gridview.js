...
define(["require", "exports", "vs/base/common/event", "vs/base/browser/ui/splitview/splitview", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/common/color", "vs/base/browser/ui/splitview/splitview", "vs/base/browser/ui/sash/sash", "vs/css!./gridview"], function (require, exports, event_1, splitview_1, lifecycle_1, dom_1, arrays_1, color_1, splitview_2, sash_1) {
    ...
    class GridView {
        constructor(options = {}) {
            ...
            this.root = new BranchNode(0 /* VERTICAL */, this.styles, this.proportionalLayout);
        }
        get root() {
            return this._root;
        }
