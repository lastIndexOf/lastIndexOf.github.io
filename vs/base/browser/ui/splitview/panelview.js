...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/browser/event", "vs/base/browser/keyboardEvent", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/common/color", "./splitview", "vs/css!./panelview"], function (require, exports, lifecycle_1, event_1, event_2, keyboardEvent_1, dom_1, arrays_1, color_1, splitview_1) {
    ...
    class Panel {
        ...
        render() {
            ...
            focusTracker.onDidFocus(() => dom_1.addClass(this.header, 'focused'), null, this.disposables);
            focusTracker.onDidBlur(() => dom_1.removeClass(this.header, 'focused'), null, this.disposables);
            this.updateHeader();
            ...
            onHeaderKeyDown.filter(e => e.keyCode === 3 /* Enter */ || e.keyCode === 10 /* Space */)
                .event(() => this.setExpanded(!this.isExpanded()), null, this.disposables);
            onHeaderKeyDown.filter(e => e.keyCode === 15 /* LeftArrow */)
                .event(() => this.setExpanded(false), null, this.disposables);
            onHeaderKeyDown.filter(e => e.keyCode === 17 /* RightArrow */)
                .event(() => this.setExpanded(true), null, this.disposables);
            event_2.domEvent(this.header, 'click')(() => this.setExpanded(!this.isExpanded()), null, this.disposables);
    ...
    class PanelView extends lifecycle_1.Disposable {
        ...
        addPanel(panel, size, index = this.splitview.length) {
            ...
            disposables.push(dom_1.scheduleAtNextAnimationFrame(() => shouldAnimate = true));
            event_1.Event.filter(panel.onDidChange, () => shouldAnimate)(this.setupAnimation, this, disposables);
            const panelItem = { panel, disposable: lifecycle_1.combinedDisposable(disposables) };
