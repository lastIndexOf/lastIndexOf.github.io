 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/common/strings", "vs/nls", "vs/base/browser/event", "vs/base/browser/keyboardEvent", "vs/base/browser/touch", "vs/base/browser/ui/menu/menu", "vs/base/common/actions", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle"], function (require, exports, browser, DOM, strings, nls, event_1, keyboardEvent_1, touch_1, menu_1, actions_1, async_1, event_2, lifecycle_1) {
    "use strict";
    ...
    class MenuBar extends lifecycle_1.Disposable {
        ...
        push(arg) {
            const menus = !Array.isArray(arg) ? [arg] : arg;
    ...
    class ModifierKeyEmitter extends event_2.Emitter {
        constructor() {
            ...
            this._subscriptions.push(event_1.domEvent(document.body, 'keydown', true)(e => {
            ...
            this._subscriptions.push(event_1.domEvent(document.body, 'keyup', true)(e => {
                if (!e.altKey && this._keyStatus.altKey) {
            ...
            this._subscriptions.push(event_1.domEvent(document.body, 'mousedown', true)(e => {
                this._keyStatus.lastKeyPressed = undefined;
            }));
            this._subscriptions.push(event_1.domEvent(document.body, 'mouseup', true)(e => {
                this._keyStatus.lastKeyPressed = undefined;
            }));
            this._subscriptions.push(event_1.domEvent(document.body, 'mousemove', true)(e => {
                if (e.buttons) {
                    this._keyStatus.lastKeyPressed = undefined;
                }
            }));
            this._subscriptions.push(event_1.domEvent(window, 'blur')(e => {
                this._keyStatus.lastKeyPressed = undefined;
                this._keyStatus.lastKeyReleased = undefined;
