 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/browser/browser", "vs/base/browser/dom", "vs/base/browser/htmlContentRenderer", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/event", "vs/base/browser/ui/widget", "vs/base/common/color", "vs/base/common/objects", "vs/base/common/history", "vs/css!./inputBox"], function (require, exports, nls, Bal, dom, htmlContentRenderer_1, aria, actionbar_1, event_1, widget_1, color_1, objects_1, history_1) {
    "use strict";
            ...
            this.contextViewProvider.showContextView({
                ...
                render: (container) => {
                    ...
                    const spanElement = (this.message.formatContent
                        ? htmlContentRenderer_1.renderFormattedText(this.message.content, renderOptions)
                        : htmlContentRenderer_1.renderText(this.message.content, renderOptions));
