 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/arrays", "./listWidget", "vs/base/common/event", "vs/base/common/cancellation", "vs/css!./list"], function (require, exports, arrays_1, listWidget_1, event_1, cancellation_1) {
    "use strict";
    ...
    class PagedList {
        constructor(container, virtualDelegate, renderers, options = {}) {
            ...
            this.list = new listWidget_1.List(container, virtualDelegate, pagedRenderers, options);
        }
        getHTMLElement() {
        ...
        get onPin() {
            return event_1.Event.map(this.list.onPin, ({ elements, indexes }) => ({ elements: elements.map(e => this._model.get(e)), indexes }));
        }
        get onContextMenu() {
