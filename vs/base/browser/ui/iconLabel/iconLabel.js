    ...
    class IconLabel extends lifecycle_1.Disposable {
        constructor(container, options) {
            ...
            if (options && options.supportHighlights) {
                this.labelNode = new highlightedLabel_1.HighlightedLabel(dom.append(this.labelDescriptionContainer.element, dom.$('a.label-name')), !options.donotSupportOcticons);
            }
            else {
            ...
            if (options && options.supportDescriptionHighlights) {
                this.descriptionNodeFactory = () => new highlightedLabel_1.HighlightedLabel(dom.append(this.labelDescriptionContainer.element, dom.$('span.label-description')), !options.donotSupportOcticons);
            }
            else {
