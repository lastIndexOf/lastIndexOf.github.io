 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/assert", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/base/common/event"], function (require, exports, Assert, errors_1, lifecycle_1, arrays, event_1) {
    "use strict";
    ...
    class TreeModel {
        ...
        selectParent(eventPayload, clearSelection = true) {
            let selection = this.getSelection();
            let item = selection.length > 0 ? selection[0] : this.input;
            let nav = this.getNavigator(item, false);
