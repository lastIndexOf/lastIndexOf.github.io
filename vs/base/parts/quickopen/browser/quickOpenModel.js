...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/base/browser/ui/iconLabel/iconLabel", "vs/base/common/comparers", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/base/browser/dom", "vs/base/browser/ui/keybindingLabel/keybindingLabel", "vs/base/common/platform", "vs/base/common/arrays"], function (require, exports, nls, types, iconLabel_1, comparers_1, actionbar_1, highlightedLabel_1, DOM, keybindingLabel_1, platform_1, arrays_1) {
    ...
    class Renderer {
        ...
        renderTemplate(templateId, container, styles) {
            ...
            // Label
            const label = new iconLabel_1.IconLabel(row1, { supportHighlights: true, supportDescriptionHighlights: true });
            // Keybinding
