...
define(["require", "exports", "assert", "vs/base/common/path", "os", "fs", "vs/platform/telemetry/node/workbenchCommonProperties", "vs/base/test/node/testUtils", "vs/platform/storage/common/storage", "vs/base/node/extfs", "vs/base/node/pfs", "vs/base/common/async"], function (require, exports, assert, path, os, fs, workbenchCommonProperties_1, testUtils_1, storage_1, extfs_1, pfs_1, async_1) {
    "use strict";
    ...
    suite('Telemetry - common properties', function () {
        ...
        test('default', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const props = yield workbenchCommonProperties_1.resolveWorkbenchCommonProperties(testStorageService, commit, version, 'someMachineId', installSource);
                ...
                const props_1 = yield workbenchCommonProperties_1.resolveWorkbenchCommonProperties(testStorageService, commit, version, 'someMachineId', installSource);
