...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/event", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/event", "vs/base/common/idGenerator", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/nls", "vs/platform/actions/common/actions", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/platform/notification/common/notification"], function (require, exports, dom_1, event_1, actionbar_1, event_2, idGenerator_1, lifecycle_1, platform_1, nls_1, actions_1, contextView_1, keybinding_1, notification_1) {
    ...
    class AlternativeKeyEmitter extends event_2.Emitter {
        constructor(contextMenuService) {
            ...
            this._subscriptions.push(event_1.domEvent(document.body, 'keydown')(e => {
                this.isPressed = e.altKey || ((platform_1.isWindows || platform_1.isLinux) && e.shiftKey);
            }));
            this._subscriptions.push(event_1.domEvent(document.body, 'keyup')(e => {
                if (this.isPressed) {
            ...
            this._subscriptions.push(event_1.domEvent(document.body, 'mouseleave')(e => this.isPressed = false));
            this._subscriptions.push(event_1.domEvent(document.body, 'blur')(e => this.isPressed = false));
    ...
    function fillInActions(groups, target, getAlternativeActions, isPrimaryGroup = group => group === 'navigation') {
    ...
    let MenuItemActionItem = class MenuItemActionItem extends actionbar_1.ActionItem {
        ...
        _updateItemClass(item) {
            ...
            if (item.iconLocation) {
                ...
                if (MenuItemActionItem.ICON_PATH_TO_CSS_RULES.has(iconPathMapKey)) {
                    ...
                    dom_1.createCSSRule(`.icon.${iconClass}`, `background-image: url("${(item.iconLocation.light || item.iconLocation.dark).toString()}")`);
                    dom_1.createCSSRule(`.vs-dark .icon.${iconClass}, .hc-black .icon.${iconClass}`, `background-image: url("${item.iconLocation.dark.toString()}")`);
                    MenuItemActionItem.ICON_PATH_TO_CSS_RULES.set(iconPathMapKey, iconClass);
                }
                dom_1.addClasses(this.label, 'icon', iconClass);
                this._itemClassDispose = lifecycle_1.toDisposable(() => dom_1.removeClasses(this.label, 'icon', iconClass));
            }
        }
        dispose() {
    ...
    // existing users
    class ContextAwareMenuItemActionItem extends MenuItemActionItem {
        onClick(event) {
            event.preventDefault();
            event.stopPropagation();
