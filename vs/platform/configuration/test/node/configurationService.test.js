...
define(["require", "exports", "assert", "os", "vs/base/common/path", "fs", "vs/platform/registry/common/platform", "vs/platform/configuration/node/configurationService", "vs/platform/environment/node/argv", "vs/platform/environment/node/environmentService", "vs/base/common/uuid", "vs/platform/configuration/common/configurationRegistry", "vs/base/test/node/utils"], function (require, exports, assert, os, path, fs, platform_1, configurationService_1, argv_1, environmentService_1, uuid, configurationRegistry_1, utils_1) {
    ...
    suite('ConfigurationService - Node', () => {
        test('simple', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const service = new configurationService_1.ConfigurationService(new SettingsTestEnvironmentService(argv_1.parseArgs(process.argv), process.execPath, res.testFile));
        ...
        test('missing file does not explode', () => {
            ...
            const service = new configurationService_1.ConfigurationService(new SettingsTestEnvironmentService(argv_1.parseArgs(process.argv), process.execPath, testFile));
            const config = service.getValue();
            assert.ok(config);
            service.dispose();
        });
        ...
        test('model defaults', () => {
            ...
            let serviceWithoutFile = new configurationService_1.ConfigurationService(new SettingsTestEnvironmentService(argv_1.parseArgs(process.argv), process.execPath, '__testFile'));
        ...
        test('lookup', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const service = new configurationService_1.ConfigurationService(new SettingsTestEnvironmentService(argv_1.parseArgs(process.argv), process.execPath, r.testFile));
