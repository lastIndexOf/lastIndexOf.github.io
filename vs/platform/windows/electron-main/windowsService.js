    ...
    let WindowsService = class WindowsService {
        ...
        openWindow(windowId, urisToOpen, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.windowsMainService.open({
                    ...
                    cli: options && options.args ? Object.assign({}, this.environmentService.args, options.args) : this.environmentService.args,
        ...
        openAboutDialog() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const detail = nls.localize('aboutDetail', "Version: {0}\nCommit: {1}\nDate: {2}\nElectron: {3}\nChrome: {4}\nNode.js: {5}\nV8: {6}\nOS: {7}", version, product_1.default.commit || 'Unknown', product_1.default.date || 'Unknown', process.versions['electron'], process.versions['chrome'], process.versions['node'], process.versions['v8'], `${os.type()} ${os.arch()} ${os.release()}`);
        ...
        openFileForURI(uri) {
            ...
            this.windowsMainService.open({ context: 5 /* API */, cli, urisToOpen });
        }
