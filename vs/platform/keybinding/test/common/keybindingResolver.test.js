define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/base/common/platform", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingResolver", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/platform/keybinding/common/usLayoutResolvedKeybinding"], function (require, exports, assert, keyCodes_1, platform_1, contextkey_1, keybindingResolver_1, resolvedKeybindingItem_1, usLayoutResolvedKeybinding_1) {
    ...
    suite('KeybindingResolver', () => {
        function kbItem(keybinding, command, commandArgs, when, isDefault) {
            const resolvedKeybinding = (keybinding !== 0 ? new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding(keyCodes_1.createKeybinding(keybinding, platform_1.OS), platform_1.OS) : null);
        ...
        test('contextIsEntirelyIncluded', () => {
            let assertIsIncluded = (a, b) => {
                let tmpA = new contextkey_1.ContextKeyAndExpr(a).normalize();
                let tmpB = new contextkey_1.ContextKeyAndExpr(b).normalize();
                assert.equal(keybindingResolver_1.KeybindingResolver.whenIsEntirelyIncluded(tmpA, tmpB), true);
            };
            let assertIsNotIncluded = (a, b) => {
                let tmpA = new contextkey_1.ContextKeyAndExpr(a).normalize();
                let tmpB = new contextkey_1.ContextKeyAndExpr(b).normalize();
            ...
            let key2IsTrue = contextkey_1.ContextKeyExpr.equals('key2', true);
            let key2IsNotFalse = contextkey_1.ContextKeyExpr.notEquals('key2', false);
            let key3IsTrue = contextkey_1.ContextKeyExpr.equals('key3', true);
            let key4IsTrue = contextkey_1.ContextKeyExpr.equals('key4', true);
