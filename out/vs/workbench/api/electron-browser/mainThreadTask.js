...
define(["require", "exports", "vs/nls", "vs/base/common/uri", "vs/base/common/uuid", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/collections", "vs/platform/workspace/common/workspace", "vs/workbench/contrib/tasks/common/tasks", "vs/workbench/contrib/tasks/common/taskService", "vs/workbench/contrib/tasks/node/tasks", "vs/workbench/api/electron-browser/extHostCustomers", "vs/workbench/api/node/extHost.protocol", "vs/workbench/services/configurationResolver/common/configurationResolver"], function (require, exports, nls, uri_1, uuid_1, Objects, Types, Platform, collections_1, workspace_1, tasks_1, taskService_1, tasks_2, extHostCustomers_1, extHost_protocol_1, configurationResolver_1) {
    ...
    (function (TaskExecutionDTO) {
        ...
        function to(value, workspace, executeOnly) {
            return {
                id: value.id,
    ...
    (function (TaskDefinitionDTO) {
        ...
        function to(value, executeOnly) {
            let result = tasks_2.TaskDefinition.createTaskIdentifier(value, console);
    ...
    let MainThreadTask = class MainThreadTask {
        ...
        $executeTask(value) {
            return new Promise((resolve, reject) => {
                if (TaskHandleDTO.is(value)) {
                    const workspaceFolder = this._workspaceContextServer.getWorkspaceFolder(uri_1.URI.revive(value.workspaceFolder));
                    this._taskService.getTask(workspaceFolder, value.id, true).then((task) => {
        ...
        $registerTaskSystem(key, info) {
            ...
            this._taskService.registerTaskSystem(key, {
                ...
                resolveVariables: (workspaceFolder, toResolve) => {
                    const vars = [];
