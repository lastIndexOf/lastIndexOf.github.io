...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/extensions/common/extensions", "vs/platform/instantiation/common/instantiation", "vs/platform/label/common/label", "vs/workbench/services/search/common/search", "vs/platform/statusbar/common/statusbar", "vs/platform/windows/common/windows", "vs/platform/workspace/common/workspace", "vs/workbench/api/electron-browser/extHostCustomers", "vs/workbench/contrib/search/common/queryBuilder", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/workspace/common/workspaceEditing", "../node/extHost.protocol"], function (require, exports, errors_1, lifecycle_1, uri_1, nls_1, commands_1, extensions_1, instantiation_1, label_1, search_1, statusbar_1, windows_1, workspace_1, extHostCustomers_1, queryBuilder_1, extensions_2, textfiles_1, workspaceEditing_1, extHost_protocol_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let MainThreadWorkspace = class MainThreadWorkspace {
        constructor(extHostContext, _searchService, _contextService, _textFileService, _workspaceEditingService, _statusbarService, _windowService, _instantiationService, _labelService) {
