...
define(["require", "exports", "vs/workbench/api/electron-browser/extHostCustomers", "vs/platform/log/common/log", "vs/base/common/lifecycle", "vs/workbench/api/node/extHost.protocol"], function (require, exports, extHostCustomers_1, log_1, lifecycle_1, extHost_protocol_1) {
    ...
    let MainThreadLogService = class MainThreadLogService extends lifecycle_1.Disposable {
        constructor(extHostContext, logService) {
            super();
            this._register(logService.onDidChangeLogLevel(level => extHostContext.getProxy(extHost_protocol_1.ExtHostContext.ExtHostLogService).$setLevel(level)));
        }
    };
