...
define(["require", "exports", "vs/base/common/lifecycle", "../node/extHost.protocol", "vs/workbench/common/views", "vs/workbench/api/electron-browser/extHostCustomers", "vs/base/common/arrays", "vs/platform/notification/common/notification", "vs/base/common/types", "vs/platform/registry/common/platform"], function (require, exports, lifecycle_1, extHost_protocol_1, views_1, extHostCustomers_1, arrays_1, notification_1, types_1, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let MainThreadTreeViews = class MainThreadTreeViews extends lifecycle_1.Disposable {
        constructor(extHostContext, viewsService, notificationService) {
            super();
        ...
        reveal(treeView, dataProvider, itemIn, parentChain, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (dataProvider.isEmpty()) {
                    // Refresh if empty
                    yield treeView.refresh();
                }
                for (const parent of parentChain) {
                    yield treeView.expand(parent);
                }
                const item = dataProvider.getItem(itemIn.handle);
                if (item) {
                    yield treeView.reveal(item);
                    if (select) {
                    ...
                    for (; itemsToExpand.length > 0 && expand > 0; expand--) {
                        yield treeView.expand(itemsToExpand);
