...
define(["require", "exports", "vs/platform/quickinput/common/quickInput", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/electron-browser/extHostCustomers", "vs/base/common/uri"], function (require, exports, quickInput_1, extHost_protocol_1, extHostCustomers_1, uri_1) {
    "use strict";
    ...
    let MainThreadQuickOpen = class MainThreadQuickOpen {
        ...
        $show(instance, options, token) {
            ...
            options = Object.assign({}, options, { onDidFocus: el => {
                    if (el) {
