...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/strings", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/services/editorWorkerService", "vs/editor/common/services/modelService", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionCommands", "vs/editor/contrib/codeAction/codeActionTrigger", "vs/editor/contrib/format/format", "vs/editor/contrib/format/formattingEdit", "vs/editor/contrib/snippet/snippetController2", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/platform/log/common/log", "vs/platform/progress/common/progress", "vs/workbench/api/electron-browser/extHostCustomers", "vs/workbench/services/textfile/common/textFileEditorModel", "../node/extHost.protocol", "vs/platform/telemetry/common/telemetry"], function (require, exports, arrays_1, async_1, cancellation_1, strings, bulkEditService_1, codeEditorService_1, trimTrailingWhitespaceCommand_1, editOperation_1, position_1, range_1, selection_1, editorWorkerService_1, modelService_1, codeAction_1, codeActionCommands_1, codeActionTrigger_1, format_1, formattingEdit_1, snippetController2_1, nls_1, commands_1, configuration_1, instantiation_1, log_1, progress_1, extHostCustomers_1, textFileEditorModel_1, extHost_protocol_1, telemetry_1) {
    "use strict";
    ...
    let FinalNewLineParticipant = class FinalNewLineParticipant {
        ...
        doInsertFinalNewLine(model) {
            ...
            model.pushEditOperations(prevSelection, [editOperation_1.EditOperation.insert(new position_1.Position(lineCount, model.getLineMaxColumn(lineCount)), model.getEOL())], edits => prevSelection);
            if (editor) {
    ...
    let FormatOnSaveParticipant = class FormatOnSaveParticipant {
        constructor(_editorService, _editorWorkerService, _configurationService, _telemetryService) {
        ...
        participate(editorModel, env) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    const request = format_1.getDocumentFormattingEdits(this._telemetryService, this._editorWorkerService, model, model.getFormattingOptions(), 1 /* Auto */, source.token);
                    setTimeout(() => {
                    ...
                    if (arrays_1.isNonEmptyArray(edits) && versionNow === model.getVersionId()) {
        ...
        _editsWithEditor(editor, edits) {
            formattingEdit_1.FormattingEdit.execute(editor, edits);
        }
        _editWithModel(model, edits) {
            const [{ range }] = edits;
        ...
        static _asIdentEdit({ text, range }) {
            return {
                text,
