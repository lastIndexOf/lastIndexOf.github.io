...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/map", "vs/editor/browser/editorBrowser", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/workbench/api/electron-browser/extHostCustomers", "vs/workbench/api/electron-browser/mainThreadDocuments", "vs/workbench/api/electron-browser/mainThreadEditor", "vs/workbench/api/electron-browser/mainThreadEditors", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/shared/editor", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledEditorService"], function (require, exports, event_1, lifecycle_1, map_1, editorBrowser_1, bulkEditService_1, codeEditorService_1, modeService_1, modelService_1, resolverService_1, files_1, extHostCustomers_1, mainThreadDocuments_1, mainThreadEditor_1, mainThreadEditors_1, extHost_protocol_1, editor_1, textEditor_1, editorService_1, editorGroupsService_1, panelService_1, textfiles_1, untitledEditorService_1) {
    "use strict";
    ...
    let MainThreadDocumentsAndEditors = class MainThreadDocumentsAndEditors {
        constructor(extHostContext, _modelService, _textFileService, _editorService, codeEditorService, modeService, fileService, textModelResolverService, untitledEditorService, _editorGroupService, bulkEditService, panelService) {
            this._modelService = _modelService;
            ...
            const mainThreadDocuments = new mainThreadDocuments_1.MainThreadDocuments(this, extHostContext, this._modelService, modeService, this._textFileService, fileService, textModelResolverService, untitledEditorService);
            extHostContext.set(extHost_protocol_1.MainContext.MainThreadDocuments, mainThreadDocuments);
            const mainThreadTextEditors = new mainThreadEditors_1.MainThreadTextEditors(this, extHostContext, codeEditorService, bulkEditService, this._editorService, this._editorGroupService);
        ...
        _onDelta(delta) {
            ...
            for (const apiEditor of delta.addedEditors) {
                const mainThreadEditor = new mainThreadEditor_1.MainThreadTextEditor(apiEditor.id, apiEditor.editor.getModel(), apiEditor.editor, { onGainedFocus() { }, onLostFocus() { } }, this._modelService);
    ...
    MainThreadDocumentsAndEditors = __decorate([
        ...
        __param(10, bulkEditService_1.IBulkEditService),
        __param(11, panelService_1.IPanelService)
