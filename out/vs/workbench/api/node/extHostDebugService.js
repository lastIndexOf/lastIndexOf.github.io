...
define(["require", "exports", "vs/base/common/path", "vs/base/common/network", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/async", "vs/nls", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/node/extHostTypes", "vs/workbench/contrib/debug/node/debugAdapter", "vs/workbench/contrib/debug/node/terminals", "vs/workbench/services/configurationResolver/common/variableResolver", "vs/workbench/contrib/debug/common/debugUtils", "vs/base/common/cancellation"], function (require, exports, path, network_1, uri_1, event_1, async_1, nls, extHost_protocol_1, extHostTypes_1, debugAdapter_1, terminals_1, variableResolver_1, debugUtils_1, cancellation_1) {
    "use strict";
    ...
    class ExtHostDebugService {
        ...
        $provideDebugConfigurations(configProviderHandle, folderUri) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const folder = yield this.getFolder(folderUri);
                return async_1.asPromise(() => provider.provideDebugConfigurations(folder, cancellation_1.CancellationToken.None));
            });
        }
        $resolveDebugConfiguration(configProviderHandle, folderUri, debugConfiguration) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const folder = yield this.getFolder(folderUri);
                return async_1.asPromise(() => provider.resolveDebugConfiguration(folder, debugConfiguration, cancellation_1.CancellationToken.None));
            });
        }
        // TODO@AW legacy
        $legacyDebugAdapterExecutable(configProviderHandle, folderUri) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const folder = yield this.getFolder(folderUri);
                return async_1.asPromise(() => provider.debugAdapterExecutable(folder, cancellation_1.CancellationToken.None)).then(x => this.convertToDto(x));
            });
        }
        ...
        getDebugAdapterTrackers(session) {
            ...
            const promises = this._trackerFactories
                ...
                .map(tuple => async_1.asPromise(() => tuple.factory.createDebugAdapterTracker(session)).then(p => p).catch(err => null));
            return Promise.race([
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (pairs.length > 0) {
                    if (pairs[0].provider.debugAdapterExecutable) {
                        return async_1.asPromise(() => pairs[0].provider.debugAdapterExecutable(session.workspaceFolder, cancellation_1.CancellationToken.None));
                    }
                }
                if (adapterProvider) {
                    const extensionRegistry = yield this._extensionService.getExtensionRegistry();
                    return async_1.asPromise(() => adapterProvider.createDebugAdapterDescriptor(session, this.daExecutableFromPackage(session, extensionRegistry)));
                }
    ...
    class DirectDebugAdapter extends debugAdapter_1.AbstractDebugAdapter {
