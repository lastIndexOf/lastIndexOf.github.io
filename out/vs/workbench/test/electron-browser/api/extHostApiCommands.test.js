            ...
            let inst;
            {
                ...
                instantiationService.stub(commands_1.ICommandService, {
                    ...
                    executeCommand(id, args) {
                        ...
                        let { handler } = commands_1.CommandsRegistry.getCommands()[id];
