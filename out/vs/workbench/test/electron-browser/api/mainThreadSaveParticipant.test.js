    ...
    suite('MainThreadSaveParticipant', function () {
        ...
        test('insert final new line', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const model = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/final_new_line.txt'), 'utf8');
                yield model.load();
        ...
        test('trim final new lines', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const model = instantiationService.createInstance(textFileEditorModel_1.TextFileEditorModel, utils_1.toResource.call(this, '/path/trim_final_new_line.txt'), 'utf8');
                yield model.load();
                const configService = new testConfigurationService_1.TestConfigurationService();
        ...
        test('trim final new lines bug#46075', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                model.textEditorModel.undo();
                assert.equal(files_1.snapshotToString(model.createSnapshot()), `${textContent}${eol}${eol}`);
                model.textEditorModel.redo();
                assert.equal(files_1.snapshotToString(model.createSnapshot()), `${textContent}${eol}`);
            });
        });
