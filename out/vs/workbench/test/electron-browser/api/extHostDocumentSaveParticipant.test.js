...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/api/node/extHostDocuments", "vs/workbench/api/node/extHostDocumentsAndEditors", "vs/workbench/api/node/extHostTypes", "vs/workbench/api/node/extHostDocumentSaveParticipant", "./testRPCProtocol", "vs/workbench/test/electron-browser/api/mock", "vs/platform/log/common/log", "vs/editor/common/modes", "vs/base/common/async", "vs/platform/extensions/common/extensions"], function (require, exports, assert, uri_1, extHostDocuments_1, extHostDocumentsAndEditors_1, extHostTypes_1, extHostDocumentSaveParticipant_1, testRPCProtocol_1, mock_1, log_1, modes_1, async_1, extensions_1) {
    "use strict";
