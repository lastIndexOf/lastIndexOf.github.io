 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "sinon", "vs/base/common/event", "vs/workbench/api/node/extHostTreeViews", "vs/workbench/api/node/extHostCommands", "vs/workbench/api/node/extHost.protocol", "./testRPCProtocol", "vs/workbench/api/node/extHostHeapService", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/workbench/api/electron-browser/mainThreadCommands", "vs/workbench/test/electron-browser/api/mock", "vs/workbench/common/views", "vs/platform/log/common/log"], function (require, exports, assert, sinon, event_1, extHostTreeViews_1, extHostCommands_1, extHost_protocol_1, testRPCProtocol_1, extHostHeapService_1, instantiationServiceMock_1, mainThreadCommands_1, mock_1, views_1, log_1) {
    "use strict";
    ...
    suite('ExtHostTreeView', function () {
        ...
        setup(() => {
            ...
            testObject = new extHostTreeViews_1.ExtHostTreeViews(target, new extHostCommands_1.ExtHostCommands(rpcProtocol, new extHostHeapService_1.ExtHostHeapService(), new log_1.NullLogService()), new log_1.NullLogService());
