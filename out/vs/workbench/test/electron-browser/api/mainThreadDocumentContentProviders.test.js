 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/api/electron-browser/mainThreadDocumentContentProviders", "vs/editor/common/model/textModel", "vs/workbench/test/electron-browser/api/mock", "vs/workbench/test/electron-browser/api/testRPCProtocol"], function (require, exports, assert, uri_1, mainThreadDocumentContentProviders_1, textModel_1, mock_1, testRPCProtocol_1) {
    "use strict";
