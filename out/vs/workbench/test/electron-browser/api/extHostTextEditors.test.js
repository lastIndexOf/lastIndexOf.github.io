...
define(["require", "exports", "assert", "vs/workbench/api/node/extHostTypes", "vs/workbench/api/node/extHost.protocol", "vs/base/common/uri", "vs/workbench/test/electron-browser/api/mock", "vs/workbench/api/node/extHostDocumentsAndEditors", "vs/workbench/test/electron-browser/api/testRPCProtocol", "vs/workbench/api/node/extHostTextEditors"], function (require, exports, assert, extHostTypes, extHost_protocol_1, uri_1, mock_1, extHostDocumentsAndEditors_1, testRPCProtocol_1, extHostTextEditors_1) {
    "use strict";
