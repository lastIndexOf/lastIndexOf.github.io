...
define(["require", "exports", "assert", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/base/common/uri", "vs/workbench/services/search/common/search", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/node/extHostSearch", "vs/workbench/api/node/extHostTypes", "vs/workbench/services/search/node/textSearchManager", "vs/workbench/test/electron-browser/api/testRPCProtocol", "vs/workbench/test/workbenchTestServices"], function (require, exports, assert, arrays_1, cancellation_1, errors_1, lifecycle_1, resources_1, uri_1, search_1, extHost_protocol_1, extHostSearch_1, extHostTypes_1, textSearchManager_1, testRPCProtocol_1, workbenchTestServices_1) {
    "use strict";
    ...
    suite('ExtHostSearch', () => {
        ...
        setup(() => {
            ...
            const logService = new workbenchTestServices_1.TestLogService();
            rpcProtocol.set(extHost_protocol_1.MainContext.MainThreadSearch, mockMainThreadSearch);
            mockExtfs = {};
            extHostSearch = new extHostSearch_1.ExtHostSearch(rpcProtocol, null, logService, mockExtfs);
        });
        teardown(() => {
        ...
        suite('File:', () => {
            ...
            test('works with non-file schemes', () => __awaiter(this, void 0, void 0, function* () {
                const reportedResults = [
                    ...
                    resources_1.joinPath(fancySchemeFolderA, 'file3.ts'),
                ];
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
                        return Promise.resolve(reportedResults);
        ...
        suite('Text:', () => {
            ...
            function assertResults(actual, expected) {
                ...
                const makeComparable = (results) => results
                    .sort((a, b) => {
                    const compareKeyA = a.uri.toString() + ': ' + (textSearchManager_1.extensionResultIsMatch(a) ? a.preview.text : a.text);
                    const compareKeyB = b.uri.toString() + ': ' + (textSearchManager_1.extensionResultIsMatch(b) ? b.preview.text : b.text);
                    return compareKeyB.localeCompare(compareKeyA);
                })
                    .map(r => textSearchManager_1.extensionResultIsMatch(r) ? {
                    uri: r.uri.toString(),
            ...
            test('basic sibling clause', () => __awaiter(this, void 0, void 0, function* () {
                mockExtfs.readdir = (_path, callback) => {
