    ...
    let HistoryService = class HistoryService extends lifecycle_1.Disposable {
        ...
        onActiveEditorChanged() {
            ...
            if (activeTextEditorWidget) {
                ...
                this.activeEditorListeners.push(event_1.Event.debounce(activeTextEditorWidget.onDidChangeCursorPosition, (last, event) => event, 0)((event => {
                ...
                this.activeEditorListeners.push(event_1.Event.debounce(activeTextEditorWidget.onDidChangeModelContent, (last, event) => event, 0)((event => this.rememberLastEditLocation(activeEditor, activeTextEditorWidget))));
            }
        }
        ...
        getLastActiveFile(schemeFilter) {
            const history = this.getHistory();
            for (const input of history) {
                let resource;
                if (input instanceof editor_1.EditorInput) {
