    ...
    let ExtensionHostProcessManager = class ExtensionHostProcessManager extends lifecycle_1.Disposable {
        ...
        measure() {
            return __awaiter(this, void 0, void 0, function* () {
                const latency = yield this._measureLatency();
                const down = yield this._measureDown();
                const up = yield this._measureUp();
                return {
        ...
        _measureLatency() {
            return __awaiter(this, void 0, void 0, function* () {
                const COUNT = 10;
                const { value: proxy } = yield this._extensionHostProcessProxy;
                let sum = 0;
