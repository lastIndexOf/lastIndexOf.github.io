...
define(["require", "exports", "vs/nls", "vs/base/common/path", "vs/base/common/types", "vs/base/common/network", "vs/workbench/common/editor", "vs/base/common/collections", "vs/platform/environment/common/environment", "vs/platform/configuration/common/configuration", "vs/platform/commands/common/commands", "vs/platform/workspace/common/workspace", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/configurationResolver/common/variableResolver", "vs/editor/browser/editorBrowser", "vs/workbench/common/editor/diffEditorInput", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/platform/windows/common/windows", "vs/platform/instantiation/common/extensions"], function (require, exports, nls, path, Types, network_1, editor_1, collections_1, environment_1, configuration_1, commands_1, workspace_1, editorService_1, variableResolver_1, editorBrowser_1, diffEditorInput_1, quickInput_1, configurationResolver_1, windows_1, extensions_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ConfigurationResolverService = class ConfigurationResolverService extends variableResolver_1.AbstractVariableResolverService {
        constructor(windowService, editorService, environmentService, configurationService, commandService, workspaceContextService, quickInputService) {
            super({
                ...
                getConfigurationValue: (folderUri, suffix) => {
                    return configurationService.getValue(suffix, folderUri ? { resource: folderUri } : undefined);
                },
                getExecPath: () => {
                ...
                getFilePath: () => {
                    ...
                    const fileResource = editor_1.toResource(activeEditor, { filter: network_1.Schemas.file });
                    if (!fileResource) {
                        return undefined;
                    }
        ...
        resolveWithInputAndCommands(folder, configuration, variableToCommandMap, section) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (folder && this.workspaceContextService.getWorkbenchState() !== 1 /* EMPTY */) {
