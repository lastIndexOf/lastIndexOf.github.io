...
define(["require", "exports", "vs/platform/instantiation/common/instantiation", "vs/workbench/common/editor", "vs/workbench/common/editor/resourceEditorInput", "vs/workbench/common/editor/dataUriEditorInput", "vs/platform/registry/common/platform", "vs/base/common/map", "vs/workbench/services/untitled/common/untitledEditorService", "vs/platform/files/common/files", "vs/base/common/network", "vs/base/common/event", "vs/base/common/uri", "vs/base/common/resources", "vs/workbench/common/editor/diffEditorInput", "vs/nls", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/editor/browser/editorBrowser", "vs/platform/label/common/label", "vs/platform/instantiation/common/extensions", "vs/base/common/types"], function (require, exports, instantiation_1, editor_1, resourceEditorInput_1, dataUriEditorInput_1, platform_1, map_1, untitledEditorService_1, files_1, network_1, event_1, uri_1, resources_1, diffEditorInput_1, nls_1, editorGroupsService_1, editorService_1, configuration_1, lifecycle_1, arrays_1, editorBrowser_1, label_1, extensions_1, types_1) {
    ...
    let EditorService = class EditorService extends lifecycle_1.Disposable {
        ...
        get onDidActiveEditorChange() { return this._onDidActiveEditorChange.event; }
        get onDidVisibleEditorsChange() { return this._onDidVisibleEditorsChange.event; }
        ...
        openEditor(editor, optionsOrGroup, group) {
            ...
            if (editor instanceof editor_1.EditorInput) {
                const editorOptions = this.toOptions(optionsOrGroup);
            ...
            if (typedInput) {
                const editorOptions = editor_1.TextEditorOptions.from(textInput);
                const targetGroup = this.findTargetGroup(typedInput, editorOptions, optionsOrGroup);
        ...
        openEditors(editors, group) {
            ...
            editors.forEach(editor => {
                if (editor_1.isEditorInputWithOptions(editor)) {
                    ...
                    typedEditors.push({ editor: this.createInput(editor), options: editor_1.TextEditorOptions.from(editor) });
                }
            });
            ...
            return Promise.all(result).then(editors => arrays_1.coalesce(editors));
        }
        //#endregion
        //#region isOpen()
        isOpen(editor, group) {
        ...
        //#endregion
        //#region getOpend()
        getOpened(editor, group) {
            return this.doGetOpened(editor);
        }
        doGetOpened(editor, group) {
            if (!(editor instanceof editor_1.EditorInput)) {
            ...
            for (const group of groups) {
                ...
                // Resource editor
                    ...
                    for (const editorInGroup of group.editors) {
                        const resource = editor_1.toResource(editorInGroup, { supportSideBySide: true });
                        if (!resource) {
        ...
        replaceEditors(editors, group) {
            ...
            editors.forEach(replaceEditorArg => {
                if (replaceEditorArg.editor instanceof editor_1.EditorInput) {
                    ...
                    const replacementEditor = this.createInput(replaceEditorArg.replacement);
                    typedEditors.push({
                        editor: typedEditor,
        ...
        createOrGet(resource, instantiationService, label, description, encoding, forceFile) {
