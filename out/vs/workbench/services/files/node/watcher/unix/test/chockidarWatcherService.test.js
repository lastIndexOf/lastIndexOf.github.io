...
define(["require", "exports", "assert", "os", "vs/base/common/path", "vs/base/node/pfs", "../chokidarWatcherService", "vs/base/common/platform", "vs/base/common/async"], function (require, exports, assert, os, path, pfs, chokidarWatcherService_1, platform, async_1) {
    ...
    suite.skip('Chockidar watching', () => {
        ...
        test('simple file operations, single root, no ignore', () => __awaiter(this, void 0, void 0, function* () {
            let request = { basePath: testDir, ignored: [] };
        ...
        test('simple file operations, ignore', () => __awaiter(this, void 0, void 0, function* () {
            let request = { basePath: testDir, ignored: ['**/b/**', '**/*.js', '.git/**'] };
            service.setRoots([request]);
            yield wait(300);
            assert.equal(service.wacherCount, 1);
            ...
            // delete all files
            yield pfs.del(movedFile1); // hidden
            yield pfs.del(movedFile2);
            yield pfs.del(movedFile3);
            yield pfs.del(folder1); // hidden
            yield pfs.del(folder2); // hidden
            yield pfs.del(folder3); // hidden
            yield pfs.del(folder4);
            yield pfs.del(folder5);
            yield pfs.del(file4);
        ...
        test('simple file operations, multiple roots', () => __awaiter(this, void 0, void 0, function* () {
            let request1 = { basePath: aFolder, ignored: ['**/*.js'] };
            let request2 = { basePath: b2Folder, ignored: ['**/*.ts'] };
            ...
            // change roots
            let request3 = { basePath: aFolder, ignored: ['**/*.json'] };
            service.setRoots([request3]);
            yield wait(300);
            assert.equal(service.wacherCount, 1);
            // delete all
            yield pfs.del(folderPath1);
            yield pfs.del(folderPath2);
            yield pfs.del(filePath4);
        ...
        test('simple file operations, nested roots', () => __awaiter(this, void 0, void 0, function* () {
            let request1 = { basePath: testDir, ignored: ['**/b2/**'] };
            let request2 = { basePath: bFolder, ignored: ['**/b3/**'] };
            service.setRoots([request1, request2]);
            yield wait(300);
            assert.equal(service.wacherCount, 1);
            // create files
