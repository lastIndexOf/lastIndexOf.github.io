 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/workbench/services/files/node/watcher/common", "vs/base/common/event"], function (require, exports, assert, platform, uri_1, common_1, event_1) {
    "use strict";
    ...
    class TestFileWatcher {
        ...
        onRawFileEvents(events) {
            // Normalize
            let normalizedEvents = common_1.normalize(events);
