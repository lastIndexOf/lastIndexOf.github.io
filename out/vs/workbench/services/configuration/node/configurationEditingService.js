...
define(["require", "exports", "vs/nls", "vs/base/common/uri", "vs/base/common/json", "vs/base/node/encoding", "vs/base/common/strings", "vs/base/common/jsonEdit", "vs/base/common/async", "vs/editor/common/core/editOperation", "vs/platform/registry/common/platform", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/platform/workspace/common/workspace", "vs/platform/environment/common/environment", "vs/workbench/services/textfile/common/textfiles", "vs/platform/configuration/common/configuration", "vs/workbench/services/configuration/common/configuration", "vs/platform/files/common/files", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configurationRegistry", "vs/workbench/services/editor/common/editorService", "vs/platform/notification/common/notification", "vs/workbench/services/preferences/common/preferences"], function (require, exports, nls, uri_1, json, encoding, strings, jsonEdit_1, async_1, editOperation_1, platform_1, range_1, selection_1, workspace_1, environment_1, textfiles_1, configuration_1, configuration_2, files_1, resolverService_1, configurationRegistry_1, editorService_1, notification_1, preferences_1) {
    ...
    let ConfigurationEditingService = class ConfigurationEditingService {
        constructor(configurationService, contextService, environmentService, fileService, textModelResolverService, textFileService, notificationService, preferencesService, editorService) {
        ...
        resolveModelReference(resource) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!exists) {
                    yield this.fileService.updateContent(resource, '{}', { encoding: encoding.UTF8 });
                }
        ...
        resolveAndValidate(target, operation, checkDirty, overrides) {
            ...
            if (operation.workspaceStandAloneConfigurationKey) {
                ...
                if (target === 1 /* USER */) {
                    return this.reject(3 /* ERROR_INVALID_USER_TARGET */, target, operation);
                }
                // Workspace tasks are not supported
                if (operation.workspaceStandAloneConfigurationKey === configuration_2.TASKS_CONFIGURATION_KEY && this.contextService.getWorkbenchState() === 3 /* WORKSPACE */ && operation.target === 2 /* WORKSPACE */) {
                    return this.reject(4 /* ERROR_INVALID_WORKSPACE_TARGET */, target, operation);
                }
            }
            // Target cannot be workspace or folder if no workspace opened
            if ((target === 2 /* WORKSPACE */ || target === 3 /* WORKSPACE_FOLDER */) && this.contextService.getWorkbenchState() === 1 /* EMPTY */) {
                return this.reject(6 /* ERROR_NO_WORKSPACE_OPENED */, target, operation);
            }
            ...
            if (target === 3 /* WORKSPACE_FOLDER */) {
                if (!operation.resource) {
                    return this.reject(5 /* ERROR_INVALID_FOLDER_TARGET */, target, operation);
                }
                if (!operation.workspaceStandAloneConfigurationKey) {
                    const configurationProperties = platform_1.Registry.as(configurationRegistry_1.Extensions.Configuration).getConfigurationProperties();
                    if (configurationProperties[operation.key].scope !== 3 /* RESOURCE */) {
                        return this.reject(2 /* ERROR_INVALID_FOLDER_CONFIGURATION */, target, operation);
                    }
                }
            }
            if (!operation.resource) {
            ...
            return this.resolveModelReference(operation.resource)
                ...
                if (this.hasParseErrors(model, operation)) {
                    return this.reject(8 /* ERROR_INVALID_CONFIGURATION */, target, operation);
                }
                // Target cannot be dirty if not writing into buffer
                if (checkDirty && this.textFileService.isDirty(operation.resource)) {
                    return this.reject(7 /* ERROR_CONFIGURATION_FILE_DIRTY */, target, operation);
                }
                return reference;
            });
        }
        getConfigurationEditOperation(target, config, overrides) {
            ...
            if (config.key) {
                ...
                for (const key of standaloneConfigurationKeys) {
                    const resource = this.getConfigurationFileResource(target, configuration_2.WORKSPACE_STANDALONE_CONFIGURATIONS[key], overrides.resource);
                    // Check for prefix
                    if (config.key === key) {
