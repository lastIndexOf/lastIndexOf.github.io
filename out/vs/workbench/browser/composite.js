 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/actions", "vs/workbench/common/component", "vs/base/common/event", "vs/base/browser/dom", "vs/base/common/lifecycle"], function (require, exports, actions_1, component_1, event_1, dom_1, lifecycle_1) {
    "use strict";
    ...
    class Composite extends component_1.Component {
        ...
        get onTitleAreaUpdate() { return this._onTitleAreaUpdate.event; }
        ...
        registerFocusTrackEvents() {
            ...
            const focusTracker = this._register(dom_1.trackFocus(this.getContainer()));
    ...
    class CompositeDescriptor {
        constructor(ctor, id, name, cssClass, order, keybindingId) {
            this.ctor = ctor;
            this.id = id;
            this.name = name;
    ...
    class CompositeRegistry extends lifecycle_1.Disposable {
        ...
        get onDidRegister() { return this._onDidRegister.event; }
        get onDidDeregister() { return this._onDidDeregister.event; }
