...
define(["require", "exports", "vs/base/common/path", "vs/base/common/resources", "vs/workbench/browser/part", "vs/workbench/services/title/common/titleService", "vs/base/browser/browser", "vs/platform/windows/common/windows", "vs/platform/contextview/browser/contextView", "vs/base/browser/mouseEvent", "vs/base/common/actions", "vs/platform/configuration/common/configuration", "vs/workbench/services/editor/common/editorService", "vs/base/common/lifecycle", "vs/nls", "vs/workbench/common/editor", "vs/platform/environment/common/environment", "vs/platform/workspace/common/workspace", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/color", "vs/base/common/strings", "vs/base/browser/dom", "vs/workbench/browser/parts/titlebar/menubarControl", "vs/platform/instantiation/common/instantiation", "vs/base/common/labels", "vs/platform/label/common/label", "vs/base/common/event", "vs/platform/storage/common/storage", "vs/workbench/services/layout/browser/layoutService", "vs/base/common/async", "vs/platform/instantiation/common/extensions", "vs/css!./media/titlebarpart"], function (require, exports, path_1, resources, part_1, titleService_1, browser_1, windows_1, contextView_1, mouseEvent_1, actions_1, configuration_1, editorService_1, lifecycle_1, nls, editor_1, environment_1, workspace_1, themeService_1, theme_1, platform_1, uri_1, color_1, strings_1, dom_1, menubarControl_1, instantiation_1, labels_1, label_1, event_1, storage_1, layoutService_1, async_1, extensions_1) {
    ...
    let TitlebarPart = class TitlebarPart extends part_1.Part {
        ...
        get minimumHeight() { return platform_1.isMacintosh ? 22 / browser_1.getZoomFactor() : (30 / (this.configurationService.getValue('window.menuBarVisibility') === 'hidden' ? browser_1.getZoomFactor() : 1)); }
        get maximumHeight() { return platform_1.isMacintosh ? 22 / browser_1.getZoomFactor() : (30 / (this.configurationService.getValue('window.menuBarVisibility') === 'hidden' ? browser_1.getZoomFactor() : 1)); }
        get onMenubarVisibilityChange() { return this._onMenubarVisibilityChange.event; }
        registerListeners() {
        ...
        updateRepresentedFilename() {
            const file = editor_1.toResource(this.editorService.activeEditor || null, { supportSideBySide: true, filter: 'file' });
        ...
        doUpdateTitle() {
            ...
            if ((platform_1.isWindows || platform_1.isLinux) && this.title) {
        ...
        doGetWindowTitle() {
            ...
            const folder = this.contextService.getWorkbenchState() === 2 /* FOLDER */ ? workspace.folders[0] : this.contextService.getWorkspaceFolder(editor_1.toResource(editor || null, { supportSideBySide: true }));
            // Variables
        ...
        updateLayout(dimension) {
            ...
            if (windows_1.getTitleBarStyle(this.configurationService, this.environmentService) === 'custom') {
                ...
                if (platform_1.isMacintosh || this.configurationService.getValue('window.menuBarVisibility') === 'hidden') {
