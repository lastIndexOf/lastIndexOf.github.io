...
define(["require", "exports", "vs/workbench/common/editor/editorGroup", "vs/workbench/common/editor", "vs/base/common/event", "vs/platform/instantiation/common/instantiation", "vs/base/browser/dom", "vs/platform/instantiation/common/serviceCollection", "vs/platform/contextkey/common/contextkey", "vs/base/browser/ui/progressbar/progressbar", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/workbench/browser/parts/editor/tabsTitleControl", "vs/workbench/browser/parts/editor/editorControl", "vs/platform/progress/common/progress", "vs/workbench/services/progress/browser/progressService", "vs/nls", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/platform/notification/common/notification", "vs/base/common/errorMessage", "vs/platform/telemetry/common/telemetry", "vs/base/common/async", "vs/base/browser/touch", "vs/workbench/browser/parts/editor/editor", "vs/workbench/services/untitled/common/untitledEditorService", "vs/base/browser/ui/actionbar/actionbar", "vs/platform/keybinding/common/keybinding", "vs/base/common/actions", "vs/workbench/browser/parts/editor/editorCommands", "vs/workbench/browser/parts/editor/noTabsTitleControl", "vs/platform/actions/common/actions", "vs/base/browser/mouseEvent", "vs/platform/actions/browser/menuItemActionItem", "vs/platform/contextview/browser/contextView", "vs/base/common/errorsWithActions", "vs/base/common/types", "vs/workbench/services/hash/common/hashService", "vs/base/common/mime", "vs/base/common/path", "vs/css!./media/editorgroupview"], function (require, exports, editorGroup_1, editor_1, event_1, instantiation_1, dom_1, serviceCollection_1, contextkey_1, progressbar_1, styler_1, themeService_1, colorRegistry_1, theme_1, tabsTitleControl_1, editorControl_1, progress_1, progressService_1, nls_1, errors_1, lifecycle_1, notification_1, errorMessage_1, telemetry_1, async_1, touch_1, editor_2, untitledEditorService_1, actionbar_1, keybinding_1, actions_1, editorCommands_1, noTabsTitleControl_1, actions_2, mouseEvent_1, menuItemActionItem_1, contextView_1, errorsWithActions_1, types_1, hashService_1, mime_1, path_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let EditorGroupView = class EditorGroupView extends theme_1.Themable {
        constructor(accessor, from, _label, instantiationService, contextKeyService, themeService, notificationService, telemetryService, untitledEditorService, keybindingService, menuService, contextMenuService, hashService) {
            super(themeService);
        ...
        //#region factory
        static createNew(accessor, label, instantiationService) {
            return instantiationService.createInstance(EditorGroupView, accessor, null, label);
        }
        static createFromSerialized(serialized, accessor, label, instantiationService) {
            return instantiationService.createInstance(EditorGroupView, accessor, serialized, label);
        }
        static createCopy(copyFrom, accessor, label, instantiationService) {
        ...
        get onWillDispose() { return this._onWillDispose.event; }
        get onDidGroupChange() { return this._onDidGroupChange.event; }
        get onWillOpenEditor() { return this._onWillOpenEditor.event; }
        get onDidOpenEditorFail() { return this._onDidOpenEditorFail.event; }
        get onWillCloseEditor() { return this._onWillCloseEditor.event; }
        get onDidCloseEditor() { return this._onDidCloseEditor.event; }
        create() {
            // Container
        ...
        handleGroupContextKeys(contextKeyServcie) {
            const groupActiveEditorDirtyContextKey = editor_1.EditorGroupActiveEditorDirtyContext.bindTo(contextKeyServcie);
        ...
        createContainerToolbar() {
            ...
            const containerToolbar = new actionbar_1.ActionBar(toolbarContainer, {
            ...
            // Toolbar actions
            const removeGroupAction = this._register(new actions_1.Action(editorCommands_1.CLOSE_EDITOR_GROUP_COMMAND_ID, nls_1.localize('closeGroupAction', "Close"), 'close-editor-group', true, () => { this.accessor.removeGroup(this); return Promise.resolve(true); }));
