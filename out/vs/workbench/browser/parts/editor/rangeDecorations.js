...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/workbench/services/editor/common/editorService", "vs/editor/common/model/textModel"], function (require, exports, lifecycle_1, event_1, editorService_1, textModel_1) {
    "use strict";
    ...
    let RangeHighlightDecorations = class RangeHighlightDecorations extends lifecycle_1.Disposable {
        ...
        get onHighlghtRemoved() { return this._onHighlightRemoved.event; }
        ...
        setEditor(editor) {
            if (this.editor !== editor) {
                ...
                this.editor = editor;
                this.editorDisposables.push(this.editor.onDidChangeCursorPosition((e) => {
