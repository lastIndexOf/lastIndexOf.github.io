...
define(["require", "exports", "vs/platform/theme/common/themeService", "vs/workbench/browser/part", "vs/base/browser/dom", "vs/base/common/event", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/instantiation/common/instantiation", "vs/base/browser/ui/grid/grid", "vs/base/common/map", "vs/workbench/common/theme", "vs/base/common/arrays", "vs/workbench/browser/parts/editor/editor", "vs/workbench/browser/parts/editor/editorGroupView", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/platform/storage/common/storage", "vs/workbench/common/editor/editorGroup", "vs/workbench/browser/parts/editor/editorDropTarget", "vs/nls", "vs/base/common/color", "vs/base/browser/ui/centered/centeredViewLayout", "vs/base/browser/ui/grid/gridview", "vs/base/common/errors", "vs/workbench/services/layout/browser/layoutService", "vs/platform/instantiation/common/extensions", "vs/workbench/browser/parts/editor/editor.contribution"], function (require, exports, themeService_1, part_1, dom_1, event_1, colorRegistry_1, editorGroupsService_1, instantiation_1, grid_1, map_1, theme_1, arrays_1, editor_1, editorGroupView_1, configuration_1, lifecycle_1, objects_1, storage_1, editorGroup_1, editorDropTarget_1, nls_1, color_1, centeredViewLayout_1, gridview_1, errors_1, layoutService_1, extensions_1) {
    "use strict";
    ...
    let EditorPart = class EditorPart extends part_1.Part {
        constructor(instantiationService, themeService, configurationService, storageService, layoutService) {
            ...
            this._onDidPreferredSizeChange = this._register(new event_1.Emitter());
            ...
            this._partOptions = editor_1.getEditorPartOptions(this.configurationService.getValue());
        ...
        get onDidActiveGroupChange() { return this._onDidActiveGroupChange.event; }
        get onDidActivateGroup() { return this._onDidActivateGroup.event; }
        get onDidAddGroup() { return this._onDidAddGroup.event; }
        get onDidRemoveGroup() { return this._onDidRemoveGroup.event; }
        get onDidMoveGroup() { return this._onDidMoveGroup.event; }
        get onDidSizeConstraintsChange() { return event_1.Event.any(this.onDidSetGridWidget.event, this._onDidSizeConstraintsChange.event); }
        get onDidPreferredSizeChange() { return this._onDidPreferredSizeChange.event; }
        get onDidEditorPartOptionsChange() { return this._onDidEditorPartOptionsChange.event; }
        registerListeners() {
        ...
        handleChangedPartOptions() {
            ...
            const newPartOptions = editor_1.getEditorPartOptions(this.configurationService.getValue());
        ...
        mergeGroup(group, target, options) {
            ...
            sourceView.editors.forEach(editor => {
                ...
                const copyOptions = { index, inactive, preserveFocus: inactive };
        ...
        get minimumWidth() { return this.centeredLayoutWidget.minimumWidth; }
        get maximumWidth() { return this.centeredLayoutWidget.maximumWidth; }
        get minimumHeight() { return this.centeredLayoutWidget.minimumHeight; }
        ...
        updateGroupLabels() {
            ...
            // based on the index.
            this.getGroups(2 /* GRID_APPEARANCE */).forEach((group, index) => {
