...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/comparers", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/filters", "vs/base/common/glob", "vs/base/common/lifecycle", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/uri", "vs/editor/contrib/documentSymbols/outlineModel", "vs/platform/configuration/common/configuration", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/list/browser/listService", "vs/platform/theme/common/colorRegistry", "vs/platform/workspace/common/workspace", "vs/workbench/browser/labels", "vs/workbench/browser/parts/editor/breadcrumbs", "vs/workbench/browser/parts/editor/breadcrumbsModel", "vs/workbench/services/themes/common/workbenchThemeService", "vs/editor/contrib/documentSymbols/outlineTree", "vs/css!./media/breadcrumbscontrol"], function (require, exports, dom, comparers_1, errors_1, event_1, filters_1, glob, lifecycle_1, path_1, resources_1, uri_1, outlineModel_1, configuration_1, files_1, instantiation_1, listService_1, colorRegistry_1, workspace_1, labels_1, breadcrumbs_1, breadcrumbsModel_1, workbenchThemeService_1, outlineTree_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function createBreadcrumbsPicker(instantiationService, parent, element) {
        const ctor = element instanceof breadcrumbsModel_1.FileElement
    ...
    let BreadcrumbsPicker = class BreadcrumbsPicker {
        ...
        show(input, maxHeight, width, arrowSize, arrowOffset) {
            ...
            const filterConfig = breadcrumbs_1.BreadcrumbsConfig.FilterOnType.bindTo(this._configurationService);
            ...
            const cfgFilterOnType = breadcrumbs_1.BreadcrumbsConfig.FilterOnType.bindTo(this._configurationService);
            this._tree.updateOptions({ filterOnType: cfgFilterOnType.getValue() });
            this._disposables.push(this._tree.onDidUpdateOptions(e => {
                this._configurationService.updateValue(cfgFilterOnType.name, e.filterOnType, 5 /* MEMORY */);
            }));
            this._domNode.focus();
    ...
    let BreadcrumbsFilePicker = class BreadcrumbsFilePicker extends BreadcrumbsPicker {
        ...
        _createTree(container) {
            ...
            return this._instantiationService.createInstance(listService_1.WorkbenchAsyncDataTree, container, new FileVirtualDelegate(), [this._instantiationService.createInstance(FileRenderer, labels)], this._instantiationService.createInstance(FileDataSource), {
                filterOnType: true,
        ...
        _getTargetFromEvent(element, _payload) {
            // todo@joh
    ...
    let BreadcrumbsOutlinePicker = class BreadcrumbsOutlinePicker extends BreadcrumbsPicker {
        constructor(parent, instantiationService, themeService, configurationService) {
        ...
        _createTree(container) {
            return this._instantiationService.createInstance(listService_1.WorkbenchDataTree, container, new outlineTree_1.OutlineVirtualDelegate(), [new outlineTree_1.OutlineGroupRenderer(), this._instantiationService.createInstance(outlineTree_1.OutlineElementRenderer)], new outlineTree_1.OutlineDataSource(), {
                filterOnType: true,
                expandOnlyOnTwistieClick: true,
                multipleSelectionSupport: false,
                sorter: new outlineTree_1.OutlineItemComparator(this._getOutlineItemCompareType()),
