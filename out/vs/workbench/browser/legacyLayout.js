...
define(["require", "exports", "vs/base/browser/ui/sash/sash", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/storage/common/storage", "vs/platform/contextview/browser/contextView", "vs/base/common/lifecycle", "vs/platform/theme/common/themeService", "vs/base/common/platform", "vs/base/common/decorators", "vs/base/browser/dom", "vs/workbench/services/editor/common/editorGroupsService"], function (require, exports, sash_1, layoutService_1, viewlet_1, storage_1, contextView_1, lifecycle_1, themeService_1, platform_1, decorators_1, dom_1, editorGroupsService_1) {
    ...
    let WorkbenchLegacyLayout = class WorkbenchLegacyLayout extends lifecycle_1.Disposable {
        ...
        layout(options) {
            ...
            this.titlebarHeight = isTitlebarHidden ? 0 : this.partLayoutInfo.titlebar.height / (platform_1.isMacintosh || !menubarVisibility || menubarVisibility === 'hidden' ? 1 : 1); // adjust for zoom prevention
