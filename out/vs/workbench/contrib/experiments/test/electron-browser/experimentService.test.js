 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/contrib/experiments/node/experimentService", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/platform/environment/common/environment", "vs/workbench/test/workbenchTestServices", "vs/platform/extensionManagement/common/extensionManagement", "vs/platform/extensionManagement/node/extensionManagementService", "vs/base/common/event", "vs/platform/extensionManagement/test/electron-browser/extensionEnablementService.test", "vs/platform/url/common/urlService", "vs/platform/url/common/url", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/configuration/common/configuration", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/lifecycle/common/lifecycle", "vs/base/common/objects", "vs/base/common/uri", "vs/platform/storage/common/storage", "vs/platform/telemetry/node/workbenchCommonProperties", "vs/platform/extensionManagement/common/extensionManagementUtil"], function (require, exports, assert, experimentService_1, instantiationServiceMock_1, environment_1, workbenchTestServices_1, extensionManagement_1, extensionManagementService_1, event_1, extensionEnablementService_test_1, urlService_1, url_1, telemetry_1, telemetryUtils_1, configuration_1, testConfigurationService_1, lifecycle_1, objects_1, uri_1, storage_1, workbenchCommonProperties_1, extensionManagementUtil_1) {
    "use strict";
    ...
    suite('Experiment Service', () => {
        ...
        test('NewUsers experiment shouldnt be enabled for old users', () => {
            ...
            instantiationService.stub(storage_1.IStorageService, {
                get: (a, b, c) => {
                    return a === workbenchCommonProperties_1.lastSessionDateStorageKey ? 'some-date' : undefined;
                },
