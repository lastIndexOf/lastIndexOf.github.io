...
define(["require", "exports", "assert", "vs/base/common/event", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/platform/lifecycle/common/lifecycle", "vs/platform/notification/common/notification", "vs/platform/notification/test/common/testNotificationService", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/workbench/contrib/experiments/electron-browser/experimentalPrompt", "vs/workbench/contrib/experiments/node/experimentService", "vs/workbench/contrib/experiments/test/electron-browser/experimentService.test", "vs/workbench/test/workbenchTestServices"], function (require, exports, assert, event_1, instantiationServiceMock_1, lifecycle_1, notification_1, testNotificationService_1, storage_1, telemetry_1, telemetryUtils_1, experimentalPrompt_1, experimentService_1, experimentService_test_1, workbenchTestServices_1) {
    ...
    suite('Experimental Prompts', () => {
        ...
        test('Test getPromptText', () => {
            ...
            assert.equal(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en'), multipleLocaleCase.promptText['en']);
            assert.equal(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'de'), multipleLocaleCase.promptText['de']);
            assert.equal(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en-au'), multipleLocaleCase.promptText['en-au']);
            assert.equal(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'en-gb'), multipleLocaleCase.promptText['en']);
            assert.equal(experimentalPrompt_1.ExperimentalPrompts.getLocalizedText(multipleLocaleCase.promptText, 'fr'), multipleLocaleCase.promptText['en']);
