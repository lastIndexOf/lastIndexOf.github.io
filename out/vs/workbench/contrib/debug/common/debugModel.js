 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/resources", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/uuid", "vs/base/common/async", "vs/base/common/types", "vs/base/common/arrays", "vs/editor/common/core/range", "vs/base/common/strings", "vs/base/common/path"], function (require, exports, nls, resources, lifecycle, event_1, uuid_1, async_1, types_1, arrays_1, range_1, strings_1, path_1) {
    "use strict";
    ...
    class DebugModel {
        ...
        addSession(session) {
            this.sessions = this.sessions.filter(s => {
                ...
                if (s.state === 0 /* Inactive */ && s.getLabel() === session.getLabel()) {
