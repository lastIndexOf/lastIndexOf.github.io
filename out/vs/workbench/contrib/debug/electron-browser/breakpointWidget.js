...
define(["require", "exports", "vs/nls", "vs/base/browser/ui/selectBox/selectBox", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/editor/common/core/position", "vs/editor/contrib/zoneWidget/zoneWidget", "vs/platform/contextview/browser/contextView", "vs/workbench/contrib/debug/common/debug", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/editor/common/services/modelService", "vs/base/common/uri", "vs/editor/common/modes", "vs/editor/contrib/suggest/suggest", "vs/editor/browser/services/codeEditorService", "vs/platform/theme/common/colorRegistry", "vs/platform/instantiation/common/serviceCollection", "vs/editor/browser/widget/codeEditorWidget", "vs/workbench/contrib/codeEditor/browser/simpleEditorOptions", "vs/editor/common/core/range", "vs/css!../browser/media/breakpointWidget"], function (require, exports, nls, selectBox_1, lifecycle, dom, position_1, zoneWidget_1, contextView_1, debug_1, styler_1, themeService_1, instantiation_1, contextkey_1, editorExtensions_1, editorContextKeys_1, modelService_1, uri_1, modes_1, suggest_1, codeEditorService_1, colorRegistry_1, serviceCollection_1, codeEditorWidget_1, simpleEditorOptions_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const $ = dom.$;
    const IPrivateBreakpointWidgetService = instantiation_1.createDecorator('privateBreakopintWidgetService');
    const DECORATION_KEY = 'breakpointwidgetdecoration';
    let BreakpointWidget = class BreakpointWidget extends zoneWidget_1.ZoneWidget {
        constructor(editor, lineNumber, context, contextViewService, debugService, themeService, contextKeyService, instantiationService, modelService, codeEditorService) {
        ...
        createBreakpointInput(container) {
            ...
            this.toDispose.push(modes_1.CompletionProviderRegistry.register({ scheme: debug_1.DEBUG_SCHEME, hasAccessToAllModels: true }, {
                provideCompletionItems: (model, position, _context, token) => {
                    ...
                    if (underlyingModel && (this.context === 0 /* CONDITION */ || this.context === 2 /* LOG_MESSAGE */ && this.isCurlyBracketOpen())) {
                        suggestionsPromise = suggest_1.provideSuggestionItems(underlyingModel, new position_1.Position(this.lineNumber, 1), new suggest_1.CompletionOptions(undefined, new Set().add(25 /* Snippet */)), _context, token).then(suggestions => {
    ...
    class CloseBreakpointWidgetCommand extends editorExtensions_1.EditorCommand {
        ...
        runEditorCommand(accessor, editor, args) {
            const debugContribution = editor.getContribution(debug_1.EDITOR_CONTRIBUTION_ID);
