 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/keyCodes", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/browser/editorExtensions", "vs/platform/contextkey/common/contextkey", "vs/workbench/contrib/debug/common/debug", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/debug/browser/breakpointsView", "vs/workbench/common/panel", "vs/platform/actions/common/actions"], function (require, exports, nls, keyCodes_1, range_1, editorContextKeys_1, editorExtensions_1, contextkey_1, debug_1, panelService_1, viewlet_1, editorService_1, breakpointsView_1, panel_1, actions_1) {
    "use strict";
    ...
    class SelectionToReplAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            return session.addReplExpression(viewModel.focusedStackFrame, text)
                .then(() => panelService.openPanel(debug_1.REPL_ID, true))
                .then(_ => undefined);
        }
    }
