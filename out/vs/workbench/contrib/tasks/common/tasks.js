 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/types", "vs/base/common/objects", "vs/platform/contextkey/common/contextkey"], function (require, exports, Types, Objects, contextkey_1) {
    "use strict";
    ...
    (function (TaskRunSource) {
        TaskRunSource[TaskRunSource["User"] = 0] = "User";
        TaskRunSource[TaskRunSource["FolderOpen"] = 1] = "FolderOpen";
        TaskRunSource[TaskRunSource["ConfigurationChange"] = 2] = "ConfigurationChange";
