 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/uuid", "vs/workbench/contrib/tasks/common/problemMatcher", "../common/tasks", "../common/taskDefinitionRegistry", "vs/workbench/contrib/tasks/node/tasks"], function (require, exports, nls, Objects, Types, UUID, problemMatcher_1, Tasks, taskDefinitionRegistry_1, tasks_1) {
    "use strict";
    ...
    (function (TaskDependency) {
        function from(external, context) {
            if (Types.isString(external)) {
                ...
                return { workspaceFolder: context.workspaceFolder, task: tasks_1.TaskDefinition.createTaskIdentifier(external, context.problemReporter) };
            }
            else {
                return undefined;
            }
    ...
    (function (ConfiguringTask) {
        ...
        function from(external, context, index) {
            ...
            let taskIdentifier = tasks_1.TaskDefinition.createTaskIdentifier(identifier, context.problemReporter);
