...
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/path", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/contrib/files/common/explorerModel", "vs/base/test/common/utils"], function (require, exports, assert, platform_1, uri_1, path_1, fileActions_1, explorerModel_1, utils_1) {
    ...
    suite('Files - View Model', function () {
        ...
        test('Merge Local with Disk', function () {
            ...
            const merge1 = new explorerModel_1.ExplorerItem(uri_1.URI.file(path_1.join('C:\\', '/path/to')), undefined, true, false, false, 'to', Date.now(), d);
            const merge2 = new explorerModel_1.ExplorerItem(uri_1.URI.file(path_1.join('C:\\', '/path/to')), undefined, true, false, false, 'to', Date.now(), new Date(0).toUTCString());
            // Merge Properties
            ...
            merge2.addChild(new explorerModel_1.ExplorerItem(uri_1.URI.file(path_1.join('C:\\', '/path/to/foo.html')), undefined, true, false, false, 'foo.html', Date.now(), d));
            explorerModel_1.ExplorerItem.mergeLocalWithDisk(merge2, merge1);
            // Merge Child with isDirectoryResolved=true
            const child = new explorerModel_1.ExplorerItem(uri_1.URI.file(path_1.join('C:\\', '/path/to/foo.html')), undefined, true, false, false, 'foo.html', Date.now(), d);
