        ...
        createEditor(parent) {
            ...
            this._list.onContextMenu((e) => {
                ...
                if (e.element.marketplaceInfo) {
                    actions.push(new actions_1.Action('runtimeExtensionsEditor.action.disableWorkspace', nls.localize('disable workspace', "Disable (Workspace)"), undefined, true, () => this._extensionsWorkbenchService.setEnablement(e.element.marketplaceInfo, 1 /* WorkspaceDisabled */)));
                    actions.push(new actions_1.Action('runtimeExtensionsEditor.action.disable', nls.localize('disable', "Disable"), undefined, true, () => this._extensionsWorkbenchService.setEnablement(e.element.marketplaceInfo, 0 /* Disabled */)));
                    actions.push(new actionbar_1.Separator());
                }
                const state = this._extensionHostProfileService.state;
