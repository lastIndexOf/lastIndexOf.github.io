...
define(["require", "exports", "sinon", "assert", "vs/base/common/path", "fs", "os", "vs/base/common/uuid", "vs/base/node/pfs", "vs/platform/extensionManagement/common/extensionManagement", "vs/workbench/contrib/extensions/electron-browser/extensionTipsService", "vs/platform/extensionManagement/node/extensionGalleryService", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/base/common/event", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/workspace/common/workspace", "vs/workbench/test/workbenchTestServices", "vs/platform/notification/test/common/testNotificationService", "vs/platform/configuration/common/configuration", "vs/base/common/uri", "vs/platform/workspace/test/common/testWorkspace", "vs/platform/files/common/files", "vs/workbench/services/files/node/fileService", "vs/base/node/extfs", "vs/platform/configuration/test/common/testConfigurationService", "vs/base/common/objects", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/environment/common/environment", "vs/workbench/contrib/extensions/common/extensions", "vs/platform/extensionManagement/node/extensionManagementService", "vs/platform/extensionManagement/test/electron-browser/extensionEnablementService.test", "vs/platform/url/common/url", "vs/platform/product/node/product", "vs/editor/common/services/modelService", "vs/platform/lifecycle/common/lifecycle", "vs/platform/notification/common/notification", "vs/platform/url/common/urlService", "vs/workbench/contrib/experiments/node/experimentService", "vs/workbench/contrib/experiments/test/electron-browser/experimentService.test", "vs/platform/storage/common/storage", "vs/platform/ipc/electron-browser/sharedProcessService"], function (require, exports, sinon, assert, path, fs, os, uuid, pfs_1, extensionManagement_1, extensionTipsService_1, extensionGalleryService_1, instantiationServiceMock_1, event_1, telemetry_1, telemetryUtils_1, workspace_1, workbenchTestServices_1, testNotificationService_1, configuration_1, uri_1, testWorkspace_1, files_1, fileService_1, extfs, testConfigurationService_1, objects_1, extensionManagementUtil_1, environment_1, extensions_1, extensionManagementService_1, extensionEnablementService_test_1, url_1, product_1, modelService_1, lifecycle_1, notification_1, urlService_1, experimentService_1, experimentService_test_1, storage_1, sharedProcessService_1) {
    "use strict";
    ...
    suite('ExtensionsTipsService Test', () => {
        ...
        test('ExtensionTipsService: No Prompt for valid workspace recommendations during extension development', () => {
            instantiationService.stub(environment_1.IEnvironmentService, { extensionDevelopmentLocationURI: true });
            return testNoPromptOrRecommendationsForValidRecommendations(mockTestData.validRecommendedExtensions);
        });
