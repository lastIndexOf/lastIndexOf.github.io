...
define(["require", "exports", "vs/base/browser/contextmenu", "vs/base/browser/dom", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/nls", "vs/platform/configuration/common/configuration", "vs/platform/configuration/common/configurationRegistry", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/registry/common/platform", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/workbench/browser/parts/editor/rangeDecorations", "vs/workbench/contrib/preferences/browser/preferencesWidgets", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/common/preferencesModels"], function (require, exports, contextmenu_1, dom_1, async_1, event_1, lifecycle_1, position_1, range_1, textModel_1, nls, configuration_1, configurationRegistry_1, contextView_1, instantiation_1, platform_1, telemetry_1, workspace_1, rangeDecorations_1, preferencesWidgets_1, preferences_1, preferencesModels_1) {
    "use strict";
    ...
    let UserSettingsRenderer = class UserSettingsRenderer extends lifecycle_1.Disposable {
        constructor(editor, preferencesModel, preferencesService, configurationService, instantiationService) {
            ...
            this._onFocusPreference = new event_1.Emitter();
            this.onFocusPreference = this._onFocusPreference.event;
            this._onClearFocusPreference = new event_1.Emitter();
            this.onClearFocusPreference = this._onClearFocusPreference.event;
            this._onUpdatePreference = new event_1.Emitter();
    ...
    let SettingsGroupTitleRenderer = class SettingsGroupTitleRenderer extends lifecycle_1.Disposable {
        constructor(editor, instantiationService) {
            ...
            this.editor = editor;
            this.instantiationService = instantiationService;
            this._onHiddenAreasChanged = new event_1.Emitter();
            this.hiddenGroups = [];
            this.disposables = [];
        }
        get onHiddenAreasChanged() { return this._onHiddenAreasChanged.event; }
        get hiddenAreas() {
            const hiddenAreas = [];
    ...
    class FilteredMatchesRenderer extends lifecycle_1.Disposable {
        ...
        createDecoration(range, model) {
            return {
                range,
                options: FilteredMatchesRenderer._FIND_MATCH
            };
        }
        computeHiddenRanges(filteredGroups, allSettingsGroups, model) {
    ...
    let EditSettingRenderer = class EditSettingRenderer extends lifecycle_1.Disposable {
        constructor(editor, masterSettingsModel, settingHighlighter, instantiationService, contextMenuService) {
            super();
            this.editor = editor;
            ...
            return this.getSettingsAtLineNumber(lineNumber).filter(setting => {
                ...
                if (configurationNode) {
                    ...
                    if (configurationNode.type === 'boolean' || configurationNode.enum) {
                        if (this.masterSettingsModel.configurationTarget !== 3 /* WORKSPACE_FOLDER */) {
                            return true;
                        }
                                ...
                                if (!this.isDefaultSettings() && setting.overrides.length) {
                                    ...
                                    for (const overrideSetting of setting.overrides) {
                                        if (lineNumber >= overrideSetting.range.startLineNumber && lineNumber <= overrideSetting.range.endLineNumber) {
                                            settings.push(Object.assign({}, overrideSetting, { index, groupId: group.id }));
                                        }
                                    }
                                }
                                else {
                                    settings.push(Object.assign({}, setting, { index, groupId: group.id }));
                                }
                            }
                            index++;
                        }
    ...
    let WorkspaceConfigurationRenderer = class WorkspaceConfigurationRenderer extends lifecycle_1.Disposable {
        constructor(editor, workspaceSettingsEditorModel, workspaceContextService) {
            super();
            this.editor = editor;
