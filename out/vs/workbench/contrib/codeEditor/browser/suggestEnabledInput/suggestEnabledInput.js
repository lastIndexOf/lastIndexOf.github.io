...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/widget", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/base/common/platform", "vs/base/common/uri", "vs/editor/browser/widget/codeEditorWidget", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/editor/common/services/modelService", "vs/editor/contrib/contextmenu/contextmenu", "vs/editor/contrib/snippet/snippetController2", "vs/editor/contrib/suggest/suggestController", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/workbench/contrib/codeEditor/browser/menuPreventer", "vs/workbench/contrib/codeEditor/browser/simpleEditorOptions", "vs/workbench/contrib/codeEditor/browser/selectionClipboard", "vs/css!./suggestEnabledInput"], function (require, exports, dom_1, widget_1, event_1, lifecycle_1, objects_1, platform_1, uri_1, codeEditorWidget_1, editOperation_1, position_1, range_1, modes, modelService_1, contextmenu_1, snippetController2_1, suggestController_1, instantiation_1, colorRegistry_1, styler_1, themeService_1, menuPreventer_1, simpleEditorOptions_1, selectionClipboard_1) {
    "use strict";
    ...
    let SuggestEnabledInput = class SuggestEnabledInput extends widget_1.Widget {
        constructor(id, parent, suggestionProvider, ariaLabel, resourceHandle, options, instantiationService, modelService) {
            ...
            onKeyDownMonaco.filter(e => e.keyCode === 3 /* Enter */).on(e => { e.preventDefault(); this._onEnter.fire(); }, this, this.disposables);
            onKeyDownMonaco.filter(e => e.keyCode === 18 /* DownArrow */ && (platform_1.isMacintosh ? e.metaKey : e.ctrlKey)).on(() => this._onShouldFocusResults.fire(), this, this.disposables);
        ...
        setValue(val) {
            val = val.replace(/\s/g, ' ');
            const fullRange = new range_1.Range(1, 1, 1, this.getValue().length + 1);
