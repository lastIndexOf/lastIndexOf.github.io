...
define(["require", "exports", "vs/nls", "vs/base/common/json", "vs/base/common/types", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/services/modeService", "vs/platform/files/common/files", "vs/platform/jsonschemas/common/jsonContributionRegistry", "vs/platform/registry/common/platform", "vs/workbench/services/extensions/common/extensions", "vs/workbench/services/textMate/common/textMateService"], function (require, exports, nls, json_1, types, languageConfigurationRegistry_1, modeService_1, files_1, jsonContributionRegistry_1, platform_1, extensions_1, textMateService_1) {
    "use strict";
    ...
    let LanguageConfigurationFileHandler = class LanguageConfigurationFileHandler {
        constructor(textMateService, _modeService, _fileService, _extensionService) {
        ...
        _handleConfigFile(languageIdentifier, configFileLocation) {
            this._fileService.resolveContent(configFileLocation, { encoding: 'utf8' }).then((contents) => {
                const errors = [];
                const configuration = json_1.parse(contents.value.toString(), errors);
                if (errors.length) {
