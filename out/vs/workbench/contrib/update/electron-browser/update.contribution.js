...
define(["require", "exports", "vs/base/common/platform", "vs/platform/registry/common/platform", "vs/workbench/common/contributions", "vs/workbench/common/activity", "vs/workbench/common/actions", "vs/platform/actions/common/actions", "./update", "vs/css!./media/update.contribution", "vs/platform/update/node/update.config.contribution"], function (require, exports, platform, platform_1, contributions_1, activity_1, actions_1, actions_2, update_1) {
    ...
    if (platform.isLinux) {
        if (process.arch === 'ia32') {
            workbench.registerWorkbenchContribution(update_1.Linux32BitContribution, 3 /* Restored */);
        }
    }
