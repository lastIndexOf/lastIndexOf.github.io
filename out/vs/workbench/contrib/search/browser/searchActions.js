...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/keyCodes", "vs/base/common/labels", "vs/base/common/network", "vs/base/common/path", "vs/base/common/platform", "vs/base/common/strings", "vs/nls", "vs/platform/clipboard/common/clipboardService", "vs/platform/configuration/common/configuration", "vs/platform/keybinding/common/keybinding", "vs/platform/list/browser/listService", "vs/workbench/contrib/search/common/constants", "vs/workbench/contrib/search/common/replace", "vs/workbench/contrib/search/common/searchModel", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/panel/common/panelService", "vs/workbench/services/search/common/search", "vs/workbench/contrib/search/common/searchHistoryService", "vs/workbench/services/viewlet/browser/viewlet"], function (require, exports, DOM, actions_1, keyCodes_1, labels_1, network_1, path_1, platform_1, strings_1, nls, clipboardService_1, configuration_1, keybinding_1, listService_1, Constants, replace_1, searchModel_1, editorGroupsService_1, editorService_1, panelService_1, search_1, searchHistoryService_1, viewlet_1) {
    ...
    function openSearchView(viewletService, panelService, focus) {
        if (viewletService.getViewlets().filter(v => v.id === search_1.VIEWLET_ID).length) {
    ...
    class FindOrReplaceInFilesAction extends actions_1.Action {
        constructor(id, label, viewletService, panelService, expandSearchReplaceWidget) {
            super(id, label);
            this.viewletService = viewletService;
            this.panelService = panelService;
    ...
    let FindInFilesAction = class FindInFilesAction extends FindOrReplaceInFilesAction {
        constructor(id, label, viewletService, panelService) {
    ...
    let OpenSearchViewletAction = class OpenSearchViewletAction extends FindOrReplaceInFilesAction {
        constructor(id, label, viewletService, panelService, editorGroupService) {
            super(id, label, viewletService, panelService, /*expandSearchReplaceWidget=*/ false);
    ...
    exports.copyPathCommand = (accessor, fileMatch) => {
    ...
    exports.copyMatchCommand = (accessor, match) => {
        const clipboardService = accessor.get(clipboardService_1.IClipboardService);
        let text;
    ...
    exports.copyAllCommand = accessor => {
