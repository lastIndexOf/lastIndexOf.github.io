...
define(["require", "exports", "vs/base/common/errors", "vs/nls", "vs/base/common/path", "vs/base/common/objects", "vs/base/common/idGenerator", "vs/base/common/uri", "vs/base/common/resources", "vs/editor/common/services/modeService", "vs/editor/common/services/getIconClasses", "vs/editor/common/services/modelService", "vs/workbench/services/themes/common/workbenchThemeService", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/workbench/browser/quickopen", "vs/workbench/contrib/search/common/queryBuilder", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/search/common/search", "vs/platform/workspace/common/workspace", "vs/platform/environment/common/environment", "vs/workbench/contrib/search/common/search", "vs/workbench/services/editor/common/editorService", "vs/base/parts/quickopen/common/quickOpenScorer", "vs/platform/files/common/files", "vs/platform/label/common/label", "vs/base/common/labels"], function (require, exports, errors, nls, path_1, objects, idGenerator_1, uri_1, resources_1, modeService_1, getIconClasses_1, modelService_1, workbenchThemeService_1, quickOpenModel_1, quickopen_1, queryBuilder_1, configuration_1, instantiation_1, search_1, workspace_1, environment_1, search_2, editorService_1, quickOpenScorer_1, files_1, label_1, labels_1) {
    "use strict";
    ...
    let OpenFileHandler = class OpenFileHandler extends quickopen_1.QuickOpenHandler {
        constructor(editorService, instantiationService, themeService, contextService, searchService, environmentService, fileService, labelService) {
            super();
        ...
        getResults(searchValue, token, maxSortedResults) {
            ...
            query.value = labels_1.untildify(query.value, this.environmentService.userHome);
            // Do find results
        ...
        getAbsolutePathResult(query) {
            if (path_1.isAbsolute(query.original)) {
                const resource = uri_1.URI.file(query.original);
