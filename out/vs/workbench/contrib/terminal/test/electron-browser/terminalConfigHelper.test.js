...
define(["require", "exports", "assert", "vs/workbench/contrib/terminal/browser/terminalConfigHelper", "vs/editor/common/config/editorOptions", "vs/platform/configuration/test/common/testConfigurationService", "vs/workbench/contrib/terminal/common/terminal"], function (require, exports, assert, terminalConfigHelper_1, editorOptions_1, testConfigurationService_1, terminal_1) {
    ...
    suite('Workbench - TerminalConfigHelper', () => {
        ...
        test('TerminalConfigHelper - getFont fontFamily', function () {
            ...
            let configHelper = new terminalConfigHelper_1.TerminalConfigHelper(terminal_1.LinuxDistro.Unknown, configurationService, null, null, null);
            ...
            configHelper = new terminalConfigHelper_1.TerminalConfigHelper(terminal_1.LinuxDistro.Fedora, configurationService, null, null, null);
            configHelper.panelContainer = fixture;
            ...
            configHelper = new terminalConfigHelper_1.TerminalConfigHelper(terminal_1.LinuxDistro.Ubuntu, configurationService, null, null, null);
            configHelper.panelContainer = fixture;
            ...
            configHelper = new terminalConfigHelper_1.TerminalConfigHelper(terminal_1.LinuxDistro.Unknown, configurationService, null, null, null);
            configHelper.panelContainer = fixture;
