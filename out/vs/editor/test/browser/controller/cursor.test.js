 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/controller/cursor", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/editor/common/editorCommon", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/common/modes/languageConfiguration", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/modes/nullMode", "vs/editor/common/viewModel/viewModelImpl", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/editorTestUtils", "vs/editor/test/common/mocks/mockMode", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/test/common/modes/supports/javascriptOnEnterRules"], function (require, exports, assert, coreCommands_1, cursor_1, editOperation_1, position_1, range_1, selection_1, token_1, editorCommon_1, textModel_1, modes_1, languageConfiguration_1, languageConfigurationRegistry_1, nullMode_1, viewModelImpl_1, testCodeEditor_1, editorTestUtils_1, mockMode_1, testConfiguration_1, javascriptOnEnterRules_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const H = editorCommon_1.Handler;
    // --------- utils
    ...
    function moveLeft(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveRight(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveDown(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveUp(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveToBeginningOfLine(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveToBeginningOfBuffer(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    function moveToEndOfBuffer(cursor, inSelectionMode = false) {
        if (inSelectionMode) {
    ...
    suite('Editor Controller - Cursor', () => {
        ...
        setup(() => {
            let text = LINE1 + '\r\n' +
                ...
                LINE4 + '\r\n' +
                LINE5;
            thisModel = editorTestUtils_1.createTextModel(text);
        ...
        test('issue #4905 - column select is biased to the right', () => {
            const model = editorTestUtils_1.createTextModel([
    ...
    suite('Editor Controller - Regression tests', () => {
        ...
        test('Bug 9121: Auto indent + undo + redo is funky', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                assert.equal(model.getValue(1 /* LF */), '\nx', 'assert8');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'x', 'assert9');
                ...
                assert.equal(model.getValue(1 /* LF */), '\nx', 'assert14');
                cursorCommand(cursor, H.Redo, {});
                assert.equal(model.getValue(1 /* LF */), 'x', 'assert15');
            });
            model.dispose();
        });
        ...
        test('issue #47733: Undo mangles unicode characters', () => {
            ...
            const model = editorTestUtils_1.createTextModel('\'👁\'', undefined, languageId);
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                editor.setSelection(new selection_1.Selection(1, 1, 1, 2));
                cursorCommand(cursor, H.Type, { text: '%' }, 'keyboard');
                assert.equal(model.getValue(1 /* LF */), '%\'%👁\'', 'assert1');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(1 /* LF */), '\'👁\'', 'assert2');
            });
            model.dispose();
            mode.dispose();
        });
        test('issue #46208: Allow empty selections in the undo/redo stack', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                assertCursor(cursor, new position_1.Position(1, 13));
                moveLeft(cursor);
                moveRight(cursor);
                model.pushEditOperations([], [editOperation_1.EditOperation.replaceMove(new range_1.Range(1, 12, 1, 13), '')], () => []);
                assert.equal(model.getLineContent(1), 'Hello world');
                assertCursor(cursor, new position_1.Position(1, 12));
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getLineContent(1), 'Hello world ');
                assertCursor(cursor, new position_1.Position(1, 13));
                cursorCommand(cursor, H.Undo, {});
                ...
                assertCursor(cursor, new position_1.Position(1, 6));
                cursorCommand(cursor, H.Undo, {});
        ...
        test('issue #46440: (1) Pasting a multi-line selection pastes entire selection into every insertion point', () => {
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 1, 1, 1), new selection_1.Selection(2, 1, 2, 1), new selection_1.Selection(3, 1, 3, 1)]);
                cursorCommand(cursor, H.Paste, {
                    text: 'a\nb\nc',
                    pasteOnNewLine: false,
                    multicursorText: null
        ...
        test('issue #12887: Double-click highlighting separating white space', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                coreCommands_1.CoreNavigationCommands.WordSelect.runCoreEditorCommand(cursor, { position: new position_1.Position(1, 5) });
                assert.deepEqual(cursor.getSelection(), new selection_1.Selection(1, 5, 1, 8));
            });
            model.dispose();
        });
        ...
        test('issue #22717: Moving text cursor cause an incorrect position in Chinese', () => {
            ...
            testCodeEditor_1.withTestCodeEditor([
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 5, 1, 5)]);
                moveDown(cursor);
                assertCursor(cursor, new selection_1.Selection(2, 9, 2, 9));
                moveRight(cursor);
                assertCursor(cursor, new selection_1.Selection(2, 10, 2, 10));
                moveRight(cursor);
        ...
        test('issue #44805: Should not be able to undo in readonly editor', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { readOnly: true, model: model }, (editor, cursor) => {
                ...
                assert.equal(model.getValue(1 /* LF */), 'Hello world!');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(1 /* LF */), 'Hello world!');
            });
            model.dispose();
        ...
        test('issue #46314: ViewModel is out of sync with Model!', () => {
            ...
            let model = editorTestUtils_1.createTextModel('Just text', undefined, new modes_1.LanguageIdentifier(LANGUAGE_ID, 0));
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor1, cursor1) => {
                testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor2, cursor2) => {
        ...
        test('issue #37967: problem replacing consecutive characters', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { multiCursorMergeOverlapping: false, model: model }, (editor, cursor) => {
    ...
    suite('Editor Controller - Cursor Configuration', () => {
        ...
        test('Enter auto-indents with insertSpaces setting 1', () => {
            ...
            usingCursor({
                ...
                assertCursor(cursor, new selection_1.Selection(1, 7, 1, 7));
                cursorCommand(cursor, H.Type, { text: '\n' }, 'keyboard');
                assert.equal(model.getValue(2 /* CRLF */), '\thello\r\n        ');
            });
            mode.dispose();
        });
        ...
        test('Enter auto-indents with insertSpaces setting 3', () => {
            ...
            usingCursor({
                ...
                assertCursor(cursor, new selection_1.Selection(1, 7, 1, 7));
                cursorCommand(cursor, H.Type, { text: '\n' }, 'keyboard');
                assert.equal(model.getValue(2 /* CRLF */), '\thell(\r\n        \r\n    )');
            });
            mode.dispose();
        });
        ...
        test('issue #15118: remove auto whitespace when pasting entire line', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                assertCursor(cursor, new position_1.Position(4, model.getLineMaxColumn(4)));
                ...
                assertCursor(cursor, new position_1.Position(5, 1));
            });
            model.dispose();
        });
        test('UseTabStops is off', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, useTabStops: false }, (editor, cursor) => {
        ...
        test('Backspace removes whitespaces with tab size', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, useTabStops: true }, (editor, cursor) => {
                ...
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'x\n        a   ');
        ...
        test('PR #5423: Auto indent + undo + redo is funky', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                assert.equal(model.getValue(1 /* LF */), '\nx', 'assert9');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(1 /* LF */), 'x', 'assert10');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(1 /* LF */), '\nx', 'assert11');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(1 /* LF */), '\n\ty\nx', 'assert12');
                ...
                assert.equal(model.getValue(1 /* LF */), '\nx', 'assert15');
                cursorCommand(cursor, H.Redo, {});
                assert.equal(model.getValue(1 /* LF */), 'x', 'assert16');
            });
            model.dispose();
        });
    });
    suite('Editor Controller - Indentation Rules', () => {
        ...
        test('Enter honors indentNextLinePattern 2', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, autoIndent: true }, (editor, cursor) => {
        ...
        test('issue #36090: JS: editor.autoIndent seems to be broken', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model, autoIndent: false }, (editor, cursor) => {
    ...
    function usingCursor(opts, callback) {
        let model = editorTestUtils_1.createTextModel(opts.text.join('\n'), opts.modelOpts, opts.languageIdentifier);
        model.forceTokenization(model.getLineCount());
        let config = new testConfiguration_1.TestConfiguration(opts.editorOpts || {});
        let viewModel = new viewModelImpl_1.ViewModel(0, config, model, null);
        let cursor = new cursor_1.Cursor(config, model, viewModel);
    ...
    suite('autoClosingPairs', () => {
        ...
        test('issue #26820: auto close quotes when not used as accents', () => {
            ...
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 2, 1, 2)]);
                cursorCommand(cursor, H.CompositionStart, null, 'keyboard');
                cursorCommand(cursor, H.Type, { text: '"' }, 'keyboard');
                cursorCommand(cursor, H.ReplacePreviousChar, { replaceCharCnt: 1, text: '"' }, 'keyboard');
                cursorCommand(cursor, H.CompositionEnd, null, 'keyboard');
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 10, 1, 10)]);
                cursorCommand(cursor, H.CompositionStart, null, 'keyboard');
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.ReplacePreviousChar, { replaceCharCnt: 1, text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.CompositionEnd, null, 'keyboard');
                ...
                model.setValue('abc');
                cursor.setSelections('test', [new selection_1.Selection(1, 1, 1, 1)]);
                cursorCommand(cursor, H.CompositionStart, null, 'keyboard');
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.ReplacePreviousChar, { replaceCharCnt: 1, text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.CompositionEnd, null, 'keyboard');
                ...
                model.setValue('abc');
                cursor.setSelections('test', [new selection_1.Selection(1, 4, 1, 4)]);
                cursorCommand(cursor, H.CompositionStart, null, 'keyboard');
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.ReplacePreviousChar, { replaceCharCnt: 1, text: '\'' }, 'keyboard');
                cursorCommand(cursor, H.CompositionEnd, null, 'keyboard');
        ...
        test('issue #41825: Special handling of quotes in surrounding pairs', () => {
            ...
            const mode = new MyMode();
            const model = editorTestUtils_1.createTextModel('var x = \'hi\';', undefined, languageId);
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                editor.setSelections([
                ...
                cursorCommand(cursor, H.Type, { text: '"' }, 'keyboard');
                assert.equal(model.getValue(1 /* LF */), 'var x = "hi";', 'assert1');
                editor.setSelections([
                    new selection_1.Selection(1, 9, 1, 10),
                    new selection_1.Selection(1, 12, 1, 13)
                ]);
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
                assert.equal(model.getValue(1 /* LF */), 'var x = \'hi\';', 'assert2');
            });
            model.dispose();
            mode.dispose();
        });
