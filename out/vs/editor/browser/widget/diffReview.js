 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/editor/browser/config/configuration", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/lineTokens", "vs/editor/common/core/position", "vs/editor/common/view/editorColorRegistry", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/common/viewModel/viewModel", "vs/platform/contextkey/common/contextkey", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/css!./media/diffReview"], function (require, exports, nls, dom, fastDomNode_1, actionbar_1, scrollableElement_1, actions_1, lifecycle_1, configuration_1, editorExtensions_1, codeEditorService_1, lineTokens_1, position_1, editorColorRegistry_1, viewLineRenderer_1, viewModel_1, contextkey_1, colorRegistry_1, themeService_1) {
    "use strict";
    ...
    class DiffReview extends lifecycle_1.Disposable {
        constructor(diffEditor) {
            ...
            this._actionBar.push(new actions_1.Action('diffreview.close', nls.localize('label.close', "Close"), 'close-diff-review', true, () => {
                this.hide();
        ...
        static _renderSection(dest, diffEntry, modLine, width, originalOpts, originalModel, originalModelOpts, modifiedOpts, modifiedModel, modifiedModelOpts) {
            const type = diffEntry.getType();
            let rowClassName = 'diff-review-row';
            let lineNumbersExtraClassName = '';
            let spacerClassName = 'diff-review-spacer';
            switch (type) {
                case 1 /* Insert */:
        ...
        static _renderLine(model, config, tabSize, lineNumber) {
