...
define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/snippetController2", "vs/editor/test/browser/testCodeEditor", "vs/editor/common/model/textModel", "vs/platform/keybinding/test/common/mockKeybindingService", "vs/platform/log/common/log", "vs/editor/common/editorCommon", "vs/base/common/async"], function (require, exports, assert, selection_1, snippetController2_1, testCodeEditor_1, textModel_1, mockKeybindingService_1, log_1, editorCommon_1, async_1) {
    ...
    suite('SnippetController2', function () {
        ...
        let model;
        let contextKeys;
        let logService = new log_1.NullLogService();
        setup(function () {
        ...
        test('Must tab through deleted tab stops in snippets #31619', function () {
            ...
            editor.trigger('test', editorCommon_1.Handler.Cut, null);
        ...
        test('A little confusing visual effect of highlighting for snippet tabstop #43270', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const ctrl = new snippetController2_1.SnippetController2(editor, logService, contextKeys);
                model.setValue('');
                editor.setSelection(new selection_1.Selection(1, 1, 1, 1));
                ctrl.insert('background-color: ${1:fff};$0');
                assertSelections(editor, new selection_1.Selection(1, 19, 1, 22));
                editor.setSelection(new selection_1.Selection(1, 22, 1, 22));
                assertContextKeys(contextKeys, true, false, true);
                editor.trigger('', 'deleteRight', null);
                assert.equal(model.getValue(), 'background-color: fff');
                yield async_1.timeout(0); // this depends on re-scheduling of events...
                assertContextKeys(contextKeys, false, false, false);
            });
        });
    });
