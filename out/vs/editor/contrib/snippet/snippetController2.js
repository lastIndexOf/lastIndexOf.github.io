...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorContextKeys", "vs/editor/contrib/suggest/suggest", "vs/platform/contextkey/common/contextkey", "vs/platform/log/common/log", "./snippetSession", "vs/editor/browser/core/editorState"], function (require, exports, lifecycle_1, strings_1, editorExtensions_1, range_1, selection_1, editorContextKeys_1, suggest_1, contextkey_1, log_1, snippetSession_1, editorState_1) {
    "use strict";
        ...
        _doInsert(template, overwriteBefore = 0, overwriteAfter = 0, undoStopBefore = true, undoStopAfter = true, adjustWhitespace = true) {
            ...
            let dedupedUpdateState = () => {
                if (!state || !state.validate(this._editor)) {
                    this._updateState();
                    state = new editorState_1.EditorState(this._editor, 2 /* Selection */ | 1 /* Value */);
                }
            };
            this._snippetListener = [
