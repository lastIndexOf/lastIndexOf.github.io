define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/editor/common/modes", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/modes/nullMode", "vs/editor/contrib/comment/lineCommentCommand", "vs/editor/test/browser/testCommand", "vs/editor/test/common/commentMode", "vs/editor/test/common/mocks/mockMode"], function (require, exports, assert, selection_1, token_1, modes, languageConfigurationRegistry_1, nullMode_1, lineCommentCommand_1, testCommand_1, commentMode_1, mockMode_1) {
    "use strict";
    ...
    suite('Editor Contrib - Line Comment Command', () => {
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            let mode = new commentMode_1.CommentMode({ lineComment: '!@#', blockComment: ['<!@#', '#@!>'] });
            testCommand_1.testCommand(lines, mode.getLanguageIdentifier(), selection, (sel) => new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */), expectedLines, expectedSelection);
            mode.dispose();
        }
        function testAddLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            let mode = new commentMode_1.CommentMode({ lineComment: '!@#', blockComment: ['<!@#', '#@!>'] });
            testCommand_1.testCommand(lines, mode.getLanguageIdentifier(), selection, (sel) => new lineCommentCommand_1.LineCommentCommand(sel, 4, 1 /* ForceAdd */), expectedLines, expectedSelection);
            mode.dispose();
        }
        ...
        test('case insensitive', function () {
            function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
                let mode = new commentMode_1.CommentMode({ lineComment: 'rem' });
                testCommand_1.testCommand(lines, mode.getLanguageIdentifier(), selection, (sel) => new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */), expectedLines, expectedSelection);
                mode.dispose();
            }
            testLineCommentCommand([
    ...
    suite('Editor Contrib - Line Comment As Block Comment 2', () => {
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            let mode = new commentMode_1.CommentMode({ lineComment: null, blockComment: ['<!@#', '#@!>'] });
            testCommand_1.testCommand(lines, mode.getLanguageIdentifier(), selection, (sel) => new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */), expectedLines, expectedSelection);
            mode.dispose();
        }
    ...
    suite('Editor Contrib - Line Comment in mixed modes', () => {
        ...
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            ...
            testCommand_1.testCommand(lines, outerMode.getLanguageIdentifier(), selection, (sel) => new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */), expectedLines, expectedSelection);
            innerMode.dispose();
            outerMode.dispose();
        }
