 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/browser/controller/coreCommands", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder", "vs/editor/common/model/textModel", "vs/editor/contrib/find/findModel", "vs/editor/contrib/find/findState", "vs/editor/test/browser/testCodeEditor"], function (require, exports, assert, coreCommands_1, position_1, range_1, selection_1, pieceTreeTextBufferBuilder_1, textModel_1, findModel_1, findState_1, testCodeEditor_1) {
    "use strict";
    ...
    suite('FindModel', () => {
        function findTest(testName, callback) {
            test(testName, () => {
                ...
                testCodeEditor_1.withTestCodeEditor(textArr, {}, (editor, cursor) => callback(editor, cursor));
                ...
                testCodeEditor_1.withTestCodeEditor([], {
                    model: new textModel_1.TextModel(factory, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, null, null)
                }, (editor, cursor) => callback(editor, cursor));
            });
        }
        ...
        findTest('incremental find from beginning of file', (editor, cursor) => {
            ...
            let findState = new findState_1.FindReplaceState();
            let findModel = new findModel_1.FindModelBoundToEditorModel(editor, findState);
