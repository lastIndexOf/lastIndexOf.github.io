...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/bulkEditService", "vs/editor/common/editorContextKeys", "vs/editor/contrib/message/messageController", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/keybinding/common/keybinding", "vs/platform/markers/common/markers", "vs/platform/progress/common/progress", "./codeActionModel", "./codeActionTrigger", "./codeActionWidget", "./lightBulbWidget", "vs/base/common/errors"], function (require, exports, lifecycle_1, strings_1, editorExtensions_1, bulkEditService_1, editorContextKeys_1, messageController_1, nls, commands_1, contextkey_1, contextView_1, keybinding_1, markers_1, progress_1, codeActionModel_1, codeActionTrigger_1, codeActionWidget_1, lightBulbWidget_1, errors_1) {
    ...
    let QuickFixController = class QuickFixController {
    ...
    class OrganizeImportsAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor) {
            return showCodeActionsForEditorSelection(editor, nls.localize('editor.action.organize.noneMessage', "No organize imports action available"), { kind: codeActionTrigger_1.CodeActionKind.SourceOrganizeImports, includeSourceActions: true }, 0 /* IfSingle */);
        }
    }
    ...
    class FixAllAction extends editorExtensions_1.EditorAction {
        ...
        run(_accessor, editor) {
            return showCodeActionsForEditorSelection(editor, nls.localize('fixAll.noneMessage', "No fix all action available"), { kind: codeActionTrigger_1.CodeActionKind.SourceFixAll, includeSourceActions: true }, 0 /* IfSingle */);
        }
    }
