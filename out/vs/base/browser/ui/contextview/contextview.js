 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/lifecycle", "vs/base/common/range", "vs/css!./contextview"], function (require, exports, DOM, lifecycle_1, range_1) {
    "use strict";
    ...
    class ContextView extends lifecycle_1.Disposable {
        constructor(container) {
            ...
            this._register(lifecycle_1.toDisposable(() => this.setContainer(null)));
        }
        setContainer(container) {
            ...
            if (container) {
                ...
                this.toDisposeOnSetContainer = lifecycle_1.combinedDisposable(toDisposeOnSetContainer);
            }
        }
        show(delegate) {
            if (this.isVisible()) {
