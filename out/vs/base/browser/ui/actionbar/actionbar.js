...
define(["require", "exports", "vs/base/common/platform", "vs/nls", "vs/base/common/lifecycle", "vs/base/browser/ui/selectBox/selectBox", "vs/base/common/actions", "vs/base/browser/dom", "vs/base/common/types", "vs/base/browser/touch", "vs/base/browser/keyboardEvent", "vs/base/common/event", "vs/css!./actionbar"], function (require, exports, platform, nls, lifecycle_1, selectBox_1, actions_1, DOM, types, touch_1, keyboardEvent_1, event_1) {
    ...
    class BaseActionItem extends lifecycle_1.Disposable {
        ...
        render(container) {
            ...
            this._register(DOM.addDisposableListener(this.element, touch_1.EventType.Tap, e => this.onClick(e)));
    ...
    class ActionItem extends BaseActionItem {
        constructor(context, action, options = {}) {
    ...
    class SelectActionItem extends BaseActionItem {
