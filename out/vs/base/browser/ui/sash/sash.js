...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/browser/browser", "vs/base/common/platform", "vs/base/common/types", "vs/base/browser/touch", "vs/base/browser/mouseEvent", "vs/base/common/event", "vs/base/browser/dom", "vs/base/browser/event", "vs/css!./sash"], function (require, exports, lifecycle_1, browser_1, platform_1, types, touch_1, mouseEvent_1, event_1, dom_1, event_2) {
    ...
    class Sash extends lifecycle_1.Disposable {
        constructor(container, layoutProvider, options = {}) {
            ...
            touch_1.Gesture.addTarget(this.el);
            ...
            if (browser_1.isIPad) {
                ...
                dom_1.addClass(this.el, 'touch');
            }
            this.setOrientation(options.orientation || 0 /* VERTICAL */);
            this.hidden = false;
        ...
        onMouseDown(e) {
            ...
            const iframes = dom_1.getElementsByTagName('iframe');
        ...
        layout() {
            const size = browser_1.isIPad ? 20 : 4;
            if (this.orientation === 0 /* VERTICAL */) {
