 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/browser/ui/tree/abstractTree", "vs/base/browser/ui/tree/objectTreeModel", "vs/base/common/iterator"], function (require, exports, abstractTree_1, objectTreeModel_1, iterator_1) {
    "use strict";
    ...
    class DataTree extends abstractTree_1.AbstractTree {
        ...
        iterate(element, isCollapsed) {
            ...
            const elements = iterator_1.Iterator.map(iterator_1.Iterator.fromArray(children), element => {
