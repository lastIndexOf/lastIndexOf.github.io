 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/event", "vs/base/common/iterator"], function (require, exports, arrays_1, event_1, iterator_1) {
    "use strict";
    ...
    function treeNodeToElement(node) {
        ...
        const children = iterator_1.Iterator.map(iterator_1.Iterator.fromArray(node.children), treeNodeToElement);
    ...
    class IndexTreeModel {
        ...
        splice(location, deleteCount, toInsert, onDidCreateNode, onDidDeleteNode) {
            ...
            const result = iterator_1.Iterator.map(iterator_1.Iterator.fromArray(deletedNodes), treeNodeToElement);
