 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/arrays", "./gridview", "vs/base/common/event", "vs/base/browser/dom", "./gridview", "vs/css!./gridview"], function (require, exports, lifecycle_1, arrays_1, gridview_1, event_1, dom_1, gridview_2) {
    "use strict";
        ...
        restoreViewsSize(location, node, orientation, widthScale, heightScale) {
            ...
            for (let i = 0; i < node.children.length; i++) {
                ...
                if (i < node.children.length - 1) {
                    const size = orientation === 0 /* VERTICAL */ ? child.box.height : child.box.width;
    ...
    class View {
        constructor(view) {
            ...
            this.show();
            this.onDidChange = event_1.Event.any(this.onDidChangeVisibility.event, event_1.Event.filter(view.onDidChange, () => this.visible));
        }
        get minimumWidth() { return this.visible ? this.view.minimumWidth : 0; }
        get maximumWidth() { return this.visible ? this.view.maximumWidth : (this.orientation === 1 /* HORIZONTAL */ ? 0 : Number.POSITIVE_INFINITY); }
        get minimumHeight() { return this.visible ? this.view.minimumHeight : 0; }
        get maximumHeight() { return this.visible ? this.view.maximumHeight : (this.orientation === 0 /* VERTICAL */ ? 0 : Number.POSITIVE_INFINITY); }
