 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/event", "vs/base/parts/ipc/node/ipc", "vs/base/parts/ipc/node/ipc.electron", "electron", "vs/base/common/lifecycle"], function (require, exports, event_1, ipc_1, ipc_electron_1, electron_1, lifecycle_1) {
    "use strict";
    ...
    function createScopedOnMessageEvent(senderId, eventName) {
        ...
        return event_1.Event.map(onMessageFromSender, ({ message }) => message);
    }
