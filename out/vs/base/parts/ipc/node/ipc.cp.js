 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "child_process", "vs/base/common/lifecycle", "vs/base/common/async", "vs/base/common/objects", "vs/base/common/event", "vs/base/node/processes", "vs/base/parts/ipc/node/ipc", "vs/base/node/console", "vs/base/common/cancellation", "vs/base/common/errors"], function (require, exports, child_process_1, lifecycle_1, async_1, objects_1, event_1, processes_1, ipc_1, console_1, cancellation_1, errors) {
    "use strict";
    ...
    class Server extends ipc_1.ChannelServer {
        constructor(ctx) {
            super({
                ...
                onMessage: event_1.Event.fromNodeEventEmitter(process, 'message', msg => Buffer.from(msg, 'base64'))
            }, ctx);
    ...
    class Client {
        ...
        get client() {
            if (!this._client) {
                ...
                const send = (r) => this.child && this.child.connected && sender.send(r.toString('base64'));
