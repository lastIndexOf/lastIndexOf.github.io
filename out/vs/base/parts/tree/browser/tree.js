...
define(["require", "exports"], function (require, exports) {
    ...
    exports.DRAG_OVER_ACCEPT_BUBBLE_UP = { accept: true, bubble: 1 /* BUBBLE_UP */ };
    exports.DRAG_OVER_ACCEPT_BUBBLE_DOWN = (autoExpand = false) => ({ accept: true, bubble: 0 /* BUBBLE_DOWN */, autoExpand });
    exports.DRAG_OVER_ACCEPT_BUBBLE_UP_COPY = { accept: true, bubble: 1 /* BUBBLE_UP */, effect: 0 /* COPY */ };
    exports.DRAG_OVER_ACCEPT_BUBBLE_DOWN_COPY = (autoExpand = false) => ({ accept: true, bubble: 0 /* BUBBLE_DOWN */, effect: 0 /* COPY */, autoExpand });
});
