...
define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/errors", "vs/base/common/async"], function (require, exports, assert, event_1, Errors, async_1) {
    "use strict";
    ...
    suite('Event utils', () => {
        ...
        suite('echo', () => {
            test('should echo events', () => {
                ...
                const emitter = new event_1.Emitter();
                const event = emitter.event;
                const echoEvent = event_1.Event.echo(event);
                emitter.fire(1);
                emitter.fire(2);
                emitter.fire(3);
                assert.deepEqual(result, []);
