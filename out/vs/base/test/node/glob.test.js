define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/glob", "vs/base/common/platform"], function (require, exports, assert, path, glob, platform_1) {
    "use strict";
    ...
    suite('Glob', () => {
        ...
        test('relative pattern - glob star', function () {
            if (platform_1.isWindows) {
                ...
                let p = { base: '/DNXConsoleApp/foo', pattern: '**/*.cs' };
                assertGlobMatch(p, '/DNXConsoleApp/foo/Program.cs');
        ...
        test('relative pattern - single star with path', function () {
            if (platform_1.isWindows) {
                ...
                let p = { base: '/DNXConsoleApp/foo', pattern: 'something/*.cs' };
        ...
        test('relative pattern - #57475', function () {
            if (platform_1.isWindows) {
                let p = { base: 'C:\\DNXConsoleApp\\foo', pattern: 'styles/style.css' };
                assertGlobMatch(p, 'C:\\DNXConsoleApp\\foo\\styles\\style.css');
                assertNoGlobMatch(p, 'C:\\DNXConsoleApp\\foo\\Program.cs');
            }
            else {
                let p = { base: '/DNXConsoleApp/foo', pattern: 'styles/style.css' };
