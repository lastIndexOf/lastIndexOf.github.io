 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "fs", "os", "vs/base/common/path", "stream", "vs/base/common/normalization", "vs/base/common/platform", "vs/base/common/uuid", "vs/base/node/extfs", "vs/base/common/amd", "vs/base/common/cancellation"], function (require, exports, assert, fs, os, path, stream_1, normalization_1, platform_1, uuid, extfs, amd_1, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const ignore = () => { };
    const mkdirp = (path, mode, callback) => {
