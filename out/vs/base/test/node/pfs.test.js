 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "os", "vs/base/common/path", "fs", "vs/base/common/uuid", "vs/base/node/pfs", "vs/base/common/async"], function (require, exports, assert, os, path, fs, uuid, pfs, async_1) {
    "use strict";
