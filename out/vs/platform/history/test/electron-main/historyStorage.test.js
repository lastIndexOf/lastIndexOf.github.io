define(["require", "exports", "assert", "os", "vs/base/common/path", "vs/base/common/uri", "vs/platform/history/common/history", "vs/platform/history/electron-main/historyStorage"], function (require, exports, assert, os, path, uri_1, history_1, historyStorage_1) {
    "use strict";
    ...
    function assertRestoring(state, message) {
        ...
        const restored = historyStorage_1.restoreRecentlyOpened(stored);
    ...
    suite('History Storage', () => {
        ...
        test('open 1_25', () => {
            ...
            let actual = historyStorage_1.restoreRecentlyOpened(JSON.parse(v1_25_win));
            let expected = {
        ...
        test('open 1_31', () => {
            ...
            let actual = historyStorage_1.restoreRecentlyOpened(JSON.parse(v1_31_win));
            let expected = {
        ...
        test('open 1_32', () => {
            ...
            let windowsState = historyStorage_1.restoreRecentlyOpened(JSON.parse(v1_32));
            let expected = {
        ...
        test('open 1_33', () => {
            ...
            let windowsState = historyStorage_1.restoreRecentlyOpened(JSON.parse(v1_33));
            let expected = {
