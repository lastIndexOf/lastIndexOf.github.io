...
define(["require", "exports", "electron", "vs/nls", "vs/base/browser/dom", "vs/base/common/collections", "vs/base/browser/browser", "vs/base/common/strings", "vs/platform/product/node/product", "vs/platform/product/node/package", "os", "vs/base/common/decorators", "vs/base/common/platform", "vs/base/common/lifecycle", "vs/base/parts/ipc/node/ipc", "vs/base/parts/ipc/node/ipc.net", "vs/platform/instantiation/common/serviceCollection", "vs/platform/windows/common/windows", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/telemetry/common/telemetryService", "vs/platform/telemetry/node/telemetryIpc", "vs/platform/instantiation/common/instantiationService", "vs/platform/telemetry/node/commonProperties", "vs/platform/windows/electron-browser/windowsService", "vs/platform/ipc/electron-browser/mainProcessService", "vs/platform/environment/node/environmentService", "vs/code/electron-browser/issue/issueReporterModel", "vs/code/electron-browser/issue/issueReporterPage", "vs/platform/log/node/spdlogService", "vs/platform/log/node/logIpc", "vs/platform/log/common/log", "vs/base/browser/ui/octiconLabel/octiconLabel", "vs/code/electron-browser/issue/issueReporterUtil", "vs/base/browser/ui/button/button", "vs/css!./media/issueReporter"], function (require, exports, electron_1, nls_1, dom_1, collections, browser, strings_1, product_1, package_1, os, decorators_1, platform, lifecycle_1, ipc_1, ipc_net_1, serviceCollection_1, windows_1, telemetryUtils_1, telemetryService_1, telemetryIpc_1, instantiationService_1, commonProperties_1, windowsService_1, mainProcessService_1, environmentService_1, issueReporterModel_1, issueReporterPage_1, spdlogService_1, logIpc_1, log_1, octiconLabel_1, issueReporterUtil_1, button_1) {
    ...
    class IssueReporter extends lifecycle_1.Disposable {
        ...
        initServices(configuration) {
            ...
            const logService = spdlogService_1.createSpdLogService(`issuereporter${configuration.windowId}`, log_1.getLogLevel(this.environmentService), this.environmentService.logsPath);
            ...
            if (!this.environmentService.isExtensionDevelopment && !this.environmentService.args['disable-telemetry'] && !!product_1.default.enableTelemetry) {
                ...
                const commonProperties = commonProperties_1.resolveCommonProperties(product_1.default.commit || 'Commit unknown', package_1.default.version, configuration.machineId, this.environmentService.installSourcePath);
        ...
        createIssue() {
            ...
            */
            ...
            if (url.length > MAX_URL_LENGTH) {
                ...
                url = baseUrl + `&body=${encodeURIComponent(nls_1.localize('pasteData', "We have written the needed data into your clipboard because it was too large to send. Please paste."))}`;
            }
        ...
        updateExtensionSelector(extensions) {
            ...
            const makeOption = (extension) => `<option value="${extension.id}">${strings_1.escape(extension.name)}</option>`;
