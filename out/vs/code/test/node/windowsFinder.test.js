define(["require", "exports", "assert", "vs/base/common/path", "vs/code/node/windowsFinder", "vs/platform/workspace/common/workspace", "vs/base/common/uri", "vs/base/common/amd"], function (require, exports, assert, path, windowsFinder_1, workspace_1, uri_1, amd_1) {
    ...
    function options(custom) {
        return Object.assign({ windows: [], newWindow: false, context: 0 /* CLI */, codeSettingsFolder: '_vscode', localWorkspaceResolver: workspace => { return workspace === testWorkspace ? { id: testWorkspace.id, configPath: workspace.configPath, folders: workspace_1.toWorkspaceFolders([{ path: path.join(fixturesFolder, 'vscode_workspace_1_folder') }, { path: path.join(fixturesFolder, 'vscode_workspace_2_folder') }]) } : null; } }, custom);
    }
